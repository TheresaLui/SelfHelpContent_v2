...
* Don't link to internal review documentation! These URLs always start with "review.microsoft.docs" - users are unable to access them.
* Avoid aka.ms short links where possible
```
