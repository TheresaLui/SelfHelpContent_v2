<properties
 pageTitle="Services Hub Common Solutions Template"
 description="Services Hub Common Solutions Template"
 articleId=""
 productFamilyId = ""
 productPesIds=""
 supportTopicIds=""
...
[cluster my-cluster]
    ...
    Autoscale = $Autoscale
```
>  Note: We do not support codeblock language specifications as part of the markdown (unlike Microsoft Docs).
...
>    - Tables do not work
>    - [!NOTE] tags do not work
>    - Named anchors dot not work.  A named anchor refers to a link to a anchor in the mardown.  An example of a named anchor is: [named anchor example](#anchor-in-this-markdown-file)
