...
2. use Data migration tool migrate the data (even when you assign a throughput to the destination container here it wont be considered as the collection is already created).  
