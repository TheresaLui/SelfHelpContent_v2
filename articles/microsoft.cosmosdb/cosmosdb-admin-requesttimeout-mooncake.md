<properties
	...
	articleId="cosmosdb-admin-requesttimeout-mooncake"
	displayOrder="6"
...
* [Azure Cosmos DB server-side programming: Stored procedures, database triggers, and UDFs](https://docs.azure.cn/cosmos-db/stored-procedures-triggers-udfs)
* [Bounded execution](https://docs.azure.cn/cosmos-db/stored-procedures-triggers-udfs#bounded-execution)
