<properties
	pageTitle="Azure Cosmos DB Gremlin authentication"
	description="Troubleshoot Azure Cosmos DB Gremlin authentication issues"
	service="microsoft.documentdb"
	resource="databaseAccounts"
	authors="jimsch"
	ms.author="jimsch"
	selfHelpType="generic"
	supportTopicIds="32746031"
	resourceTags=""
	productPesIds="15585"
	cloudEnvironments="public,fairfax,blackforest,mooncake,usnat,ussec"
	articleId="cosmosdb-gremlin-authentication"
	displayOrder="190"
	category="Gremlin"
	ownershipId="AzureData_AzureCosmosDB"
/>

# Azure Cosmos DB Gremlin (Graph) authentication

Most users are able to resolve their Cosmos DB Gremlin (Graph) authentication using the steps below. 
