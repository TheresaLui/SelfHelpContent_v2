<properties
	...
	articleId="cosmosdb-changefeed-mooncake"
	displayOrder="21"
	category="Core (SQL)"
/>
...
* [Change feed in Azure Cosmos DB - overview](https://docs.azure.cn/cosmos-db/change-feed)
* [Reading Azure Cosmos DB change feed](https://docs.azure.cn/cosmos-db/read-change-feed)
* [Change feed processor in Azure Cosmos DB](https://docs.azure.cn/cosmos-db/change-feed-processor)
