<properties
	...
	articleId="cosmosdb-bulkexecutor-mooncake"
	displayOrder="13"
...
* [Azure Cosmos DB bulk executor library overview](https://docs.azure.cn/cosmos-db/bulk-executor-overview)
* [Use bulk executor .NET library to perform bulk operations in Azure Cosmos DB](https://docs.azure.cn/cosmos-db/bulk-executor-dot-net)
* [Use bulk executor Java library to perform bulk operations on Azure Cosmos DB data](https://docs.azure.cn/cosmos-db/bulk-executor-java)