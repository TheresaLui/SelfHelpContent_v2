...
# TLS 1.2 Upgrade Documents

We have determined that you are using TLS that is earlier than 1.2. Earlier versions are not secure. 

## Documents on why to switch to TLS 1.2:

* [Preparing for TLS 1.2 in Microsoft Azure](https://azure.microsoft.com/updates/azuretls12/)

We recommend that you complete migration towards solutions that support transport layer security (TLS) 1.2 and make sure that TLS 1.2 is used by default.

All Azure services fully support TLS 1.2. Services where you use only TLS 1.2 changed to accept only TLS 1.2 traffic. Services that currently accept TLS 1.0/1.1 traffic will continue supporting these protocol versions until further notice to ensure compatibility with existing applications. Although the TLS 1.0 implementation has no known security vulnerabilities, it’s important to account for potential future protocol downgrade attacks and other TLS vulnerabilities. We continue to monitor the security landscape and will reevaluate its position as needed.
...
* [TLS 1.2 enforcement on Azure Cosmos DB](https://devblogs.microsoft.com/cosmosdb/tls-1-2-enforcement/)
 ...
 Azure Cosmos DB already supports TLS 1.2. To ensure that you are covered with the best level of security, TLS 1.2 is enforced by default starting July 29, 2020 on:
...
* [Java](https://www.java.com/en/configure_crypto.html)
  ...
  This link above contains additional information and/or instructions for testing and/or reverting changes to Oracle's JDK and JRE announced on the [Oracle JRE and JDK Cryptographic Roadmap](https://www.java.com/en/jre-jdk-cryptoroadmap.html)
