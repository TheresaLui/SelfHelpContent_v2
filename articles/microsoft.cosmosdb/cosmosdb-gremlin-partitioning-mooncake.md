<properties
	...
	articleId="cosmosdb-gremlin-partitioning-mooncake"
	displayOrder="30"
...
* [Partitioning and horizontal scaling in Azure Cosmos DB](https://docs.azure.cn/cosmos-db/partition-data) 
* [Using a partitioned graph in Azure Cosmos DB](https://docs.azure.cn/cosmos-db/graph-partitioning)
