...
* Learn [how to configure IP firewall in Azure Cosmos DB](https://docs.microsoft.com/azure/cosmos-db/how-to-configure-firewall) from the Azure portal, declaratively by using an Azure Resource Manager template, or programmatically through the Azure CLI or Azure PowerShell by updating the ipRangeFilter property
