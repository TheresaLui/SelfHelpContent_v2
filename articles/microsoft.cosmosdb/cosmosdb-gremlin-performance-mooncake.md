<properties
	...
	articleId="cosmosdb-gremlin-performance-mooncake"
	displayOrder="31"
...
* [How to use the execution profile step to evaluate your Gremlin queries](https://docs.azure.cn/cosmos-db/graph-execution-profile) 
