...
# Azure Synapse Link for Cosmos DB - SQL Serverless
Most users are able to resolve their Azure Synapse Link for Cosmos DB SQL Serverless issue using the steps below.  
