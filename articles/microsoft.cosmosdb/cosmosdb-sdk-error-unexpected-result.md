...
This is typically caused by issues with the SSL certificates. Please verify your certificates.  
...
CancelationToken parameter in ExecuteStoredProcedureAsync should be given as the 3rd parameter. If it is not the payload will be incorrect.  
