<properties
    pageTitle="TLS 1.2 Upgrade Document - No recent TLS &lt; 1.2 but has override and old requests"
    ...
    authors="tomrlake"
    ms.author="tolake"
    articleId="cosmosdb-tls12-upgrade-no-current-with-override-and-old-rca"
