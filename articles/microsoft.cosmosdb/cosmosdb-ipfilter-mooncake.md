<properties
	...
	articleId="cosmosdb-ipfilter-mooncake"
	displayOrder="36"
...
* Enable [Service Endpoints](https://docs.azure.cn/zh-cn/cosmos-db/vnet-service-endpoint) on the subnet
...
* [How to configure access from virtual networks (VNet)](https://docs.azure.cn/cosmos-db/how-to-configure-vnet-service-endpoint)
