...
Check [How to monitor normalized RU/s for an Azure Cosmos container or an account](https://docs.microsoft.com/azure/cosmos-db/monitor-normalized-request-units)  
