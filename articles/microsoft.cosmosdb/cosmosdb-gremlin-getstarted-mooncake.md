<properties
	...
	articleId="cosmosdb-gremlin-getstarted-mooncake"
	displayOrder="27"
...
* [Import data into Cosmos DB Gremlin account](https://docs.azure.cn/cosmos-db/bulk-executor-graph-dotnet)
* [Development using the Gremlin API](https://docs.azure.cn/cosmos-db/graph-introduction#get-started)
* [Supported Gremlin operators](https://docs.azure.cn/cosmos-db/gremlin-support)
* [Graph data partitioning](https://docs.azure.cn/cosmos-db/graph-partitioning)
