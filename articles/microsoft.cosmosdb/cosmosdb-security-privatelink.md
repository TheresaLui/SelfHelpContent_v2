...
### Make sure the API and connection modes you are using are supported by Azure Cosmos DB private endpoints
| API | Connection mode | Support | Notes |
| --- | --- | --- | --- |
