<properties
	...
	articleId="cosmosdb-admin-securityvnetendpoint-mooncake"
	displayOrder="7"
...
* [Secure access to an Azure Cosmos DB account by using Azure Virtual Network service endpoint](https://docs.azure.cn/cosmos-db/vnet-service-endpoint)
* [Frequently asked questions](https://docs.azure.cn/cosmos-db/vnet-service-endpoint#frequently-asked-questions)
