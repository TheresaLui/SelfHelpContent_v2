<properties
	...
	articleId="cosmosdb-authentication-mooncake"
	displayOrder="10"
	category="Core (SQL)"
/>
...
* [Securing access to Azure Cosmos DB data](https://docs.azure.cn/cosmos-db/secure-access-to-data)
...
* [Azure Cosmos DB database security](https://docs.azure.cn/cosmos-db/database-security)
