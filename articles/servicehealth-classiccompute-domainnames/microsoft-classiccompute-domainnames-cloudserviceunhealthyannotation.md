<properties
    pageTitle="Your Cloud Service deployment is degraded because {0} out of {1} role instances are unavailable."
    ...
    articleTags="healthannotation_CloudServiceUnhealthyAnnotation,ServiceHealthAutogenerated"
