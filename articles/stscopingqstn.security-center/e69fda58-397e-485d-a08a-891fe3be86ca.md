<properties
  ...
  supporttopicids="32693227,32693235,32693247,32749432"
  resourcetags=""
  productpesids="15947"
...
ASC maps **Not applicable resources** to the **Unhealthy** policy state.
...
## Recommendations API
- In the REST API, Recommendations are referred to as Assessments. The available actions include: Create Or Update, Get, List, and Delete.  
For details, see https://docs.microsoft.com/rest/api/securitycenter/assessments
- SubAssessments (also referred to as Nested Recommendations) are the findings of the Vulnerabilities Assessments tools and the Security Configurations scanner.  
