<properties
    pageTitle="JIT API/Powershell issue"
    description="Resolving issues with JIT API/Powershell"
    service=""
    resource=""
...
For PowerShell usage and troubleshooting, please click [here](https://docs.microsoft.com/powershell/module/az.security/?view=azps-2.4.0).
