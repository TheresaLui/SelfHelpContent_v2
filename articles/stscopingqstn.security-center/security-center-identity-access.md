<properties
	pageTitle="Identity and Access Common Solutions"
	description="Identity and Access Common Solutions"
	authors="genlin"
	ms.author="jaserano"
	displayOrder=""
...
- [Monitor identity and access in Azure Security Center](https://docs.microsoft.com/azure/security-center/security-center-identity-access)
