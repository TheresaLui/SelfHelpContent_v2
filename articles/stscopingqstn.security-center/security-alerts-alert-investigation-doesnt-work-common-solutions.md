<properties
    pageTitle="Security Alerts - Alert investigation doesn't work Common Solutions"
    description="Security Alerts - Alert investigation doesn't work Common Solutions"
    service=""
    resource=""
...
* Customer need write permission to the workspace to be able to start the investigation.
