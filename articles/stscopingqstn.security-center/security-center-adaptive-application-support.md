<properties
    pageTitle="Azure Security Center Overview Common Solutions"
	description="Azure Security Center Overview Common Solutions"
	authors="genlin"
	ms.author="jaserano"
	displayOrder=""
	selfHelpType="generic"
    supportTopicIds="32636838,32636855,32636874,32636921,32636922"
	resourceTags=""
	productPesIds="15947"
...
- [Adaptive application controls in Azure Security Center Overview](https://docs.microsoft.com/azure/security-center/security-center-adaptive-application)
- [Adaptive application controls in Azure Security Center Tutorial](https://docs.microsoft.com/azure/security-center/tutorial-protect-resources#harden-vms-against-malware)
