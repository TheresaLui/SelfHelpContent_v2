<properties
    pageTitle="Security Alerts - Alert details are incorrect Common Solutions"
    description="Security Alerts - Alert details are incorrect Common Solutions"
    service=""
    resource=""
...
For VMBA alerts, the same Virtual Machine (VM) name appears in both the alert detail and the Azure portal. This name may be different from the host name of the VM.
