...
3. Customer should have the RBAC role to contain the above actions (Contributor or Owner) as described at [Understanding just-in-time virtual machine access in Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/just-in-time-explained)
