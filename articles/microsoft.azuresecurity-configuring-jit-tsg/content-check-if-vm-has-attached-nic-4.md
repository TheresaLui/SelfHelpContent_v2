...
1. Make sure the NIC is attaced to the VM with either public or private IP addresses. 
2. Please refer to [NIC attached to VMs](https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-network-interface)
