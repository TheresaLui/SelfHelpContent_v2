...
* On the IoT Edge gateway, run `iotedge check --verbose`. Look particularly at the results of the configuration checks to make sure that the certificates are valid and defined correctly. 
