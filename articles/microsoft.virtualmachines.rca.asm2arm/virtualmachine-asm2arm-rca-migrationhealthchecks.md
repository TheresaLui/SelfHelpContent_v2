...
<!--issueDescription-->
We have detected that the following configuration settings in the virtual machine **<!--$vmname-->Virtual machine<!--/$vmname-->** or  its virtual networking **<!--$VNET-->VNET<!--/$VNET-->** are preventing the migration to succeed:
