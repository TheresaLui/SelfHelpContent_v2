 <properties
      articleId="FAF18E19-B171-4AC8-B10E-5F104D09B5C8"
...
---
{
  ...
  "title": "Azure SQL Database gateway IP addresses",
  "fileAttachmentHint":"",
  "formElements":
  [
    {
...
,
    {
      "id": "forbidden_or_proxy_error_400",
      "order": 400,
      "controltype": "dropdown",
      "displaylabel": "Have inbound IP Addresses been granted access through the proxy? ",
...
,
    {
      "id": "forbidden_or_proxy_error_500",
      "order": 500,
      "controltype": "multilinetextbox",
...
,
    {
      "id": "forbidden_or_proxy_error_600",
      "order": 600,
      "controltype": "dropdown",
...
,
    {
      "id": "forbidden_or_proxy_error_700",
      "order": 700,
      "controltype": "dropdown",
