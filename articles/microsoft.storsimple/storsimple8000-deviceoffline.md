...
* The device is turned off. For more information, go to [Turn on your StorSimple 8000 series device](https://docs.microsoft.com/azure/storsimple/storsimple-8000-turn-device-on-or-off).
