...
** To get the service registration key, go to your StorSimple Device Manager blade and then go to [**Management** > **Keys**](data-blade:Microsoft_Azure_StorSimple.GardaRegistrationKeyBlade). For detailed instructions, go to [Get a service registration key](https://docs.microsoft.com/azure/storsimple/storsimple-8000-manage-service#get-the-service-registration-key).
...
* Your proxy server settings may be incorrect. Ensure that you use a valid proxy server while registering. For more information, go to [Configure web proxy for your StorSimple device](https://docs.microsoft.com/azure/storsimple/storsimple-configure-web-proxy).
* Ensure that firewall is configured to meet the [Networking requirements for your StorSimple device](https://docs.microsoft.com/azure/storsimple/storsimple-system-requirements#networking-requirements-for-your-storsimple-device)
