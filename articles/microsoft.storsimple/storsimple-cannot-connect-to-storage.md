...
1. [Verify if the access key to storage account has been regenerated. If so, synchronize the access key of your storage account](https://docs.microsoft.com/azure/storsimple/storsimple-virtual-array-manage-storage-accounts#synchronizing-storage-account-credential-keys)
