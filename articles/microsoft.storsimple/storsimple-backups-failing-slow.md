...
2. [Ensure that your StorSimple device has a dedicated 40Mbps or more bandwidth available at all times.](https://docs.microsoft.com/azure/storsimple/storsimple-8000-system-requirements#networking-best-practices)
