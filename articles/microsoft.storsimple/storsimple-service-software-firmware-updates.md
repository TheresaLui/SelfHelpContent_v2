...
- [Reset the device to factory default settings](https://docs.microsoft.com/en-us/azure/storsimple/storsimple-manage-device-controller#reset-the-device-to-factory-default-settings)<br>
- [Troubleshoot update failures](https://docs.microsoft.com/en-us/azure/storsimple/storsimple-install-update-4#troubleshooting-update-failures)
