...
* If you're having trouble using the Azure CLI:
  ...
  * Specify all required parameters in `az monitor metrics alert` using valid values. Review [Azure CLI Monitor Metrics](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-metric#with-azure-cli) for valid parameters.

* If you're having trouble using the Azure Rest API:
