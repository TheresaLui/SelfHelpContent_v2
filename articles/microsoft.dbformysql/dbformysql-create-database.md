...
* To familiarize yourself with using ARM templates to create databases in Azure Database for PostgreSQL server, refer to [this sample template](https://github.com/Azure/azure-mysql/tree/master/arm-templates)
