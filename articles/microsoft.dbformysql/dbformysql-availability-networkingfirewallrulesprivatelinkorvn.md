<properties
    ...
    articleId="2f1a94b5-957a-4222-922a-9a198924666b"
...
* If you use Private Link, ensure the correct configuration of the [Private link](https://docs.microsoft.com/azure/mysql/howto-configure-privatelink-portal)
* If you use a Basic tier server, note that [Private Link](https://docs.microsoft.com/azure/mysql/concepts-data-access-security-private-link) is not supported
...
* If you use VNets, ensure the correct configuration of the [service endpoints](https://docs.microsoft.com/azure/mysql/howto-manage-vnet-using-portal)
* If you use a Basic tier server, note that VNet service endpoints are not supported
