<properties
    pageTitle="Private Link for Azure Database for MySQL using Portal"
    description="Private Link for Azure Database for MySQL using Portal"
    service="microsoft.dbformysql"
    resource="servers"
    ms.author="jtoland"
    displayOrder="40"
    selfHelpType="generic"
    supportTopicIds="32788522"
    resourceTags="servers, databases"
    productPesIds="16221"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="a446f708-60ad-4064-b47f-e70c03387237"
    ownershipId="AzureData_AzureDatabaseforMySQL"
/>

# Private Link for Azure Database for MySQL using Portal
