...
You can restore one or more databases from a file generated by **mysqldump**, which is commonly used to back up one or more databases. Most users can resolve issues by using the steps below.
...
* See [common issues with restoring with mysqldump](https://techcommunity.microsoft.com/t5/azure-database-for-mysql/tips-and-tricks-in-using-mysqldump-and-mysql-restore-to-azure/ba-p/916912).
