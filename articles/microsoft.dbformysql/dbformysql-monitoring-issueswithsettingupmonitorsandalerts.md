...
* If you are having trouble configuring planned maintenance notification, review [how to receive planned maintenance notification](https://docs.microsoft.com/azure/mysql/concepts-monitoring#to-receive-planned-maintenance-notification)
