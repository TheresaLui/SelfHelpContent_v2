...
Refer to [troubleshoot replication latency in Azure Database for MySQL](./howto-troubleshoot-replication-latency.md) to learn on how to troubleshoot replication latency.
