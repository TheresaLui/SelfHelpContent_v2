...
You can resolve common issues by considering the following points and using the following steps.

## **Recommended Steps**

* In Azure Database for MySQL, the [`mysql` system database](https://dev.mysql.com/doc/refman/8.0/en/system-schema.html) is read-only because it is used to support various aspects of the PaaS service functionality. Note that you can't change anything in the `mysql` system database.
