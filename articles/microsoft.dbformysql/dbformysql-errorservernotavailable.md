...
Applications that are connecting to cloud services [should implemented retry logic](https://docs.microsoft.com/azure/mysql/concepts-connectivity) to catch handle such transient errors.
