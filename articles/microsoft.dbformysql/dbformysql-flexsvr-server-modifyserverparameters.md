<properties
    pageTitle="Managing server parameters in Azure Database for MySQL - Flexible Server"
    description="Managing server parameters in Azure Database for MySQL - Flexible Server"
    ...
    supportTopicIds="32747625"
    resourceTags="servers, databases"
    productPesIds="17344"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="d81957ff-115e-49bc-8d57-34a04f8ee0a7"
    ownershipId="AzureData_AzureDatabaseforMySQL"
/>

# Managing server parameters in Azure Database for MySQL - Flexible Server
