...
* **ERROR 9002 (28000): FATAL: Invalid Username specified**
  ...
  Confirm that the username you're passing ends with the correct server name/hostname field. The username needs to be passed in the format `username@servername`.
