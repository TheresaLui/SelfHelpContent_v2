<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="f6e3ad9c-5d58-48ba-b06b-ebffba60dd18_UsSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 2.0,
    "streamNamespace": "cluster('https://adfcus.usseceast.kusto.core.microsoft.scloud/').database('azuredatafactorygov').AdvisorRepeatedlyFailingPipelines",
    "dataSource": "Kusto",
