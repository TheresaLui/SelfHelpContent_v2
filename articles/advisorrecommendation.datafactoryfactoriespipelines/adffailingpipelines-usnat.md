<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="f6e3ad9c-5d58-48ba-b06b-ebffba60dd18_UsNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 2.0,
    "streamNamespace": "cluster('https://adfcus.usnateast.kusto.core.eaglex.ic.gov/').database('azuredatafactorygov').AdvisorRepeatedlyFailingPipelines",
    "dataSource": "Kusto",
