...
Log Analytics currently supports Azure VM backups, MAB Agent and System Center DPM, for more information read note in this [article](https://aka.ms/Create-Alert-LA)
