...
- [How to configure email notification on successful backup jobs?](https://docs.microsoft.com/azure/backup/backup-azure-monitor-vms#using-activity-logs-to-get-notifications-for-successful-backups)<br>
...
- [What are the limitations on IAAS VM Activity Log Alerts or email notification on successful backup jobs?](https://docs.microsoft.com/azure/backup/backup-azure-monitor-vms#limitations-on-alerts)<br>
