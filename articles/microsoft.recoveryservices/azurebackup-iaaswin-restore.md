...
- [Unsupported restore configurations](https://docs.microsoft.com/azure/backup/backup-support-matrix-iaas#vm-storage-support): ***Temp drive***, ***Deduplicated Disk*** and ***disk with write Accelerator enabled***
