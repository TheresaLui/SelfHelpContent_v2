...
## **Recommended Steps**
- Ensure AZUREWLBACKUPHANAUSER is present in the HANA system with required roles and permissions as specified in this [article](https://aka.ms/HANAPermissions).  
