...
<!--issueDescription-->
Replication status is critical. This issue is caused by the Site recovery Mobility Service on the source virtual machine is not able to access to the [cache storage account](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-architecture#architectural-components
) to replicate data.
<!--/issueDescription-->
