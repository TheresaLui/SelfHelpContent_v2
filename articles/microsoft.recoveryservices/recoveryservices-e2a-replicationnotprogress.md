...
* Verify that your [configuration is supported](https://docs.microsoft.com/azure/site-recovery/support-matrix-hyper-v-to-azure) by Azure Site Recovery
...
- [Replication not progressing](https://docs.microsoft.com/azure/site-recovery/hyper-v-azure-troubleshoot#replication-issues)<br>
