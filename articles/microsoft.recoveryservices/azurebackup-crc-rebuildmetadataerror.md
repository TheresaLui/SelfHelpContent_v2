...
- If issue persists then review the pre-requites and troubleshooting steps for Cache folder by referring this [article](https://docs.microsoft.com/zure/backup/backup-azure-mars-troubleshoot#troubleshoot-cache-problems). 
