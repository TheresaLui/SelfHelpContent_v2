...
- If private DNS zone is not feasible, then setup DNS configuration for private endpoint using the host file. [Learn more](https://docs.microsoft.com/azure/private-link/private-endpoint-dns)
