...
<!--issueDescription-->
## We have identified that backup operation was failed becuase a Protection Group was created with special character (such as @, #, $, /, \ and so on).
<!--/issueDescription-->
...
* Rename the Protection group and make sure it doesn't have the special character.
