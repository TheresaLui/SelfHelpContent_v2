<properties
	pageTitle="Microsoft Azure Backup Server setup"
	description="Azure Backup server setup"
	...
	supportTopicIds="32749572"
	resourceTags=""
	productPesIds="15207"
	cloudEnvironments="public, fairfax, usnat, ussec"
	articleId="b8ac28bf-4873-4aa8-a5c0-10c53ea54a89"
...
- [Use Backup Server to back up a VMware server](https://docs.microsoft.com/azure/backup/backup-azure-backup-server-vmware)
- [Use Backup Server to back up SQL Server](https://docs.microsoft.com/azure/backup/backup-azure-sql-mabs)
- [Add Modern Backup Storage to Backup Server](https://docs.microsoft.com/azure/backup/backup-mabs-add-storage)
