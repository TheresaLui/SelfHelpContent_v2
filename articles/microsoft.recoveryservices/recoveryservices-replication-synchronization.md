...
- [Troubleshooting common Azure to Azure VM replication Errors](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-troubleshoot-replication)
- [Steps to configure outbound network connectivity](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-architecture#connectivity-requirements)
