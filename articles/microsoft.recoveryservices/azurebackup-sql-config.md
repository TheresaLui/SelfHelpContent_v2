...
- [If I change the recovery model, how do I restart protection?](https://docs.microsoft.com/azure/backup/backup-azure-sql-database#if-i-change-the-recovery-model-how-do-i-restart-protection)</br>
