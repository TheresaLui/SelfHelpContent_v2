...
- [When I select a SQL Server instance are future databases automatically added?](https://docs.microsoft.com/en-us/azure/backup/backup-azure-sql-database#when-i-select-a-sql-server-instance-are-future-databases-automatically-added)</br>
- [If I change the recovery model, how do I restart protection?](https://docs.microsoft.com/en-us/azure/backup/backup-azure-sql-database#if-i-change-the-recovery-model-how-do-i-restart-protection)</br>
- [Can I protect SQL Always On Availability Groups where the primary replica is on premises?](https://docs.microsoft.com/en-us/azure/backup/backup-azure-sql-database#can-i-protect-sql-always-on-availability-groups-where-the-primary-replica-is-on-premises?)</br>
