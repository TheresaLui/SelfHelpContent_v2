...
- [When I select a SQL Server instance are future databases automatically added?](https://docs.microsoft.com/azure/backup/backup-azure-sql-database#when-i-select-a-sql-server-instance-are-future-databases-automatically-added)</br>
