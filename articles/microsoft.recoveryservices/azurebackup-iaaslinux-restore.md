...
- Special restore configuration requirements for [dynamic disks](https://docs.microsoft.com/azure/backup/backup-azure-restore-files-from-vm#dynamic-disks), [LVM/RAID arrays](https://docs.microsoft.com/en-us/azure/backup/backup-azure-restore-files-from-vm#lvmraid-arrays-for-linux-vms)
