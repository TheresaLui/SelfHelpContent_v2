...
<!--issueDescription-->
Yur backup operation might have failed because the backup service was unable to communicate with your VM's Guest Agent.
<!--/issueDescription-->
...
3. Check if the root drive has enough space
