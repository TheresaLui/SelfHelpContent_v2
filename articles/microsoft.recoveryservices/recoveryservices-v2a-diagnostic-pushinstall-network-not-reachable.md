...
2. Ensure that you can ping the source machine (Source IP) from the configuration server or scale-out process server using following command: "telnet CS/scale-out-PS-IP-address 135". For more information, see [Connectivity failure](https://docs.microsoft.com/azure/site-recovery/vmware-azure-troubleshoot-push-install#connectivity-failure-errorid-95117--97118).
