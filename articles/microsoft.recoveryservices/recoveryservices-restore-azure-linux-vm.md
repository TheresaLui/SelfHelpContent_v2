...
* We recommend using SSH based authentication for Linux VMs. If You are using Password based authentication on the VM which got backed up, you need to [reset password](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-classic-reset-access/) post restre using VM Access extension. 
