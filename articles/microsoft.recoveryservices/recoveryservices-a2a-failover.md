...
- [**Looking for guidance on how to Failover and failback** Azure VMs between Azure regions?](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-tutorial-failover-failback) <br>
- [Retaining IP address after failover](https://docs.microsoft.com/azure/site-recovery/concepts-on-premises-to-azure-networking#retaining-ip-addresses)<br>
