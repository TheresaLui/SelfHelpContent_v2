...
- [Issue] [*Connect button grayed out on VM*](https://aka.ms/unable_to_rdp_no_connectbutton)<br>
- [Issue] [*Connect button available but unable to RDP/SSH to VM*](https://aka.ms/unable_to_rdp_withconnectbutton)<br>
