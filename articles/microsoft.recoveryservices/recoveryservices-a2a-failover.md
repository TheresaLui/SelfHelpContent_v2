...
- [Issue] [*Connect button grayed out on VM*](https://aka.ms/unable_to_rdp_withconnectbutton)<br>
- [Issue] [*Connect button available and unable to RDP/SSH to VM*](https://aka.ms/unable_to_rdp_no_connectbutton)<br>
