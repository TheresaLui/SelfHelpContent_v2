...
## **Recommended steps**
- [**How to Fail over and fail back** Azure VMs between Azure regions?](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-tutorial-failover-failback)
...
- **Connect button greyed out?** [assign your virtual machine a public IP address](https://docs.microsoft.com/azure/site-recovery/site-recovery-monitoring-and-troubleshooting#adding-a-public-ip-on-a-resource-manager-virtual-machine)</br>
...
- [Retaining IP address during fail over](https://docs.microsoft.com/azure/site-recovery/concepts-on-premises-to-azure-networking#retaining-ip-addresses)
- [Assigning new IP address](https://docs.microsoft.com/azure/virtual-network/virtual-networks-static-private-ip-arm-pportal)
