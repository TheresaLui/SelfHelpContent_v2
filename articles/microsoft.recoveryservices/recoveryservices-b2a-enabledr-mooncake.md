...
* Ensure that the server that you are trying to protect meets the following requirements
	...
	-   Name of the server should meet requirements of Azure virtual machine name – length should be less than 16 characters and contain Alphanumeric, underscore, and hyphen.
...
[Hyper-V Site to Azure](https://docs.azure.cn/site-recovery/hyper-v-site-walkthrough-overview)
