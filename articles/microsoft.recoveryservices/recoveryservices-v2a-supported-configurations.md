<properties
    pageTitle="VMware to Azure - Supported Configurations"
    description="VMware to Azure - Supported Configurations"
...
* Supported [Azure storage/compute configurations](https://docs.microsoft.com/azure/site-recovery/vmware-physical-azure-support-matrix#azure-storage)<br>
* Supported [Azure VM configurations](https://docs.microsoft.com/azure/site-recovery/vmware-physical-azure-support-matrix#azure-vm-requirements)<br>
* Supported [Site Recovery churn/data change limits](https://docs.microsoft.com/azure/site-recovery/vmware-physical-azure-support-matrix#azure-site-recovery-churn-limits)
