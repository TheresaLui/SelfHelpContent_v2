...
**Backup**
- [Steps to enable backup for a SQL database in Azure VM](https://docs.microsoft.com/azure/backup/backup-sql-server-database-azure-vms)
- How to [enable auto-protection for a standalone SQL server](https://docs.microsoft.com/azure/backup/backup-sql-server-database-azure-vms#enable-auto-protection)
...
- [FAQs](https://docs.microsoft.com/azure/backup/faq-backup-sql-server)
