...
- Special restore configuration requirements for [**LVM/RAID arrays for Linux VM**](https://docs.microsoft.com/en-us/azure/backup/backup-azure-restore-files-from-vm#lvmraid-arrays-for-linux-vms)
