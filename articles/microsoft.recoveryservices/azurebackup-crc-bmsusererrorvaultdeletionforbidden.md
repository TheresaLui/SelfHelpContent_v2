...
* To disable the soft delete feature for newly created vaults, refer to [disabling soft delete](https://docs.microsoft.com/azure/backup/backup-azure-security-feature-cloud#disabling-soft-delete)
* Step-by step instruction to [delete a Recovery Services Vault](https://docs.microsoft.com/azure/backup/backup-azure-delete-vault)
