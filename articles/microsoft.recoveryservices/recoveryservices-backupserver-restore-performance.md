...
**Unable to Backup?**
To resolve common slow Backup/Restore, follow the below best practices:
- [Backup agent running on an Azure virtual machine](https://docs.microsoft.com/azure/backup/backup-azure-troubleshoot-slow-backup-performance-issue#cause-backup-agent-running-on-an-azure-virtual-machine)
- [Steps to ensure there are no conflicts with another process or antivirus](https://docs.microsoft.com/azure/backup/backup-azure-troubleshoot-slow-backup-performance-issue#cause-another-process-or-antivirus-software-interfering-with-azure-backup)
- [Steps to understand bottlenecks in the case of large number of files](https://docs.microsoft.com/azure/backup/backup-azure-troubleshoot-slow-backup-performance-issue#cause-performance-bottlenecks-on-the-computer)
