...
## **Recommended Steps**
- [Can I see details for scheduled backup jobs in the Jobs menu?](https://docs.microsoft.com/en-us/azure/backup/backup-azure-sql-database#can-i-see-details-for-scheduled-backup-jobs-in-the-jobs-menu)</br>
- [Do successful backup jobs create alerts?](https://docs.microsoft.com/en-us/azure/backup/backup-azure-sql-database#do-successful-backup-jobs-create-alerts)</br>
