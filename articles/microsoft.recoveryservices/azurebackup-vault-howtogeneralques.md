...
- [What is the impact of policy change on recovery points?](https://docs.microsoft.com/azure/backup/backup-architecture#impact-of-policy-change-on-recovery-points)
