...
- [Deploy a on-premises scale-out process server](https://docs.microsoft.com/azure/site-recovery/vmware-azure-set-up-process-server-scale)
...
- [Manage process servers](https://docs.microsoft.com/azure/site-recovery/vmware-azure-manage-process-server)
- [Monitor process servers](https://docs.microsoft.com/azure/site-recovery/vmware-physical-azure-monitor-process-server)
