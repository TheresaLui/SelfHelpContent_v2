...
# Site Recovery (VMware to Azure)/Failover: Test failover

## **Unable to connect/RDP/SSH to the failed over virtual machine**

### Connect button is grayed out on the virutal machine 
...
[Detailed failover documentation](https://azure.microsoft.com/en-in/documentation/articles/site-recovery-failover/)

[Troubleshoot RDP connection](https://azure.microsoft.com/en-in/documentation/articles/virtual-machines-windows-troubleshoot-rdp-connection/)
