...
- Ensure the operation currently in progress is completed and retry the backup. For more info, refer this [article](https://docs.microsoft.com/en-us/azure/backup/troubleshoot-azure-files#bmsusererrorobjectlocked--another-operation-is-in-progress-on-the-selected-item)
