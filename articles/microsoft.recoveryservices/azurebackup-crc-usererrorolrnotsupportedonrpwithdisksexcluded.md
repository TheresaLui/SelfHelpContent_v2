...
- Check if your VM is having disk with write accelerator enabled, on Portal > VM > Settings > Disk > [HOST CATCHING](https://docs.microsoft.com/azure/virtual-machines/how-to-enable-write-accelerator#enabling-write-accelerator-using-the-azure-portal)
