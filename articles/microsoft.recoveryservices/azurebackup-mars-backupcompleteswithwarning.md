...
- Check if there are any files in the protected folders which are being pushed by a scanning software, which might be handled by this scanning software and cannot be transfered to Azure Backup service by Azure Backup agent
