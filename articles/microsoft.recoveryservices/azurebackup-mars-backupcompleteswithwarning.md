...
- Ensure there are no files in the protected folder that is pushed by an scanning software, since these files cannot be transferred to Azure Backup service by Azure Backup agent
