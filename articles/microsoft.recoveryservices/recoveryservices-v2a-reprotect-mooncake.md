...
* [Some common issues are also listed here](https://docs.azure.cn/zh-cn/site-recovery/site-recovery-failback-azure-to-vmware#common-issues-in-failback)

## **Recommended documents**
The end to end [failback documentation is here](https://docs.azure.cn/zh-cn/site-recovery/site-recovery-failback-azure-to-vmware)
