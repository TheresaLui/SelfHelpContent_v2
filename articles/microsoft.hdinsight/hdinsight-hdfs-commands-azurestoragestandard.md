<properties
    pageTitle="Azure HDInsights HDFS commands do not work - Azure Storage in Standard Cluster"
    description="Azure HDInsights HDFS Commands do not work - Azure Storage in Standard Cluster"
