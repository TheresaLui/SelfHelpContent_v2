...
* If you are using [Azure Data Lake Store](https://docs.microsoft.com/azure/hdinsight/hdinsight-hadoop-use-data-lake-store) (ADLS Gen1), understand that it not supported for HBASE clusters, and is not supported in HDI version 4.0
