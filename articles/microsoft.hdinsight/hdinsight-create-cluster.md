...
* If you are using [Azure Data Lake Storage Gen1](https://docs.microsoft.com/azure/hdinsight/hdinsight-hadoop-use-data-lake-store), understand that it not supported for HBASE clusters, and is not supported in HDI version 4.0
