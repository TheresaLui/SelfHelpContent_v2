...
## Problem
There is a problem while creating a cluster HDInsight cluster <!--$ClusterDnsName-->[ClusterDnsName]<!--/$ClusterDnsName--> when Service Bypass is disabled.

Since "Allow trusted Microsoft services to access this storage account checkbox is not checked" unable to create a cluster
