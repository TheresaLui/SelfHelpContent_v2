...
## **Recommended Steps**
There is probably a problem with the the user-defined rules for the cluster. Please follow the steps listed in the [troubleshooting guide](https://hdinsight.github.io/ClusterCRUD/hdinsight-udr) to resolve this issue.
