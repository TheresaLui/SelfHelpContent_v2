<properties
    pageTitle="HDInsight Insufficient Number Of Cores"
    description="Insufficient number of cores for resource"
    infoBubbleText="Found recent insufficient number of cores error. See details on the right."
...
You will have to create a support request by following these steps:

1. Set Issue type as Service and subscription limits (quotas)
