...
## **Recommended steps**
 ...
 2. For Linux clusters, if you cannot recall your SSH credentials, you can [reset the credentials within the Ambari UI](https://docs.azure.cn/hdinsight/hdinsight-administer-use-portal-linux#change-passwords).  For Windows clusters, you can change your credentials by opening the Cluster Login or Remote Desktop settings in the portal.
