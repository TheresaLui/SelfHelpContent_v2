<properties
    pageTitle="Azure HDInsights HDFS commands do not work - WASB in cluster with Enterprise Security Package"
    description="Azure HDInsights HDFS commands do not work - WASB in cluster with Enterprise Security Package"
