...
The AllowCloudPasswordValidation policy has not been set by the tenant. <br>
The Company Administrator of the Azure Active Directory (AAD) tenant should run the following commands to enable AAD to use password hashes for Active Directory Federation Services (ADFS) backed users. <br>
...
2. Enter Connect-AzureAD by using global administrator (tenant administrator) credentials. <br>
