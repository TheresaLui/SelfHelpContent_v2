...
### **My assessment is in am Outdated state, why is that so?**
...
For sizing related queries, refer to [thi documentation](https://docs.microsoft.com/azure/migrate/concepts-azure-vmware-solution-assessment-calculation#sizing)
