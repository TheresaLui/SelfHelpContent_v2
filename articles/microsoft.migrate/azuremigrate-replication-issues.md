...
If this error occurs, stop replication for the virtual machine, [reset changed block tracking](https://aka.ms/migrate/selfhelp/reset_vmware_cbt) on the virtual machine, and then reconfigure replication.
...
Resetting VMware changed block tracking on a virtual machine using VMware PowerCLI: [https://kb.vmware.com/s/article/1031873](https://kb.vmware.com/s/article/1031873)
...
- Your Hyper-V hosts and VMs meet all [requirements and prerequisites](https://aka.ms/migrate/hyperv_migration_support_matrix)
