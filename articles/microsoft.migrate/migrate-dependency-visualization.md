## <properties
	...
	supportTopicIds="32593685,32593690,32593694"
	resourceTags=""
	productPesIds="16348"
...
No, Azure Migrate lets you visualize dependencies for up to one  hour duration. You can go back to a particular date in the last one month, but the duration for which you can visualize the dependencies is up to 1 hour.
...
Typically, the dependencies start showing up after 15-20 minutes of installing the agents. Learn more about [agent installation](https://docs.microsoft.com/en-us/azure/migrate/how-to-create-group-machine-dependencies#download-and-install-the-vm-agents). 
