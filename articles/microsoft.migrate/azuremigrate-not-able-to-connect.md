...
Use Boot diagnostics/Serial Console to validate if your VM has booted up. For Boot diagnostics, you should see the VM login page. Use the Serial Console to ensure you can connect to the VM.

![Boot Diagnostics ](./media/Boot_diagnostics.png)
*Sample Boot diagnostics screenshot*

![SAC Linux](./media/SAC_linux.jpg)
*Sample Serial Console screenshot*

If your VM has booted up, but you are unable to connect to your VM, please refer to the [**Unable to connect to VM**](#unable-to-connect-to-VM)  section below. If your VM has not booted up, refer to the [**VM boot troubleshoot**](#vm-boot-troubleshoot) section below. 
