<properties
	  pageTitle="Upgrade package and test scenario 3"
	  description="Upgrade package and test scenario 3"
	  ...
	  articleId="eade5de2-38fd-4f92-a6b4-63648b57bc23"
	  ownershipId="Cloudnet_VirtualWAN"
/>

# Upgrade package and test scenario 3

The P2S client can connect to the correct HUB, but is unable to reach its destination (VNET/Branch..)
