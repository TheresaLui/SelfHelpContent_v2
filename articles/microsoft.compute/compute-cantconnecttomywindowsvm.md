...
### If your VM is not at the ctl-alt-del screen it may be experiencing a boot error
...
### If your VM is at the ctl-alt-del screen try
...
### If you need help with firewall errors
...
### If you need help with VPN errors
If you are using VPN S2S, RDP to your VM from Internet may not work with forced tunneling enabled. Review [effective routes](data-blade:Microsoft_Azure_Network.EffectiveRoutesBlade.id.$resourceId). With forced tunneling, all outbound traffic destined to Internet will be redirected to on-premises.
