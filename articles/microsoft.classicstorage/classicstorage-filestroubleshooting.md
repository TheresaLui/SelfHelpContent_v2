...
- [My storage account contains "/" and the net use command fails](https://docs.microsoft.com/azure/storage/storage-troubleshoot-file-connection-problems#slashfails)
...
- [Linux VM experiencing random delays in commands like "ls"](https://docs.microsoft.com/azure/storage/storage-troubleshoot-file-connection-problems#delayproblem)
