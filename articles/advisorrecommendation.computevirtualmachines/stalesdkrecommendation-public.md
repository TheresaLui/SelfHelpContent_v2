...
"owner":
  ...
  "description": "Update your current Compute SDK version to the most recent version.",
  "longDescription": "We have identified operations under this subscription using outdated Compute SDK versions. We recommend switching to the latest Compute SDK versions, which might involve changes to your existing codebase, to obtain improved security and performance.",
  "potentialBenefits": "Improved security, performance, data resiliency, and support for new features.",
  "displayLabel": "Update your current Compute SDK version to the most recent version",
  "tip": "Regularly update your Compute SDK versions to prevent security issues and access new features.",
