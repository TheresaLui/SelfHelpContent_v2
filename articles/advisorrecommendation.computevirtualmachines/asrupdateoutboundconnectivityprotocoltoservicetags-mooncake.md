<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="bcfeb92b-fe93-4cea-adc6-e747055518e9_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 1.0,
    "streamNamespace": "cluster('asradxclusmc.chinanorth2.kusto.chinacloudapi.cn').database('ASRKustoDB').GetIPWhitelistedSubscriptionAndVmArmId",
    "dataSource": "Kusto",
