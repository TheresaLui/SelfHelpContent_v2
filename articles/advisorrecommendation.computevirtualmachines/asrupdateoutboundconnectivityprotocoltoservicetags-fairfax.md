<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="bcfeb92b-fe93-4cea-adc6-e747055518e9_Fairfax"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 1.0,
    "streamNamespace": "cluster('asrclusff.kusto.usgovcloudapi.net').database('ASRKustoDB').GetIPWhitelistedSubscriptionAndVmArmId",
    "dataSource": "Kusto",
