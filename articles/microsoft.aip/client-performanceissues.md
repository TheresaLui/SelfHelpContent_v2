...
6. If you are experiencing issues in Excel using macros, please verify you have followed the [Update macros in Excel spreadsheets](https://docs.microsoft.com/azure/information-protection/rms-client/client-admin-guide#update-macros-in-excel-spreadsheets) guidelines
