...
1. If you are not seeing data or receiving an error message when trying to access Log Analytics Dashboard, please verify that you have the [Permissions required for Azure Information Protection analytics](https://docs.microsoft.com/azure/information-protection/reports-aip#permissions-required-for-azure-information-protection-analytics).
