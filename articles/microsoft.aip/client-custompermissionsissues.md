...
If the **Custom Permissions**" option is not available in the Azure Information Protection client, verify that the policy setting **Make the custom permissions option available for users** is enabled for the user. [More information](https://docs.microsoft.com/azure/information-protection/deploy-use/configure-policy-settings)
