...
Please also check the registry settings are defined correctly depending on your Exchange Server version as outlined here:<br>
...
4.	Check Exchange configuration with:<br>
	...
	HKLM\Software\Microsoft\MSDRM\ServiceLocation\Activation Reg_SZ: Default = "https://MicrosoftRMSURL/_wmcs/certification"<br>
	and purge certificates in the Exchange DRM folder in each Exchange server, disable and re-enable IRM. Keep in mind that different Exchange servers may have different registry settings, all should have the same.<br>
