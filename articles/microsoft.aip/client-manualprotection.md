...
4. Verify if you have [Azure AIP onboarding policy](https://docs.microsoft.com/azure/information-protection/deploy-use/activate-service#configuring-onboarding-controls-for-a-phased-deployment) enabled
