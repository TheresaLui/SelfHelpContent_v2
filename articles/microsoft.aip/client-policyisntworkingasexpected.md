...
6. If automatic labeling isn't working for Outlook when attaching a labeled document or Label information doesn't appear properly on files, verify that DRMEncryptProperty isn't defined as described here: [IRM registry settings for security](https://docs.microsoft.com/deployoffice/security/protect-sensitive-messages-and-documents-by-using-irm-in-office#office-2016-irm-registry-key-options)
