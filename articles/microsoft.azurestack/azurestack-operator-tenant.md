...
* To register your Azure Stack enviornment, [Connect to Azure Stack](https://docs.microsoft.com/azure/azure-stack/user/azure-stack-version-profiles-azurecli2#connect-to-azure-stack), using the right parameters for your environment
