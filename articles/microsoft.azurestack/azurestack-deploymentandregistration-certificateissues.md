...
* Starting with the 1808 update, you can [prepare for extension host for Azure Stack](https://docs.microsoft.com/azure/azure-stack/azure-stack-extension-host-prepare), which requires two additional certificates. The extension host will be required starting with the 1811 update<br>
