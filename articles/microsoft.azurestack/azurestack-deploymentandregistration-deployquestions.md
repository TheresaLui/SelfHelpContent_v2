...
2. Use the [Azure Stack capacity planner spreadsheet](https://aka.ms/azstackcapacityplanner) to help you make informed decisions with respect to planning capacity
3. Discuss with your Azure Stack hardware vendor while collecting pre-deployment information
4. Review the worksheets [contained in the planner](https://docs.microsoft.com/azure/azure-stack/capacity-planning-spreadsheet) and use your scenario details to match the system configurations being considered for use or purchase
