...
* If you see a **rainy cloud** error, the most likely cause is that permissions were removed. To resolve the error, un-register and [register Azure Stack Hub](https://docs.microsoft.com/azure-stack/operator/azure-stack-registration). 
