...
2. VMs that run Windows Server 2012 or earlier are not automatically activated and must be activated by using <a href="https://docs.microsoft.com/previous-versions/tn-archive/ff793438(v=technet.10)">MAK activation</a>, using your own product key.
...
* <a href="https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/dn303421(v=ws.11)">Automatic VM Activation (AVMA)</a> for Windows Server 2012 R2 and newer versions
