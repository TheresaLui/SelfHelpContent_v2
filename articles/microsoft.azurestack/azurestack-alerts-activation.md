...
2. VMs that run Windows Server 2012 or earlier are not activated automatically, and must be activated by using <a href="https://docs.microsoft.com/previous-versions/tn-archive/ff793438(v=technet.10)">MAK activation</a>, using your own product key.
