<properties
    pageTitle="Azure Stack Windows VM restarted or stopped unexpectedly"
    description="Azure Stack Windows VM restarted or stopped unexpectedly"
...
- [Configure availability sets for virtual machines with Azure CLI](https://docs.microsoft.com/azure/virtual-machines/windows/tutorial-availability-sets)
- [Understand planned maintenance for virtual machines in Azure](https://docs.microsoft.com/azure/virtual-machines/windows/maintenance-and-updates)
