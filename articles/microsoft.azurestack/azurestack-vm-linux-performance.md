...
- As a virtual machines boots up, the [boot diagnostic agent](https://docs.microsoft.com/azure/virtual-machines/troubleshooting/boot-diagnostics) captures screen output that can be used for troubleshooting purposes in the portal.
...
- Review supported metrics with Azure Monitor on Azure Stack, and then retrieve metrics from [Azure Monitor for VMs](https://docs.microsoft.com/azure/azure-monitor/overview#azure-monitor-for-vms) in the public portal.
