...
Azure virtual machine scale sets let you create and manage a group of identical, load balanced, and auto-scaling VMs. Learn how to create, configure, manage, and auto-scale virtual machine scale sets with our quick-starts, tutorials, and samples.
