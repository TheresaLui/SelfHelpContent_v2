...
1. Review the release notes for any known issues for the specific update package. This is listed under [Update Package Release Cadence](https://docs.microsoft.com/azure/azure-stack/azure-stack-servicing-policy#update-package-release-cadence).
