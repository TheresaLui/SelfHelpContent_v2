...
## How to Reset Admin or User Password
...
**Note:** 
- Microsoft does not have, nor can we retrieve the old password. Customers must restore access by resetting the password to a new value of their choosing.
- The admin login name cannot be changed after the logical server is created.
