...
### **There could be several reasons why there is charges on your free account and free services usage**
...
If you believe you have unexpected charges under your Free Trial account, below are the steps that can help you look up the bill and understand it.

1. Please get the Invoice ID from the invoice pdf. This should also be available in the invoice email that account admin would have received.
2. Please search for this invoice number in Azure Portal. You will be able to find the Invoice link. If you do not have the permission to view invoices then you might receive a message saying **‘Either the invoice doesn't exists or you don't have access to view the invoice.'** Please see [manage billing access](https://docs.microsoft.com/azure/cost-management-billing/manage/manage-billing-access#opt-in) to know the roles that can access invoice.
4. Please click on the Invoice link and details of the invoice will show in Portal. The data under **Billing summary** should exactly match the charges details in your invoice.
5. Please click the **View in Cost Analysis**. This will open the detailed cost analysis view of the invoice showing the different resources with their associated fields such as service type etc.
6. Clicking on the resource link can show details of the SKU information. If a free SKU is not used and if $200 Azure credit is finished, a charge will get incurred. For complete list of eligible services in free trial account please see [Free services](https://azure.microsoft.com/free/free-account-faq/).
7. If you opted for a support plan when you upgraded the cost of support plan will show in the above view as well. If you wish to cancel your support plan please see [Cancel a support plan](https://azure.microsoft.com/resources/knowledge-center/how-do-i-change-or-cancel-my-azure-support-plan/).
8. In the same view, if you group by Publisher Type you may see cost where publisher is not Azure. All resources where publisher is not Azure is charged. We have a lot of offerings in Azure Market Place from external publishers. For list of marketplace offering with the publisher info please see [Azure marketplace](https://azuremarketplace.microsoft.com/marketplace/).
9. If you want to get rid of the future cost, you can click on the resource link in the above view and delete the resource using instructions [manage resources](https://docs.microsoft.com/azure/azure-resource-manager/management/manage-resources-portal#open-resources). Please note you need to have permissions to the subscription/resource. If you wish to cancel a subscription please see Cancel subscription.
10. Please note in case of deletion, you might still see some charge for the resource in the next invoice. This charge would map to the usage incurred during the billing period for the period between 5th of the month and date when you deleted the source.
