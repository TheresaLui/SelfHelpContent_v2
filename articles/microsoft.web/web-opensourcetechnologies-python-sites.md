...
* [Running Python Web job on Azure App Services using non-default python version](https://prmadi.com/running-python-webjob-on-azure-app-services-using-non-default-python-version/)
