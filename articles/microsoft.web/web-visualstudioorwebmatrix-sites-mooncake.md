...
[How to create and deploy a simple ASP.NET MVC web project by using Visual Studio and Web Deploy](https://docs.azure.cn/app-service-web/app-service-web-get-started-dotnet)<br>
...
[How to Deploy Azure WebJobs using Visual Studio.](https://docs.azure.cn/app-service-web/websites-dotnet-deploy-webjobs)<br>
