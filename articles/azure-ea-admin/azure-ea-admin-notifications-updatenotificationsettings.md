...
1. Email Address: The email address associated with the Enterprise Administrator's Microsoft Account, Work, or School Account that receives the notifications
1. Unbilled Balance Notification Frequency: The frequency that notifications are set to send to each individual Enterprise Administrator

To add a contact:

1. Click **+Add Contact**
1. Enter the email address and then confirm it
1. Click **Save**
