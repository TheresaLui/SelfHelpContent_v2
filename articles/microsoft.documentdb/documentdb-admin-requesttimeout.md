...
The application should check for the return value and handle the timeout.  All server side execution have to check for the return value "isAccepted" and handle based on the returned value.  
