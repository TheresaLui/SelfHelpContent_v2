...
GitHub DocumentDB .NET Sample Code](https://github.com/Azure/azure-documentdb-dotnet/blob/master/samples/code-samples/Queries/Program.cs#L664-L734) for .NET SDK 1.9.2 and above.

## **Recommended documents**
[Performance Tips](https://azure.microsoft.com/documentation/articles/documentdb-performance-tips/)<br>
