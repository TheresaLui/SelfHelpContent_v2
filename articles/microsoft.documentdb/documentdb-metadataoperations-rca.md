...
Retrieve the names of your databases and collections from configuration or cache them on start. Calls like *ReadDatabaseAsync*/*ReadDocumentCollectionAsync* or *CreateDatabaseQuery*/*CreateDocumentCollectionQuery* will result in calls to the service, and will consume RUs. They must be performed infrequently, i.e. not on every call. 
