...
reflect the availability have gone down. 

Otherwise, ensure the application has implemented the Peformance Tips with respect to Networking and SDKs from https://docs.microsoft.com/azure/cosmos-db/performance-tips#networking. 
Also, review the client resource such as CPU memory pressure on the client machine.
