<properties
    articleId="ac92ca9c-31p2-017a-a5e4-49812c98d489"
    pageTitle="I am unable to install the mobility service agent due to Azure extension issues"
    description="I am unable to install the mobility service agent due to Azure extension issues"
    authors="TobyTu"
    ms.author="sideeksh"
...
---
{
    ...
    "title": "I am unable to install the mobility service agent due to Azure extension issues",
    "fileAttachmentHint": "",
    "formElements": [
        {
