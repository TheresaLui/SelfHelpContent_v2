...
---
{
	...
	"formElements": [{
		...
		},
		{
			...
			"order": 4,
			"controlType": "dropdown",
            "infoBalloonText": "Info: <a href="https://docs.microsoft.com/en-us/azure/backup/tutorial-backup-sap-hana-db#setting-up-permissions">Learn more</a> about the required permissions",
		...
		},
		{
            ...
            "infoBalloonText": "Info: <a href="https://docs.microsoft.com/en-us/azure/backup/tutorial-backup-sap-hana-db#setting-up-permissions">Learn more</a> about the scenarios we support",
