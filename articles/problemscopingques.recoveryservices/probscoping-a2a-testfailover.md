<properties
         pageTitle="Scoping questions for Azure VM test failover failures"
         description="Scoping questions for Azure VM test failover failures"
         authors="genlin"
         ms.author="asgang"
...
---
{
    ...
    "formElements": [
        ...
        },
        {
            ...
            "displayLabel": " I am trying to do Test failover, but ",
            "watermarkText": "Choose an option",
            "dropdownOptions": [
                {
                    "value": "Test failover failed",
                    "text": " Test failover failed"
                },
                {
                    "value": "Test failover is stuck ",
                    "text": "Test failover is stuck "
                },
                {
                    "value": "Test failover succeeded but failed to get the desired IP",
                    "text": "Test failover succeeded but failed to get the desired IP"
                },
		        {
