<properties
    pageTitle="Upgrade the standard disks attached to your premium-capable VM to premium disks (Preview)"
    description="Upgrade the standard disks attached to your premium-capable VM to premium disks (Preview)"
    authors="aadevteam"
    ms.author="aadevteam"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 1.0,
    "streamNamespace": "AzureStorage.Data.StorageAdvisorStandardToPremiumMigration_Fairfax",
    "dataSource": "Cosmos",
