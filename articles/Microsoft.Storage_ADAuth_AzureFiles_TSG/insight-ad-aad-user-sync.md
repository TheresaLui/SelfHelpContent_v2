...
1. You can verify if the AD User's identity is synced to Azure AD by using [this TSG](https://aka.ms/ADOnPremToAAD). If you dont see the identity synced with AAD, please engage the AAD team to verify customer's AAD Sync setup and take their help to resolve this sync issue. Use this support topic path to cut a collaboration task with them: "Azure/Azure Active Directory User Provisioning and Synchronization/Syncing from AD to AAD". 
