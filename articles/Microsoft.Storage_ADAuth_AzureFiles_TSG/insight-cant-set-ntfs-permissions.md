...
The user needs **Storage File Data SMB Share Elevated Contributor** RBAC permission on the file share in order to be able to set NTFS permissions. Please use ASC to verify if the user has this RBAC permission. See:  https://supportability.visualstudio.com/AzureVMPOD/_wiki/wikis/AzureVMPOD/295083/ADAuth-for-Azure-Files-Access-Denied.md?anchor=things-to-check
