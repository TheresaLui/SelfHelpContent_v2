...
* Create real-time inference pipeline
  - If your training pipeline contains more than one **Train Model** module, select one **Train Model** module when you create real-time inference pipeline. Real-time inference pipeline can only contain one trained model.
