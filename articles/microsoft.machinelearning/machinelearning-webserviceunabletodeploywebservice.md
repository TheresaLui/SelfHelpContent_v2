...
## **Recommended steps**
If you are unable to deploy your web service and are seeing this error during deployment, it's likely that this account does not have sufficient access to the Azure subscription that contains the Workspace.
