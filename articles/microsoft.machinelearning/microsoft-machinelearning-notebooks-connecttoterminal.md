<properties
	pageTitle="Can't connect to terminal"
	description="Can't connect to terminal"
	infoBubbleText="Can't connect to terminal"
	service="microsoft.machinelearning"
	resource="machinelearning"
	authors="abeomor"
	ms.author="osomorog"
	supportTopicIds="32739646"
	productPesIds="16644"
	cloudEnvironments="public, fairfax, mooncake, usnat, ussec"
	articleId="microsoft.machinelearning.notebooks-connecttoterminal"
...
4. If the Terminal continues to fail, make sure the Compute Instance is stopped and create a new one
