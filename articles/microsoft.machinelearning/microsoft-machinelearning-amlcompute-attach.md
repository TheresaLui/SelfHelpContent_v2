<properties
    pageTitle="Issues with attaching Azure VM's, Azure databricks or HDInsights"
    description="Article on issues while attaching Azure VM's, Azure databricks or HDInsights"
    service="microsoft.machinelearning"
    resource="Microsoft.MachineLearningServices/workspaces/computes"
    authors="sauryadas"
    ms.author="saudas"
    selfHelpType="generic"
    articleId="microsoft-machinelearning-amlcompute-attach.md"
...
# When you are hitting issues attaching compute such as Azure VM's, Azure databricks or HDInsights
