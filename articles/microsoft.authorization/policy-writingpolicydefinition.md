...
Be sure to validate that the definition structure (information found : [policy definition](https://docs.microsoft.com/azure/governance/policy/concepts/definition-structure)) is correct, [alias](https://docs.microsoft.com/azure/governance/policy/tutorials/create-custom-policy-definition#find-the-property-alias) is mapped to the desired resource type/property and effects are as expected.
...
If an alias does not exist, please create a support ticket.
