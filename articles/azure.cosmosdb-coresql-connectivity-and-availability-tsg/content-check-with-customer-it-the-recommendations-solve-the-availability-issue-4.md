<properties
	  pageTitle="Check with customer it the recommendations solve the Availability issue"
	  description="Check with customer it the recommendations solve the Availability issue"
	  ...
	  articleId="9704b56d-83cd-4ccd-9871-70cd3d0abdc5"
	  ownershipId="AzureData_AzureCosmosDB"
/>

# Check with customer it the recommendations solve the Availability issue
