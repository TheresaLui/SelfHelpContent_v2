...
---
{
        ...
        },
	{
            ...
            "displayLabel": "What issue are you facing with elastic pools?",
            "required": true,
            "dropdownOptions": [
                {
                    "value": "creation_deletion",
                    "text": "Creating or deleting an elastic pool?"
                },
                {
                    "value": "adding_database",
                    "text": "Adding a database to elastic pool?"
                },
                {
                    "value": "removing_database",
                    "text": "Removing database from elastic pool?"
                },
		{
                    "value": "scaling",
                    "text": "Changing the service tier of an elastic pool?"
                },
                {
