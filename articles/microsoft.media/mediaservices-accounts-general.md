...
Azure Media Services accounts can be created directly in the portal, using the Azure CLI (cloudshell or local), using the REST API one of the many client libraries. 
