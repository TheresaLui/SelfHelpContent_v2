...
Our internal service telemetry detected that your streaming endpoint(s) under your Azure Media Services account **<!--$amsAccountName--> amsAccountName <!--/$amsAccountName-->** had performance issues from  **<!--$startTime--> startTime <!--/$startTime-->** to **<!--$endTime--> endTime <!--/$endTime-->**

 (UTC) due to high traffic or heavy processing.
