...
* If you [receive a 403 error when installing the agent](https://docs.microsoft.com/azure/log-analytics/log-analytics-agent-linux-support#issue-you-receive-a-403-error-when-trying-to-onboard):

    a. Run the `date` command on the Linux machine. If the date is over 15 minutes ahead or behind the current time, onboarding will fail.
