...
* [Verify the user account Group Policies](https://docs.microsoft.com/services-hub/health/assessments-troubleshooting#verify-the-user-account-group-policies)<br>
* [Inactive Assessment or No Data is found in Azure Log Analytics ](https://docs.microsoft.com/services-hub/health/assessments-troubleshooting#inactive--no-data-found-in-azure-log-analytics)
