...
* [Usage and estimated costs](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/manage-cost-storage#understand-your-usage-and-estimate-costs)
* [Understanding the source of your workspace’s data ingestion](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/manage-cost-storage#understanding-ingested-data-volume)
* [Log Analytics pricing model](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/manage-cost-storage#pricing-model)
...
It is highly recommended to [configure an alert](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/manage-cost-storage#alert-when-daily-cap-reached) so you know when the daily cap has been met.
...
1.	Daily Cap you configured on your workspace was reached. You can either wait until the end of the 24 hour period for collection to resume, or [raise the Daily Cap setting](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/manage-cost-storage#set-the-daily-cap). 
...
**Recommended Documents**
* [Troubleshooting Log Analytics data collection](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/manage-cost-storage#troubleshooting-why-log-analytics-is-no-longer-collecting-data)
* [Changing pricing tiers](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/manage-cost-storage#troubleshooting-why-log-analytics-is-no-longer-collecting-data)
* [Managing your daily cap](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/manage-cost-storage#troubleshooting-why-log-analytics-is-no-longer-collecting-data)
