...
## **Recommended steps**
* If you have not created rules, go to "Configure" to create rules , select source and destinations and set thresholds to start monitoring. [Learn more](https://docs.microsoft.com/en-us/azure/azure-monitor/insights/network-performance-monitor#configure-the-solution)<br>
