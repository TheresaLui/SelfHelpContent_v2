...
3. Log into the machine with appropriate privileges to add and remove software. Click on the Windows start button and type "Add or Remove Programs"
	* If the **Microsoft Monitoring Agent** is listed, click it, and choose **Uninstall**
...
[Powershell Installation of Windows Log Analytics Agent Extension](https://docs.microsoft.com/en-us/azure/virtual-machines/extensions/oms-windows#powershell-deployment) <br>
