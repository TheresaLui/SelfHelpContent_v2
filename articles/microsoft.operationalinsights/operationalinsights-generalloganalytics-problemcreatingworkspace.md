...
* Installed solutions and linked services such as Azure Automation account are permanently removed from the workspace and can’t be recovered.<br>
...
* You can create Log Analytics workspace in any of the supported [regions](https://azure.microsoft.com/global-infrastructure/services/?products=monitor&regions=all)<br>
