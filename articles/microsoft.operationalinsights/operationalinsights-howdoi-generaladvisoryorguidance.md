...
Review the following topics for information and troubleshooting. If you didn't find an answer for your inquiry, try the the [discussion forum](https://social.msdn.microsoft.com/Forums/home?forum=opinsights). When opening a support request, use the support path to the right of "**|**" and help route it quicker.<br> 
...
* How to [query Diagnostics data]( https://docs.microsoft.com/azure/azure-monitor/platform/diagnostic-logs-stream-log-store#examples) in a Log Analytics workspace **|** *How Do I* > *How to query specific data*
...
* Analyze [Azure Active Directory log](https://docs.microsoft.com/azure/active-directory/reports-monitoring/howto-analyze-activity-logs-log-analytics) **|** *Monitoring non-VMs resources* > *Other*
* Analyze [Application gateway]( https://docs.microsoft.com/azure/application-gateway/application-gateway-diagnostics#diagnostic-logging) **|** *Monitoring non-VMs resources* > *Other*
* [On-Demand Assessments](https://docs.microsoft.com/services-hub/health/getting_started_with_on_demand_assessments) and view [Assessment FAQs](https://docs.microsoft.com/services-hub/health/assessments_faq) **|** *Monitoring non-VMs resources* > *Assessment - On-demand and Health Check (Active Directory, SQL)*
...
* [Network Performance Monitoring](https://docs.microsoft.com/azure/azure-monitor/insights/network-performance-monitor) - configuration, service connectivity monitoring and ExpressRoute monitor **|** *Monitoring non-VMs resources* > *Network monitoring - NPM, DNS*
