...
You shouldn't share the same QnA Maker App Service. But you can share the 'App Service Plan'. Please find the details [here](https://docs.microsoft.com/en-us/azure/cognitive-services/qnamaker/concepts/azure-resources#share-services-with-qna-maker).

* **How to configure App Service to handle more RPS (Request Per Second)?**<br>
You have full control to scale up/down the app service as per your RPS needs. You can find the recommended settings [here](https://docs.microsoft.com/en-us/azure/cognitive-services/qnamaker/concepts/azure-resources#recommended-settings).
...
* [Manage and Customize QnA Maker Azure Resources](https://docs.microsoft.com/en-us/azure/cognitive-services/qnamaker/concepts/azure-resources)
