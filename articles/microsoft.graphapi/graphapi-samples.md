<properties
	pageTitle="Microsoft Graph samples issues"
	description="Information to help resolve Microsoft Graph samples issues."
...
- [Getting started building Microsoft Graph apps](https://developer.microsoft.com/graph/get-started)
