<properties
    pageTitle="Logic App on-premise connectors - Biztalk"
    description="Logic App on-premise connectors - Biztalk"
    service="microsoft.logicapps"
    resource="logicapps"
    authors="v-miegge"
    ms.author="kawilson"
    selfHelpType="generic"
    supportTopicIds="32742510"
    resourceTags=""
     productPesIds="15791"
    ownershipId="Compute_LogicApps"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="00c4e2d1-9356-48f3-9f4b-222e061ef0fd"
/>

# Logic App on-premise connectors - Biztalk

Biztalk is part of Microsoft's hybrid integration platform to run BizTalk based applications side by side connecting to On-Premise Line of Business systems.
...
## BizTalk Connector Reference

[BizTalk Server connector](https://docs.microsoft.com/connectors/biztalk/)
