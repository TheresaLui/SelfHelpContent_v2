<properties
    pageTitle="Logic App on-premise connectors - IBM Informix"
    description="Logic App on-premise connectors - IBM Informix"
    service="microsoft.logicapps"
    resource="logicapps"
    authors="v-miegge"
    ms.author="kawilson"
    selfHelpType="generic"
    supportTopicIds="32742528"
    resourceTags=""
     productPesIds="15791"
    ownershipId="Compute_LogicApps"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="a240cf81-43ea-43e3-9c6a-161d1996fed7"
/>

# Logic App on-premise connectors - IBM Informix

Integrates Azure applications with resources stored in an IBM Informix database. Microsoft Connector for Informix integrates Azure applications with resources stored in an IBM Informix database. Connector supports SELECT, INSERT, UPDATE, and DELETE operations.
...
## IBM Informix [Preview] Connector Reference

[Microsoft Connector for Informix](https://docs.microsoft.com/connectors/informix/)
