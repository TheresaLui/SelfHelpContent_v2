<properties
    pageTitle="Tools and management - REST API"
    description="Tools and management - REST API"
    ...
    articleId="b12cc6b6-6be3-4f1d-9316-dde135fef5c0"
/>

# Tools and management - REST API
