<properties
    pageTitle="Logic App on-premise connectors - IBM DB2"
    description="Logic App on-premise connectors - IBM DB2"
    service="microsoft.logicapps"
    resource="logicapps"
    authors="v-miegge"
    ms.author="kawilson"
    selfHelpType="generic"
    supportTopicIds="32742527"
    resourceTags=""
     productPesIds="15791"
    ownershipId="Compute_LogicApps"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="cbae9c51-f557-4b37-81d2-eb0b3edc96db"
/>

# Logic App on-premise connectors - IBM DB2

Integrate Azure applications with resources stored in an IBM DB2 database.
