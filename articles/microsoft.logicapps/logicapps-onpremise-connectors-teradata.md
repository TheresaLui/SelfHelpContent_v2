<properties
    pageTitle="Logic App on-premise connectors - Teradata"
    description="Logic App on-premise connectors - Teradata"
    service="microsoft.logicapps"
    resource="logicapps"
    authors="v-miegge"
    ms.author="kawilson"
    selfHelpType="generic"
    supportTopicIds="32742552"
    resourceTags=""
     productPesIds="15791"
    ownershipId="Compute_LogicApps"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="46276307-8500-4594-9657-d600c97e2a5d"
/>

# Logic App on-premise connectors - Teradata

Azure Logic App connects to an on-premises Teradata database to read data from tables.
...
## Teradata Connector Reference

[Teradata Connector](https://docs.microsoft.com/connectors/teradata/)
