<properties
    pageTitle="Logic App on-premise connectors - PostgreSQL"
    description="Logic App on-premise connectors - PostgreSQL"
    service="microsoft.logicapps"
    resource="logicapps"
    authors="v-miegge"
    ms.author="kawilson"
    selfHelpType="generic"
    supportTopicIds="32742536"
    resourceTags=""
     productPesIds="15791"
    ownershipId="Compute_LogicApps"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="e64b7265-45d7-40a1-8054-4952e8985a3b"
/>

# Logic App on-premise connectors - PostgreSQL

Connect Azure Logic App to on-premise PostgreSQL database to read data from tables.
...
## PostgreSQL [Preview] Connector Reference

[PostgreSQL Connector](https://docs.microsoft.com/connectors/postgresql/)
