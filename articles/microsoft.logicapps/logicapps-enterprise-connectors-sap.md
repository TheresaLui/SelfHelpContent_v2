...
- [How to send messages to SAP](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#send-message-to-sap)
- [XML samples for RFC requests](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#xml-samples-for-rfc-requests)
- [XML samples for BAPI requests](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#xml-samples-for-bapi-requests)
- [XML samples for IDoc requests](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#xml-samples-for-idoc-requests)
- [Generate schemas](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#add-an-sap-action-to-generate-schemas)

## Receive messages from SAP
- [How to receive messages from SAP](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#receive-message-from-sap)
...
## Tips and tricks
- [De-duplicate IDOC transmission](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#avoid-sending-duplicate-idocs)
- [Specify the language for the connection](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#change-language-headers)
- [Large request support](https://docs.microsoft.com/en-us/archive/blogs/david_burgs_blog/large-request-upcoming-support-for-azure-logic-app-sap-connector)
...
- [Known issues and limitations](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#known-issues-and-limitations)

## Troubleshooting
- [Find extended error logs](https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-using-sap-connector#find-extended-error-logs)
- [Logic App SAP connector all the logs](https://docs.microsoft.com/en-us/archive/blogs/david_burgs_blog/logic-app-sap-connector-all-the-logs-to-capture-for-troubleshooting-and-requesting-support)
