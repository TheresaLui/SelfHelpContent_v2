<properties
    pageTitle="Logic App on-premise connectors - SQL Server"
    description="Logic App on-premise connectors - SQL Server"
    service="microsoft.logicapps"
    resource="logicapps"
    authors="v-miegge"
    ms.author="kawilson"
    selfHelpType="generic"
    supportTopicIds="32742550"
    resourceTags=""
     productPesIds="15791"
    ownershipId="Compute_LogicApps"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="9835f3ff-58be-4531-a254-0fd3602b2195"
/>

# Logic App on-premise connectors - SQL Server

Logic Apps allows you to configure on-premises SQL connectors to automate tasks, processes, or workflows that manage your SQL data and resources.
...
[Access data in your SQL database from inside a logic app with the SQL Server connector](https://docs.microsoft.com/azure/connectors/connectors-create-api-sqlazure).
