<properties
    pageTitle="Logic App on-premise connectors - File System"
    description="Logic App on-premise connectors - File System"
    service="microsoft.logicapps"
    resource="logicapps"
    authors="v-miegge"
    ms.author="kawilson"
    selfHelpType="generic"
    supportTopicIds="32742518"
    resourceTags=""
     productPesIds="15791"
    ownershipId="Compute_LogicApps"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="28928b1d-5273-4621-becf-ad3007cccaa1"
/>

# Logic App on-premise connectors - File System
...
Azure Logic Apps and the File System connector lets you [create automated tasks and workflows that create and manage files on an on-premises file share](https://docs.microsoft.com/azure/logic-apps/logic-apps-using-file-connector).
