<properties
    pageTitle="Logic App on-premise connectors - IBM MySQL"
    description="Logic App on-premise connectors - IBM MySQL"
    service="microsoft.logicapps"
    resource="logicapps"
    authors="v-miegge"
    ms.author="kawilson"
    selfHelpType="generic"
    supportTopicIds="32742532"
    resourceTags=""
     productPesIds="15791"
    ownershipId="Compute_LogicApps"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    articleId="dd2b5509-c746-4423-8593-1b2e1a98724c"
/>

# Logic App on-premise connectors - IBM MySQL

An open-source RDBMS to connect to on-premises MySQL database to read and write data.
...
## MySQL [Preview] Connector Reference

[MySQL Connector](https://docs.microsoft.com/connectors/mysql/)
