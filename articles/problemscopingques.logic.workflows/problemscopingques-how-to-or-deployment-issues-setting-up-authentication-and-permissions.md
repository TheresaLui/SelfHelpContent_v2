<properties
	articleId="problemscopingques-authentication"
	pageTitle="Setting up authentication and permissions"
	description="Setting up authentication and permissions"
	supportTopicIds="32588765"
...
---
{
    ...
    "formElements": [
        ...
        },
        {
            ...
            "displayLabel": "Was Authentication working before for this App?",
