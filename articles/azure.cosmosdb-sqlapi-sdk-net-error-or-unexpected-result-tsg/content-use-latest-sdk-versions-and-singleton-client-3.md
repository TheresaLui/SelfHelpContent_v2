<properties
	  pageTitle="Use latest SDK versions and singleton client"
	  description="Use latest SDK versions and singleton client"
	  ...
	  articleId="f586826b-3960-4562-ba6a-fcc4041d9ae9"
	  ownershipId="AzureData_AzureCosmosDB"
/>

# Use latest SDK versions and singleton client

Always ensure you are using the latest SDK, [Azure Cosmos DB .NET SDK for SQL API: Download and release notes](https://docs.microsoft.com/azure/cosmos-db/sql-api-sdk-dotnet). Ensure also you are using singleton client. 

We highly suggest you to also go hrough the following documets.
