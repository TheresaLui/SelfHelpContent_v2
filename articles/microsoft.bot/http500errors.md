...
## **Recommended steps**
	...
	1. Navigate to AppInsights blade. Click "All App service settings", then "Application Insights" button. 
  
  1. And then navigate to "View Application Insights data", and then click the "Analytics" button.
...
[Troubleshooting  Bot Timeout Errors](https://docs.microsoft.com/azure/bot-service/bot-service-troubleshoot-500-errors?view=azure-bot-service-4.0&tabs=dotnetwebapi)
[Troubleshooting Application Insights setting for ASP.NET Web App](https://docs.microsoft.com/azure/azure-monitor/app/asp-net)
[Troubleshooting Application Insights setting for ASP.NET Core Web App](https://docs.microsoft.com/azure/azure-monitor/app/asp-net-core)
