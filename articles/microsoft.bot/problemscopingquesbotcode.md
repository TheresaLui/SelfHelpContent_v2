<properties
	pageTitle="Bot code is returning an exception or an error"
...
/>
# Bot code is returning an exception or an error
---
{
    "$schema": "SelfHelpContent",
    "resourceRequired": true,
    "subscriptionRequired": true,
    "title": "Bot code is returning an exception or an error",
    "fileAttachmentHint": "",
    "formElements": [
        {
        ...
        },
        {
            ...
            "infoBalloonText": "For errors returned from your code",
            "dropdownOptions": [
                {
                    "value": "Error_Null",
                    "text": "Null reference"
                ...
                {
                    "value": "Error_ErrorResponseException",
                    "text": "ErrorResponseException"
                },
				{
                    "value": "Error_Other",
