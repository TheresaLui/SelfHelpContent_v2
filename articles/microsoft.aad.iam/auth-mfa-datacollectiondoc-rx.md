<properties
    ...
    schemaVersion="1"
    articleId="Conditional_Access_Resultant_Set_of_Policy_Issue_rx"
...
---
{
    ...
    "diagnosticCard": {
        ...
        "description": "Click here to use the new <a href='https://portal.azure.microsoft.scloud/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/diagnose/symptomId/ms_aad_dxp_signin_caDiagnoseAndSolveSummarySymptom&launchedFrom=casecreation'>Sign-in Diagnostic</a> Or provide additional input below to see a helpful diagnostic analysis.",
