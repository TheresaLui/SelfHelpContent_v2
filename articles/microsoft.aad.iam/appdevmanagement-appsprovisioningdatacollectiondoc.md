...
---
{
  ...
  "formElements": [
    ...
    },
    {
      ...
      "content": null,
      "watermarkText": "Examples: configure user provisioning to an application, modify attribute mappings for a provisioning-enabled app.",
      "infoBalloonText": null,
      "dropdownOptions": null,
      "dynamicDropdownOptions": null,
      "hints": [],
    ...
    },
    {
      ...
      "order": 5,
      "controlType": "multilinetextbox",
      "displayLabel": "Where is the user trying to accomplish this task?",
      "content": null,
    ...
    },
    {
      ...
      "content": null,
      "watermarkText": "Examples: error message in the Azure portal, error message on signing in, user not provisioned",
      "infoBalloonText": null,
      "dropdownOptions": null,
      "dynamicDropdownOptions": null,
      "hints": [],
