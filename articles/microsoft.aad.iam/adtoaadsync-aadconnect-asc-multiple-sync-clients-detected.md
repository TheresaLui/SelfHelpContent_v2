...
Please validate your setup. If you have multiple sync clients synchronizing by mistake, you need to make sure that **only one** client is **actively exporting** changes to Azure AD.
