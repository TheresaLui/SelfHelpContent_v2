...
---
{
    ...
    "diagnosticCard": {
        ...
        "description": "Click here to use the new [Sign-in Diagnostic](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ConditionalAccessBlade/diagnose/symptomId/ms_aad_dxp_signin_caDiagnoseAndSolveSummarySymptom)
        Or provide additional input below to see a helpful diagnostic analysis.",
