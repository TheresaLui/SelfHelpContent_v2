...
* If <!--$UserId-->[UserId]<!--/$UserId-->  is able to sign in to your Azure AD, they can go to [aka.ms/ssprsetup](https://mysignins.microsoft.com/security-info) to register for self-service password reset
