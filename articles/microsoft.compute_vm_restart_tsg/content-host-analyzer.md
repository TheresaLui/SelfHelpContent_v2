<properties
	pageTitle="Check if Host Analyzer(HA) reports have been created"
	description="Check if Host Analyzer(HA) reports have been created"
	...
	articleId="abe0eb61-2344-408d-b2e8-be16c020857d"
