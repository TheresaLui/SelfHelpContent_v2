...
For more about planned maintenance on Azure, please refer to Planned maintenance for virtual machines in Azure  
For more information on update domains for Virtual Machines, please refer to Manage VM Availability.  
For more information on pending reboot on IaaS Virtual Machine, please refer to In-VM Notification Service.  
Maintenance is scheduled to only impact one region at a single time in each regional pair  . This enables you to deploy VMs across those regions to reduce the impact of the maintenance.
All reboots associated with planned maintenance can be viewed in you virtual machine’s reboot logs.  
