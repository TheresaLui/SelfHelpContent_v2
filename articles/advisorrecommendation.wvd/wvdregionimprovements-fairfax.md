<properties
    ...
    authors="marius"
    ms.author="rdinfra"
    articleId="d89829c9-dadf-4ddc-87d6-fd746debd5d3_Fairfax"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://rdsffx.usgovvirginia.kusto.usgovcloudapi.net').database('WVD').HostRegionShouldAlignWithGatewayRegion",
    "dataSource": "Kusto",
