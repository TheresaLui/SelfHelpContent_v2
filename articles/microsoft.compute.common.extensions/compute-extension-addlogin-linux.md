<properties
	...
	supportTopicIds="32684010,32684011,32684012,32684013,32684014"
	resourceTags=""
...
* [Overview of Azure Active Directory authentication for Linux VMs](https://docs.microsoft.com/azure/virtual-machines/linux/login-using-aad)
* [Enable system-assigned managed identity on an existing VM](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/qs-configure-portal-windows-vm#system-assigned-managed-identity)
* [Enable system-assigned managed identity during creation of a VM](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/qs-configure-portal-windows-vm#enable-system-assigned-managed-identity-during-creation-of-a-vm)
* [Enable system-assigned managed identity on an existing VM](
https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/qs-configure-portal-windows-vm#enable-system-assigned-managed-identity-on-an-existing-vm)
