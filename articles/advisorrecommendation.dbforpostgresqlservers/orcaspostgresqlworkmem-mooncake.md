<properties
    ...
    ms.author="kummanish"
    articleId="2613de4e-b3d7-11e9-a2a3-2a2ae2dbcce4_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazurechi2.chinanorth2.kusto.chinacloudapi.cn').database('MoonCake').GetPostgreSqlWorkMemRecommendations",
    "schemaVersion": 2.0,
    "dataSource": "Kusto",
  ...
  "actions": [
    {
      "actionId": "461e223b-7533-4c06-b166-013727680d88",
  ...
  "resourceMetadata": {
    "action": {
      "actionId": "e0518e61-5e3e-409e-8374-6c1dbfd765c7",
      "actionType": "Blade",
