<properties
    ...
    ms.author="sunila"
    articleId="38f4a461-1543-4089-854c-90e7edf37707_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazurechi2.chinanorth2.kusto.chinacloudapi.cn').database('MoonCake').GetPostgreSqlRightSizeRecommendations",
    "schemaVersion": 2.0,
    "dataSource": "Kusto",
  ...
  "actions": [
    {
      "actionId": "c20dff60-8750-4fd3-a26c-d0f2ab109d9f",
      "description": "Decrease your PostgreSQL server's CPU vCores",
      "actionType": "Blade",
  ...
  "resourceMetadata": {
    "action": {
      "actionId": "ead3ce6a-c113-4664-b722-a2ca399963b9",
      "actionType": "Blade",
      "extensionName": "HubsExtension",
      "bladeName": "ResourceMenuBlade",
      "metadata": {
