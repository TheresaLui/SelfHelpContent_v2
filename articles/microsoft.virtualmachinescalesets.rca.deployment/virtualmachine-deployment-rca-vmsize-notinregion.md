<properties
	...
	ms.author="tiag"
	displayOrder=""
	articleId="VMSS_DeploymentFailure_RCA-vmsize-notinregion"
...
<!--issueDescription-->
We have detected that the deployment for virtual machine scale set **<!--$vmssname-->Virtual machine scale set<!--/$vmssname-->** initiated at **<!--$StartTime-->StartTime<!--/$StartTime--> (UTC)** failed because of a restriction on the VM instance SKU that you are trying to deploy. This resulted in the error:
