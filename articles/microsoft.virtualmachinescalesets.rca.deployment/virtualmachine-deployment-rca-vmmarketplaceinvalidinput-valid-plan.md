<properties
	...
	ms.author="tiag"
	displayOrder=""
	articleId="VMSS_DeploymentFailure_rca-vmmarketplaceinvalidinput-valid-plan"
...
<!--issueDescription-->
We have detected that the deployment for virtual machine scale set **<!--$vmssname-->Virtual machine scale set<!--/$vmssname-->** initiated at **<!--$StartTime-->StartTime<!--/$StartTime--> (UTC)** failed because the plan information required deployment was not present and the image referenced requires Marketplace plan information to be present.
<!--/issueDescription-->
