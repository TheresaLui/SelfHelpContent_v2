<properties
    ...
    authors="timbasham, jasonbandrew"
    ms.author="timbasham, v-jasoan"
...
2. If the file name refers to the file *\Windows\system32\config\SYSTEM* then [save a copy of the OS disk](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-vhd-copy)
