...
## **Recommended Steps**
Currently running in-place upgrade on an Azure VM is not supported however it could be performed by using a *Nested Hyper-V Environment*.  The following steps walk you through how to do this.
