...
7. In the attached OS Disk, browse to the file path noted in Step 1 and rename the file to `[BINARY.SYS].OLD`
...
9. Choose the latest of the list and copy it to the windows\system32 folder path on the attached OS disk with `copy [drive]:\Windows\WinSxS\[directory_where_file_is]\[binary_with_extension] [drive]:\Windows\System32\Drivers\`
