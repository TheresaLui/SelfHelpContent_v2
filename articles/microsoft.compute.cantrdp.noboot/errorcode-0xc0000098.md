...
9. Choose the latest of the list and copy it to the `windows\system32` folder path on the attached OS disk using `copy [drive]:\Windows\WinSxS\[directory_where_file_is]\[binary_with_extension] [drive]:\Windows\System32\Drivers\`
