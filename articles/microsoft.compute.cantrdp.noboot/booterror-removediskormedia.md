<properties
    ...
    description="Virtual machine failed to boot because the OS is unable to boot due to the partition holding the BCD Store is not active or the bboot manager somehow changed and is no longer pointing to the default boot loader identifier."
    infoBubbleText="A boot error 'Remove disks or other media. Press any key to continue.' has been found for your virtual machine."
    service="microsoft.compute"
    resource="virtualmachines"
    authors="jasonbandrew"
    ms.author="v-jasoan"
    displayOrder=""
    articleId="BootError-REMOVE_DISK_OR_MEDIA"
