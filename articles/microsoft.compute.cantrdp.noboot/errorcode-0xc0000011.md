...
# VM boot error
<!--issueDescription-->
## **Boot error diagnostic information for your [vmname]<!--($vmname)-->:**
Windows failed to boot with error code 0xc0000011. The operating system couldn't be loaded because a critical system driver is missing or corrupt.<br>
<!--/issueDescription-->
