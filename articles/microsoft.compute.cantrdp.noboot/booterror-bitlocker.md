...
This behavior is observed if the process of retrieving the BEK files from the BEK volume on Azure platform has encountered issues while starting a VM using the Azure Disk Encryption extension.
