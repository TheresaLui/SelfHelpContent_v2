...
**Why can't I find a work item on the backlog?**
  ...
  - Try changing your settings so that bugs are managed with requirements. [Learn more here](https://docs.microsoft.com/azure/devops/organizations/settings/show-bugs-on-backlog?view=azure-devops).

  - If you have a large team, you may have reached the limit of 10,000 items that can be displayed on the backlog. [Learn more here](https://docs.microsoft.com/azure/devops/organizations/settings/work/object-limits?view=azure-devops#backlogs-boards-and-teams).
...
**Why are Features or Epics missing from the backlog?**
  ...
  - Check the filter to make sure it is not excluding the work item type. [Learn more here](https://docs.microsoft.com/azure/devops/boards/backlogs/filter-backlogs?view=azure-devops).

**I don't see any work items that are in progress**

   Try configuring your backlog view to show work **In Progress**. [Learn more here](https://docs.microsoft.com/azure/devops/boards/backlogs/backlogs-overview?view=azure-devops#in-progress-items-and-work-listed-on-the-backlog).
