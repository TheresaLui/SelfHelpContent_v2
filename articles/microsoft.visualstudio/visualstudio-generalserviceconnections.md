...
* Service connection creation operation failed: Ensure that the service connection is verified while creating it. 
...
* I get the error, "Service Connection is unable to access the pipeline" 
