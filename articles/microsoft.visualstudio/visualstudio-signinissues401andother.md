...
'401 - Work or school, or Personal account'<br>
...
Tip: To avoid seeing this prompt, you can rename your Microsoft account. Then, only one identity (your work or school account, or Azure AD account) uses your sign-in address.<br>
...
For more information on sign-in issues and how to resolve them, please see:<br>
