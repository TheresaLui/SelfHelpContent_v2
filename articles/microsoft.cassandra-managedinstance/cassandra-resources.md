...
- Verify the Azure CosmosDB Network Contributor has permission on the subnet (see https://docs.microsoft.com/azure/network-watcher/required-rbac-permissions)
