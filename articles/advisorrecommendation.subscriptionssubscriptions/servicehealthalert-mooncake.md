<properties
    ...
    authors="ahex"
    ms.author="ahex"
    articleId="c6ac1f03-bd58-4421-9522-23cffb64d8e1_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 1.0,
    "streamNamespace": "cluster('https://azhealthmc.chinaeast2.kusto.chinacloudapi.cn').database('azhealthmcmds').ServiceHealthRecommendation",
    "dataSource": "Kusto",
