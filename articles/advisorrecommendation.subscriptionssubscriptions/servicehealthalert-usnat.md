<properties
    ...
    authors="ahex"
    ms.author="ahex"
    articleId="c6ac1f03-bd58-4421-9522-23cffb64d8e1_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 1.0,
    "streamNamespace": "cluster('https://azureinsights.usnateast.kusto.core.eaglex.ic.gov').database('Insights').ServiceHealthAlertRecommendation",
    "dataSource": "Kusto",
