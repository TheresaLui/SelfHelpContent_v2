...
1. Now, Look at the effecitive routes and find the destination address space and see if you can see the next hop type virtual network gateway pointing to VPN gateway CA address. Note: Traffic do not hit route service in this scenario.