<properties
  pagetitle="Windows Virtual Desktop (classic) - issues creating WVD tenant"
  service=""
  resource=""
...
- [Review general requirements for a Windows Virtual Desktop deployment](https://docs.microsoft.com/azure/virtual-desktop/overview#requirements)