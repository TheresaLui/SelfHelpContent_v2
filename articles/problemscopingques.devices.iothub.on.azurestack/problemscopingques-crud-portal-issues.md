<properties
  articleId="problemscopingques-crud-portal-issues"
  pageTitle="Scoping questions - Issues related to Hub on Stack CRUD operations"
  description="Scoping questions to troubleshoot the issues related to CRUD features of IoT Hub on Azure Stack"
  authors="camanle"
  authoralias="camanle"
  ms.author="camanle"
...
/>
# Issues related to Hub on Stack CRUD operations
---
{
