<properties
  ...
  pageTitle="Scoping questions - Issues related to Hub on Stack device issues"
  description="Scoping questions to troubleshoot the issues related to device issues on IoT Hub on Azure Stack"
  authors="camanle"
  authoralias="camanle"
  ms.author="camanle"
  selfHelpType="problemScopingQuestions"
  supportTopicIds="32782341, 32782337, 32782338, 32782339, 32782334, 32782331, 32782332"
  productPesIds="17381"
  cloudEnvironments="public, Fairfax, usnat, ussec, mooncake"
  schemaVersion="1"
  ownershipId="AzureIot_IotHub"
/>
# Issues related to Hub on Stack device issues
---
{
