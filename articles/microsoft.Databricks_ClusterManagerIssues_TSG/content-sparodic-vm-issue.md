...
<<<<<<< HEAD
	...
	```
	**Note:**
	You can get metastore IP address from [here](https://docs.microsoft.com/azure/azure-databricks/mysql-ip-address?toc=/azure/databricks/toc.json&bc=/azure/databricks/breadcrumb/toc.json#updated-mysql-ip-addresses) for different regions.<br>
	**Example:**
...
**Note:**
You can get metastore IP address from [here](https://docs.microsoft.com/azure/azure-databricks/mysql-ip-address?toc=/azure/databricks/toc.json&bc=/azure/databricks/breadcrumb/toc.json#updated-mysql-ip-addresses) for different regions.
