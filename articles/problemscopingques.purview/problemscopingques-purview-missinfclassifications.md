<properties
	...
	pageTitle="Scoping Questions for Purview Missing classifications on an asset"
	description="Scoping Questions for Purview Missing classifications on an asset"
	authors="deeptivu"
	ms.author="deeptivu"
...
---
{
    ...
    "fileAttachmentHint": "Share screenshot of you scan rule set that shows the classifications you are trying to match; in case you are using custom classification, please share a screenshot of the custom classification definition",
    "formElements": [
        {
