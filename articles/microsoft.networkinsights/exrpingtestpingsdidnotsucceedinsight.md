...
BGP is currently not up on one or more peerings on one or more devices, listed below. ICMP reachability is currenty down from the MSEE to the customer. If ICMP or ping is not functioning from the MSEE, than BGP is likely down because of this. 
...
## **Recommended steps**
 ...
 + Provider should check to ensure that


## **Recommended document**
[Verifying ExpressRoute connectivity](https://docs.microsoft.com/en-us/azure/expressroute/expressroute-troubleshooting-expressroute-overview) <br>