...
<!--issueDescription-->
The tunnel was disconnected because the gateway {VpnGatewayName} received a Notify Message with an invalid syntax.
<!--/issueDescription-->
## **Issue Details & Mitigation**
The VPN tunnel was disconnected because the Azure VPN gateway received a Notify Message from your on-premises device that had an invalid syntax. Please check your on-premises device and supress invalid Notify Messages.
