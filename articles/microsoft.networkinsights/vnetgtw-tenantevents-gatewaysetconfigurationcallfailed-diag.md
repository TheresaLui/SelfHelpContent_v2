...
/>
# Microsoft Azure has detected a platform configuration issue
<!--issueDescription-->
We have identified a platform configuration issue with the Virtual Network Gateway for VNet **<!--virtualNetworkName-->[virtualNetworkName]<!--/virtualNetworkName-->** with a VIP of: **<!--gatewayVip-->[gatewayVip]<!--/gatewayVip-->** at **<!--preciseTimestamp-->[preciseTimestamp]<!--/preciseTimestamp-->**.
<!--/issueDescription-->
