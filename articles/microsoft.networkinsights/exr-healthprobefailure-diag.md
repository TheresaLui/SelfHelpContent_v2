<properties
pageTitle="ExpressRoute Health Probe Failure"
description="ExpressRoute Health Probe Failure"
...
<!--issueDescription-->
We have identified an Azure platform configuration issue for your private peering ExpressRoute connection to virtual network ID: **<!--$VNetId-->[VNetId]<!--/$VNetId-->**. The initial diagnosis is showing that your Virtual Network Gateway is not responding to health probes. See below for more details and steps for mitigation.
<!--/issueDescription-->
## **Mitigation Steps**
