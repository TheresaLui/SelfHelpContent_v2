<properties
pageTitle="Express Route Unexpected Provisioning State"
description="Express Route Unexpected Provisioning State"
infoBubbleText="Issues with your ExpressRoute were detected. See details on the right."
service="microsoft.network"
resource="ExpressRoute"
authors="chadmath"
displayOrder="10"
articleId="ExRVNetGatewayNotProvisionedInsight"
diagnosticScenario="ExRVNetGatewayNotProvisionedInsight"
...
/>
# ExpressRoute Virtual Network Gateway Not Provisioned
<!--issueDescription-->
We have identified a platform connectivity issue for your private peering ExpressRoute connection to virtual network ID: **<!--$VNetId-->[VNetId]<!--/$VNetId-->**. The initial diagnosis is showing that the virtual network gateway for this connection is not in a provisioned state. See below for more details and steps for mitigation.
<!--/issueDescription-->
## **Mitigation Steps**
