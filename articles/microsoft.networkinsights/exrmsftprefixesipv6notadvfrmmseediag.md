<properties 
    ...
    displayOrder=""
    articleId="exrmsftprefixesipv6notadvfrmmseediag"
...
This is likely failing due to missing route filters.  Many services are accessible through peering configured on an ExpressRoute circuit.  The prefixes related to those services are advertised through Border Gateway Protocol (BGP) session that are established.  A BGP community value is attached to every prefix to identify the service that is offered through the prefix. <br> 
<br>
