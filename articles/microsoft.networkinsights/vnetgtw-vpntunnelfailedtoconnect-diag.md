<properties
pageTitle="My Virtual Network Gateway VPN Tunnel Cannot Connect"
description="My Virtual Network Gateway VPN Tunnel Cannot Connect"
infoBubbleText="Issues with your Virtual Network Gateway were detected. See details on the right."
service="microsoft.network"
resource="VirtualNetworkGateway"
authors="chadmath"
displayOrder="10"
articleId="VNGSeamlessVPNTunnelFailedToConnectInsight"
diagnosticScenario="VNGSeamlessVPNTunnelFailedToConnectInsight"
...
/>
# Microsoft Azure has identified the Virtual Network Gateway cannot connect
<!--issueDescription-->
We have identified that your Virtual Network Gateway for Vnet, **<!--virtualNetworkName-->[virtualNetworkName]<!--/virtualNetworkName-->** with a VIP of  **<!--gatewayVip-->[gatewayVip]<!--/gatewayVip-->** has failed to connected due to '**<!--match.Reason-->[match.Reason]<!--/match.Reason-->**'.
