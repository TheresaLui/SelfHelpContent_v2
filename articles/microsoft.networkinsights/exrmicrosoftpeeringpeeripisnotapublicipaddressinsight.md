...
Microsoft peering provides customers with the ability to access Microsoft public services (i.e. Azure Storage, Azure SQL, etc.) over a private connection, bypassing the Internet. <br><br>
The traffic for Microsoft peering does not enter a Virtual Routing Forwarding instance and instead routes advertised to Microsoft peering and the sub-interfaces are within the global routing table. Microsoft recommends public IPs for the peer IPs to ensure uniqueness and ownership. <br><br>
...
[ExpressRoute circuits and routing domains](https://docs.microsoft.com/azure/expressroute/expressroute-circuit-peerings#routing-domain-comparison) <br>