<properties
pageTitle="Express Route Data Path Probe Failure"
description="Express Route Data Path Probe Failure"
infoBubbleText="Issues with your ExpressRoute were detected. See details on the right."
service="microsoft.network"
resource="ExpressRoute"
authors=""
displayOrder="10"
articleId="ExRVNetGatewayDataPathProbeStatusInsight"
diagnosticScenario="ExRVNetGatewayDataPathProbeStatusInsight"
...
<!--issueDescription-->
We have identified an Azure platform configuration issue for your private peering ExpressRoute connection to virtual network ID: **<!--$VNetId-->[VNetId]<!--/$VNetId-->**. The initial diagnosis is showing a datapath probe failure. See below for more details and steps for mitigation.
<!--/issueDescription-->
## **Mitigation Steps**
