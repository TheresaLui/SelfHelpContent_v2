...
7. Use [Instance Level Public IPs](https://docs.microsoft.com/azure/virtual-network/virtual-networks-instance-level-public-ip) for the instances that need to make exceptionally large number of outbound connections.
