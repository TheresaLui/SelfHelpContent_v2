<properties
pageTitle="MSEE BGP Peers Count Does Not Match the Expected BGP Peers Count"
description="MSEE BGP Peers Count Does Not Match the Expected BGP Peers Count"
infoBubbleText="Issues with your ExpressRoute were detected. See details on the right."
service="microsoft.network"
resource="ExpressRoute"
authors=""
displayOrder="10"
articleId="ExRVNetGatewayUnexpectedBgpPeersCountInsight"
diagnosticScenario="ExRVNetGatewayUnexpectedBgpPeersCountInsight"
...
<!--issueDescription-->
We have identified an Azure platform configuration issue for your private peering ExpressRoute connection to virtual network ID: **<!--$VNetId-->[VNetId]<!--/$VNetId-->**. The initial diagnosis is showing that the Microsoft Edge Router has an unexpected BGP peer count. See below for more details and steps for mitigation.
<!--/issueDescription-->
## **Mitigation Steps**
