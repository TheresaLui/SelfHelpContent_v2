<properties
pageTitle="Express Route N-Active Mode Disabled"
description="Express Route N-Active Mode Disabled"
infoBubbleText="Issues with your ExpressRoute were detected. See details on the right."
service="microsoft.network"
resource="ExpressRoute"
authors=""
displayOrder="10"
articleId="ExRVNetGatewayNActiveModeDisabledInsight"
diagnosticScenario="ExRVNetGatewayNActiveModeDisabledInsight"
...
<!--issueDescription-->
We have identified an Azure platform configuration issue for your private peering ExpressRoute connection to virtual network ID: **<!--$VNetId-->[VNetId]<!--/$VNetId-->**. The initial diagnosis is showing that a configuration value does not match expected default value. See below for more details and steps for mitigation.
<!--/issueDescription-->
## **Mitigation Steps**
