...
* [Configure policy-based traffic selectors on VPN connections](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-connect-multiple-policybased-rm-ps)
* [Manage on-premises network settings in Azure Local Network Gateways](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-modify-local-network-gateway-portal)
