...
2. The Function invocation triggered but failed to complete due to an exception during the invocation. Here is an example query to use in Application Insights.  <br>
   ```
   traces
