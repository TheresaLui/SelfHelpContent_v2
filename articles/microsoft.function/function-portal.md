...
1. Your VM is not on the virtual network, e.g. you are trying to do this from your laptop.<br>
2. The DNS entries are missing either from your hosts file or your DNS server if you have a DNS server on the virtual network.<br>
3. The SSL certificate is not trusted.<br>
4. The portal functions site is not listed in the CORS rules of your Function App.<br>
Navigate to the Kudu site of your function app (functionappname.scm.ilbdomain) and log in using the site level credentials available from the Publishing Profile of your function app.<br>
