<properties
    ...
    ms.author="srthatip"
    articleId="7c83695a-3fa9-4668-9080-85151f5ab7be_mooncake"
...
---
{
	...
	"dataSourceMetadata": {
		"streamNamespace": "cluster('analytics365prod.chinanorth2.kusto.chinacloudapi.cn').database('Analytics365PROD').synapse_advisor_SynapseManagementClientSdk",
		"dataSource": "Kusto",
