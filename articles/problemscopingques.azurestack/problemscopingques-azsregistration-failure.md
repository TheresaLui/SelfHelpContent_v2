<properties
    pageTitle="Azure Stack registration failure"
    description="Azure Stack registration failure"
...
/>
# Azure Stack registration failure questions
---
{
  "subscriptionRequired": true,
  "resourceRequired": false,
  "title": "Azure Stack registration failure questions",
  ...
  "formElements": [{
        ...
        },
        {
            ...
            "watermarkText": "Provide additional information and the error message displayed during registration",
            "required": true,
            "useAsAdditionalDetails": true,
      "infoBalloonText": "Provide additional information and the error message displayed during registration",
            "hints": []
        }
    ],
