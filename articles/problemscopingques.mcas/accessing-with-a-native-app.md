<properties
	pageTitle="Cloud App Security - Access and session controls - Accessing with a native app"
	description="Cloud App Security - Access and session controls - Accessing with a native app"
	authors="ms-nagrand"
	ms.author="nagrand"
    ...
    articleId="scoping_MCAS_Accessing with a native app"
	schemaVersion="1"
...
---
{
                ...
                "title": "Access and session controls - Accessing with a native app",
