<properties
	pageTitle="Cloud App Security - Access and session controls - Logging in to a protected app"
	description="Cloud App Security - Access and session controls - Logging in to a protected app"
	authors="ms-nagrand"
	ms.author="nagrand"
    ...
    articleId="scoping_MCAS_Logging in to a protected app"
	schemaVersion="1"
	ownershipId="CloudAppSecurity_CAAC"
/>
# Access and session controls - Logging in to a protected app
---
{
				"$schema": "SelfHelpContent",
                "resourceRequired": false,
                "title": "Access and session controls - Logging in to a protected app",
