<properties
	pageTitle="Cloud App Security - Access and session controls - Access and session policies"
	description="Cloud App Security - Access and session controls - Access and session policies"
	authors="ms-nagrand"
	ms.author="nagrand"
    ...
    articleId="scoping_MCAS_Access and session policies"
	schemaVersion="1"
	ownershipId="CloudAppSecurity_CAAC"
/>
# Access and session controls - Access_and_session_policies
---
{
				"$schema": "SelfHelpContent",
                "resourceRequired": false,
                "title": "Access and session controls - Access and session policies",
