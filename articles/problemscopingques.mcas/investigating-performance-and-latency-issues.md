<properties
	pageTitle="Cloud App Security - Access and session controls - Investigating performance and latency issues"
	description="Cloud App Security - Access and session controls - Investigating performance and latency issues"
	authors="ms-nagrand"
	ms.author="nagrand"
    ...
    articleId="scoping_MCAS_Investigating performance and latency issues"
	schemaVersion="1"
	ownershipId="CloudAppSecurity_CAAC"
/>
# Access and session controls - Investigating performance and latency issues
---
{
				"$schema": "SelfHelpContent",
                "resourceRequired": false,
                "title": "Access and session controls - Investigating performance and latency issues",
