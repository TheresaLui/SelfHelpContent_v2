...
---
{
				...
				"fileAttachmentHint": "1. Please attach the raw data of the activity from MCAS activity log. You can locate it under Investigate - Activity Log - Expand the activity - Source - View raw data 2. Please attach the correlated activity log from the source app. For example, for O365 apps (EXO, SPO, OD, etc.), please export the relevant log from O365 Unified Audit logs",
