<properties
    ...
    authors="prvavill"
    ms.author="kustosee"
    articleId="44D40198-60E8-401C-9D26-8C5FB06C008E_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://kustodataestate.usseceast.kusto.core.microsoft.scloud').database('AdvisorRecommendations').PublishUpdateCacheRecommendations",
    "dataSource": "Kusto",
