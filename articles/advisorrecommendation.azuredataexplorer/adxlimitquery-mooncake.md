<properties
    ...
    authors="prvavill"
    ms.author="kustosee"
    articleId="2F06F696-F664-48AB-9EBC-A3F2969A392D_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://kustodataestate.chinaeast2.kusto.chinacloudapi.cn').database('AdvisorRecommendations').PublishLimitQueryRecommendations",
    "dataSource": "Kusto",
