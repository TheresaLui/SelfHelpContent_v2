<properties
    ...
    authors="t-elbery"
    ms.author="kustosee"
    articleId="354D7BBB-A243-4BE1-A8B9-43DBFC05C44A_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://kustodataestate.chinaeast2.kusto.chinacloudapi.cn').database('AdvisorRecommendations').PublishStoppedClustersRecommendations",
    "dataSource": "Kusto",
