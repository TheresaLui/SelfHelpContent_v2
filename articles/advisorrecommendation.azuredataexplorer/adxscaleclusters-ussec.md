<properties
    ...
    authors="prvavill"
    ms.author="kustosee"
    articleId="729678B1-B3C0-4520-BFDC-49CDE002E365_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 2.0,
    "streamNamespace": "cluster('https://kustodataestate.usseceast.kusto.core.microsoft.scloud').database('AdvisorRecommendations').PublishPerformanceSkuChangeRecommendations",
    "dataSource": "Kusto",
