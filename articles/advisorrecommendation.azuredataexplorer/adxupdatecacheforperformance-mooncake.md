<properties
    ...
    authors="lizlotor"
    ms.author="kustosee"
    articleId="389653ce-d564-4b95-aac4-ca30e1602536_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://kustodataestate.chinaeast2.kusto.chinacloudapi.cn').database('AdvisorRecommendations').PublishUpdateCacheForPerformanceRecommendations",
    "dataSource": "Kusto",
  ...
  "actions": [
    {
      "actionId": "ea6f191b-b03b-45ce-813f-5b211b2e7c95",
      "description": "Reduce cache period",
      "actionType": "Blade",
