<properties
    ...
    authors="t-elbery"
    ms.author="kustosee"
    articleId="354D7BBB-A243-4BE1-A8B9-43DBFC05C44A_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://kustodataestate.usnatwest.kusto.core.eaglex.ic.gov').database('AdvisorRecommendations').PublishStoppedClustersRecommendations",
    "dataSource": "Kusto",
