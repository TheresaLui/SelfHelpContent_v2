<properties
    ...
    authors="t-elbery"
    ms.author="kustosee"
    articleId="354D7BBB-A243-4BE1-A8B9-43DBFC05C44A_Fairfax"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://kustodataestate.usgovvirginia.kusto.usgovcloudapi.net').database('AdvisorRecommendations').PublishStoppedClustersRecommendations",
    "dataSource": "Kusto",
