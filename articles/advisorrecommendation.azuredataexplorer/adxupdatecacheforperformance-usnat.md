<properties
    ...
    authors="lizlotor"
    ms.author="kustosee"
    articleId="389653ce-d564-4b95-aac4-ca30e1602536_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://kustodataestate.usnatwest.kusto.core.eaglex.ic.gov').database('AdvisorRecommendations').PublishUpdateCacheForPerformanceRecommendations",
    "dataSource": "Kusto",
