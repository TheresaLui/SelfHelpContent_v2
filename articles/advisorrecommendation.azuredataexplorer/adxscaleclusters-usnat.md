...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 2.0,
    "streamNamespace": "cluster('https://kustodataestate.usnateast.kusto.core.eaglex.ic.gov').database('AdvisorRecommendations').PublishPerformanceSkuChangeRecommendations",
    "dataSource": "Kusto",
