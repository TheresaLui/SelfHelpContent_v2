<properties
    ...
    authors="t-elbery"
    ms.author="kustosee"
    articleId="354D7BBB-A243-4BE1-A8B9-43DBFC05C44A_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://kustodataestate.usseceast.kusto.core.microsoft.scloud').database('AdvisorRecommendations').PublishStoppedClustersRecommendations",
    "dataSource": "Kusto",
