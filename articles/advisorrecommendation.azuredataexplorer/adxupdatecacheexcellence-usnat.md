<properties
    ...
    authors="dsigron"
    ms.author="kustosee"
    articleId="9a3ea211-a282-4ab6-a63b-81024975b796_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://kustodataestate.usnatwest.kusto.core.eaglex.ic.gov').database('AdvisorRecommendations').PublishUpdateCacheExcellenceRecommendations",
    "dataSource": "Kusto",
