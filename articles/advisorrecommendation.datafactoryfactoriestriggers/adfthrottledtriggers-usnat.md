<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="eb4f67d2-2440-4d58-bec7-6de73cc5ba75_UsNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 2.0,
    "streamNamespace": "cluster('https://adfcus.usnateast.kusto.core.eaglex.ic.gov/').database('azuredatafactorygov').AdvisorThrottledTriggerEvents",
    "dataSource": "Kusto",
