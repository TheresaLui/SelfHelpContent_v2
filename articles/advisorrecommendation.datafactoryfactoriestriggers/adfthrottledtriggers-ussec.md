<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="eb4f67d2-2440-4d58-bec7-6de73cc5ba75_UsSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 2.0,
    "streamNamespace": "cluster('https://adfcus.usseceast.kusto.core.microsoft.scloud/').database('azuredatafactorygov').AdvisorThrottledTriggerEvents",
    "dataSource": "Kusto",
