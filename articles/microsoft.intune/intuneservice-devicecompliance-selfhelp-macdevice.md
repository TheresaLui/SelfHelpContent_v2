...
*.Article 1 (Microsoft Intune and Jamf Pro: Better Together to Manage and Secure Macs)[https://cloudblogs.microsoft.com/enterprisemobility/2017/12/14/microsoft-intune-and-jamf-pro-better-together-to-manage-and-secure-macs/)
*.Article 2 (Integrate Jamf Pro with Intune for compliance)[https://docs.microsoft.com/intune/conditional-access-integrate-jamf]
