...
Complete the following steps to make sure Jamf is integrated with Intune.
   ...
   2.	Tell the device owner to go to the Jamf self-service portal and re-run the device registration policy.

The Mac OS should now appear under the Intune device list in the Azure portal as well as in Azure AD.
