<properties
	pageTitle="Set device compliance - Create an Android Policy"
	description="Set device compliance - Create an Android Policy"
	service="microsoft.intune"
	resource="intune"
	authors="rciliax"
	displayOrder=""
	selfHelpType="generic"
	supportTopicIds="32599625"
	resourceTags=""
	productPesIds="15584"
...
Let's review a couple common Android policy setup issues.
...
[How to create a device compliance policy for Android devices in Intune](https://docs.microsoft.com/intune/compliance-policy-create-android)<br>
