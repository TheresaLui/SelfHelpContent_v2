<properties
	pageTitle="I want to defer the Windows 10 updates that are being pushed to users."
	description="I want to defer the Windows 10 updates that are being pushed to users."
