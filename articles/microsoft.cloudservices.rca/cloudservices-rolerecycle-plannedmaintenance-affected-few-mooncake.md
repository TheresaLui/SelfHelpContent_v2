...
Your role **<--/$rolename-->** availability has been partially affected from **<--/$StartTime--> (UTC)**  to **<--/$EndTime--> (UTC)**.  The instance **<--/$ListRoleInstanceName-->**  was/were down during this time frame. This expected occurrence was caused by an **Azure initiated planned maintenance action.**  
...
* [Guest OS Releases](https://docs.azure.cn/cloud-services/cloud-services-guestos-update-matrix#releases)<br>
* [Security updates on Guest OS](https://docs.azure.cn/cloud-services/cloud-services-guestos-msrc-releases)<br>
