...
**<!--$ListRoleInstanceName-->ListRoleInstanceName<!--/$ListRoleInstanceName-->** of you role **<!--$RoleName-->RoleName<!--/$RoleName-->** has been recycling since  **<!--$StartTime-->StartTime<!--/$StartTime--> (UTC)**  and has not been able to recover itself. 
We ran diagnostic on your resource and found that the Startup task <name of the startup task> is exiting with nonzero error level which is blocking the Role to be in Ready state. 
