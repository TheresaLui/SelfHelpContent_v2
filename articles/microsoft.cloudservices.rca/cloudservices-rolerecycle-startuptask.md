...
We ran diagnostic on your resource and found that the Startup task <name of the startup task> is exiting with nonzero error level which is causing the role to recycle. 
