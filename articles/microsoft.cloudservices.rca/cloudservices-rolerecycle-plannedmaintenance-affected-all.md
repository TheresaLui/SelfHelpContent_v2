...
Your role **[RoleName]<!--($RoleName)--> availability has been affected from **[StartTime]<!--($StartTime)--> (UTC)**  to **[EndTime]<!--($EndTime)--> (UTC)**.  The instance **[ListRoleInstanceName]<!--($ListRoleInstanceName)-->  were down during this time frame. This expected occurrence was caused by an **Azure initiated planned maintenance action.**  
