...
Your role **<--/$RoleName-->** availability has been affected from **<--/$StartTime--> (UTC)**  to **<--/$EndTime--> (UTC)**.  The instance **<--/$ListRoleInstanceName-->**  was/were down during this time frame. This expected occurrence was caused by an **Azure initiated planned maintenance action.**  
