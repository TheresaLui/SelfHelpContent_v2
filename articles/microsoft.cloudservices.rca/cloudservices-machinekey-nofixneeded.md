<properties
	...
	authors="mmccrory"
	displayOrder=""
	articleId="MachineKey_NoFixNeeded"
...
**<!--$DeploymentName-->DeploymentName<!--/$DeploymentName-->** is not impacted. No further action is required. You can read more about MachineKey in this [advisory](https://aka.ms/azuremachinekeyinfo). 
