...
To use the enahaced algorithm, perform the steps provided in this [advisory](https://aka.ms/azuremachinekeyinfo). You can also check this [advisory](https://aka.ms/azuremachinekeyinfo) for directions to identify if your deployments are using the enhanced algorithm.
