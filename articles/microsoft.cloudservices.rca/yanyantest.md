...
We have investigated and identified that your VM <!--$vmname-->_[vmname]_blahblah<!--$vmname--> is currently in an inaccessible state because its started in Safe Mode.
