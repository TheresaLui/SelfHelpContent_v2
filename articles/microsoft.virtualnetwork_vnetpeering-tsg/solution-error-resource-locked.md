...
1. Follow the linke below in setting up the vNET peering from within the Databricks service blade and specifying the target peer via resource ID and connectivity fix the peering on the  target vNET
