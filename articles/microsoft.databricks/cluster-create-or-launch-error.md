...
|Timeout after xxx milliseconds with threshold 600 seconds. Please check network connectivity from data plane to control plane | Make sure to add the UDR to the control plane. Double-check UDR configuration as described in [this document](https://docs.microsoft.com/azure/databricks/administration-guide/cloud-configurations/azure/udr#udr)
