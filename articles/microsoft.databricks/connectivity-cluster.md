...
* If IP Access List feature is enabled for the workspace, make sure to whitelist Azure Data Factory IPs so that you can run notebooks from ADF:
  ...
  - To update IP access list or create additional new one with new CIDR, please follow [these instructions](https://docs.microsoft.com/azure/databricks/security/network/ip-access-list).
