...
* **Problem:**
 ...
 You are not able to connect to Azure SQL DW using managed identity and ADLS from Databricks, and you're receiving an error message similar to:
