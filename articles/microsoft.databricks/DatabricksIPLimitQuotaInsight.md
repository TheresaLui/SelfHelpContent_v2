...
* Please raise [ticket](https://ms.portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade/overview)
...
* Select Deployment Model "Resource Manager" and Location for increasing quota limit
* Select Resources "Public IP Addresses" and provide new limits of public addresses.
* Review request details and hit create button for raising request.
