...
* See if the lower compute tiers (DWUc400 and less) are [available in your region](https://docs.microsoft.com/en-us/azure/sql-data-warehouse/gen2-migration-schedule?branch=pr-en-us-66148#automated-schedule-and-region-availability-table).
* How long will my upgrade take?
  ...
  * To expedite the background data migration process, you can immediately force data movement by running [Alter Index rebuild](https://docs.microsoft.com/en-us/azure/sql-data-warehouse/sql-data-warehouse-tables-index) on all primary columnstore tables you'd be querying at a larger SLO and resource class.
