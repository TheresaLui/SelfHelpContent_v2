...
* Set up and connect to SQL Data Warehouse using [Azure Active Directory](https://docs.azure.cn/sql-database/sql-database-aad-authentication?toc=/azure/sql-data-warehouse/toc.json) authentication
