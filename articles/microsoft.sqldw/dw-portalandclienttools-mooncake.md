<properties
	...
	supportTopicIds="32635188, 32635189, 32635211, 32635220"
	productPesIds="15818"
	displayOrder="14"
...
* To ensure latest feature support, we recommend using the [latest version of SQL Server Database tools (SSDT) and Visual Studio for development purposes](https://docs.azure.cn/sql-data-warehouse/sql-data-warehouse-install-visual-studio)
* Monitoring resource utilization and query activity [from Azure Portal](https://docs.azure.cn/sql-data-warehouse/sql-data-warehouse-concept-resource-utilization-query-activity)
...
* [Query with SSMS](https://docs.azure.cn/sql-data-warehouse/sql-data-warehouse-query-ssms)
* [Query with Visual Studio](https://docs.azure.cn/sql-data-warehouse/sql-data-warehouse-query-visual-studio)
