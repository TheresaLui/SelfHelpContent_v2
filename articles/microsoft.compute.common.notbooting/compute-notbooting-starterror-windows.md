<properties  
    pageTitle="My Windows VM is not starting"
    description="My Windows VM is not starting"
    service=""
    resource=""
    authors="timbasham"
    ms.author="tibasham"
...
4 out of 5 customers resolved their VM start issue using the steps listed below.<br>
