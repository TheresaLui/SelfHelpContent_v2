<properties  
    pageTitle="My Linux VM is not starting"
    description="My Linux VM is not starting"
    service=""
    resource=""
    authors="timbasham"
    ms.author="tibasham"
    ...
    articleId="320e1896-15ca-4421-ba3b-5a7644ac7e00"
	ownershipId="Compute_VirtualMachines"
/>

# My Linux VM is not starting

4 out of 5 customers resolved their VM start issue using the guides listed below.
