<properties  
    pageTitle="My Linux VM is stuck in a reboot loop"
    description="My Linux VM is stuck in a reboot loop"
    service=""
    resource=""
    authors="timbasham"
    ms.author="tibasham"
    ...
    articleId="c90c2539-5432-4e1d-b302-62aa635251be"
	ownershipId="Compute_VirtualMachines"
/>

# My Linux VM is stuck in a reboot loop
