...
2. Look up suggested actions by error code and [Troubleshoot error codes for resize & restart](https://docs.azure.cn/virtual-machines/windows/classic/troubleshoot-deployment-new-vm#error-string-lookup)
