...
2. [Understand, manage, and use 'Availability Sets' to reduce the impact of downtime events](https://azure.microsoft.com/documentation/articles/virtual-machines-manage-availability/)<br>
