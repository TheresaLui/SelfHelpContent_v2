...
* [Powershell script for MI online migration](https://docs.microsoft.com/en-us/azure/dms/howto-sql-server-to-azure-sql-managed-instance-powershell-online)
...
* [Powershell script for MI offline migration](https://docs.microsoft.com/en-us/azure/dms/howto-sql-server-to-azure-sql-managed-instance-powershell-offline)
* [Blog: Migration from SQL Server to Azure SQL Database Managed Instance](https://blogs.technet.microsoft.com/hybridcloudbp/2018/11/02/migration-from-sql-server-to-azure-sql-database-managed-instance)<br>
...
* [How to create a File Share for MI migration](https://docs.microsoft.com/en-us/azure/dms/known-issues-azure-sql-db-managed-instance-online#smb-file-share-connectivity)<br>
