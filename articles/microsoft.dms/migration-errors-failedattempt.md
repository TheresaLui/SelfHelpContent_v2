...
they are tested with DMS to ensure compatibility before they are supported as source. 
* Workaround: In order to proceed with migration before such update, export the databases/collections to Azure storage and use the <b>"Data from Azure storage"</b> 
