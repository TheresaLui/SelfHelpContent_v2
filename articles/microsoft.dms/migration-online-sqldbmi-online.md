<properties
	pageTitle="Migration setup for SQLDB MI - Online Mode"
	description="Migration setup for SQLDB MI - Online Mode"
	infoBubbleText=""
	...
	ms.author="rradjou"
	displayOrder="1"
	articleId="migration-online-sqldbmi-online"
	diagnosticScenario=""
...
* [Migrate certificate of TDE protected database to Azure SQL Database Managed Instance](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-managed-instance-migrate-tde-certificate)<br>
