...
---
{
    ...
    "fileAttachmentHint": "If possible, please attach a copy of the ARM template used.",
    "formElements": [
        {
        ...
        },
        {
            ...
            "content": "Please provide a screenshot of any errors and all relevant JSON files for the ARM template used.",
            "required": false
        },
    ],
