<properties
    articleId="mc06cf9c-05b3-437a-a5e4-49812c08d489"
    pageTitle="Scoping Questions for Calling Child Workflow (Workflow Operations)"
    description="Scoping Questions for Calling Child Workflow (Workflow Operations)"
    authors="TobyTu"
    ms.author="kawilson"
    selfHelpType="problemScopingQuestions"
    supportTopicIds="32780484"
    productPesIds="17378"
    cloudEnvironments="public, Fairfax, usnat, ussec"
    schemaVersion="1"
    ownershipId="Compute_LogicApps"
/>
# Calling Child Workflow (Workflow Operations)
---
{
    "resourceRequired": true,
    "subscriptionRequired": true,
    "title": "Calling Child Workflow (Workflow Operations)",
    "fileAttachmentHint": "",
    "formElements": [
        {
