<properties
	pageTitle="Azure Backup - Configuration and Setup"
	description="Azure Backup - Configuration and Setup"
...
1. Read and understand the online guidance:<br>
	- Preparing the VM and planning your infrastructure<br>
...
2. Troubleshoot Azure Backup issues by reviewing the top issues customers are encountering:<br>
	...
	- [Troubleshoot Microsoft Azure Recovery Services (MARS) Agent](https://docs.microsoft.com/azure/backup/backup-azure-mars-troubleshoot)<br>
	- [Troubleshoot problems backing up Azure File Shares](https://docs.microsoft.com/azure/backup/troubleshoot-azure-files)
	- [Troubleshoot problems backing up SQL Server on Azure](https://docs.microsoft.com/azure/backup/backup-sql-server-azure-troubleshoot)
...
* [Understand how to backup Azure virtual machines to Recovery Services vaults](https://docs.microsoft.com/azure/backup/backup-azure-vms-first-look-arm)
