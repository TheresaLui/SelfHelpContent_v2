<properties
	...
	resourceTags = ""
	productPesIds = "15818"
	supportTopicIds = "32738843"
	displayOrder = ""
	diagnosticScenario = ""
	infoBubbleText = ""
	pageTitle = "Data Import, Export (ETL) with SQL pool/Using SSIS"
	description = "Data Import, Export (ETL) with SQL pool/Using SSIS"
	articleId = "synapse-dataimportexportetlwithsqlpool-usingssis"
	authors = "saltug"
	ms.author = "saltug"
/>

# Data Import, Export (ETL) with SQL pool/Using SSIS
...
* [Load data into SQL pool using SSIS](https://docs.microsoft.com/sql/integration-services/load-data-to-sql-data-warehouse?view=sql-server-2017)
