...
- Configure SSMS to [generate scripts](https://docs.microsoft.com/sql/ssms/scripting/generate-and-publish-scripts-wizard?view=azure-sqldw-latest#generating-scripts-on-azure-sql-data-warehouse)
...
* Generating a script for Synapse SQL pool fails if the option "Generate script for dependent objects" option is set to "True". As a workaround, click on the menu [Tools]->[Options]->[SQL Server Object Explorer]->[Generate script for dependent options] and set the value to False.
- More information in [Tools Troubleshooting](https://docs.microsoft.com/azure/synapse-analytics/sql-data-warehouse/sql-data-warehouse-troubleshoot#tools)
