<properties
	...
	infoBubbleText = ""
	articleId = "synapse-administrationandsecurity-sqlondemandstorageaccesscontrol"
	authors = "saltug"
...
* For credentials defined on storage path level, make sure credential is not created on storage level, but at least on container level. For more information see [control storage access for SLQ on-demand](https://docs.microsoft.com/azure/synapse-analytics/sql/develop-storage-files-storage-access-control). 
