...
* If your query fails with the error message "The query references an object that is not supported in distributed processing mode", it means that query targets data from both storage account and temporary table, which is not currently supported 
