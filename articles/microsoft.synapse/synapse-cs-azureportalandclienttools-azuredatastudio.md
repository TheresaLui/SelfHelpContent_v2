<properties
    ...
    resourceTags = ""
    productPesIds = "15818"
    supportTopicIds = "32783838"
    displayOrder = ""
    diagnosticScenario = ""
    infoBubbleText = ""
    pageTitle = "Azure Portal and Client Tools/Azure Data Studio"
    description = "Azure Portal and Client Tools/Azure Data Studio"
    articleId = "synapse-cs-azureportalandclienttools-azuredatastudio.md"
    ms.author = "saltug,goventur"
/>

# Azure Portal and Client Tools/Azure Data Studio

## **Recommended Steps**

* To connect and query Dedicated SQL pool using Azure Data Studio, follow [steps outlined here](https://docs.microsoft.com/sql/azure-data-studio/quickstart-sql-dw?view=sql-server-2017). Make sure to set the firewall rule allowing Azure Data Studio to connect as explained in the tutorial.
