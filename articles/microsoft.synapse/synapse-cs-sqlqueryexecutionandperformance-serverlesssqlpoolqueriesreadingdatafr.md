<properties
    ...
    resourceTags = ""
    productPesIds = "15818"
    supportTopicIds = "32783907"
    displayOrder = ""
    diagnosticScenario = ""
    infoBubbleText = ""
    pageTitle = "SQL Query Execution and Performance/Serverless SQL pool - Queries reading data from Azure Synapse Link for Cosmos DB"
    description = "SQL Query Execution and Performance/Serverless SQL pool - Queries reading data from Azure Synapse Link for Cosmos DB"
    articleId = "synapse-cs-sqlqueryexecutionandperformance-serverlesssqlpoolqueriesreadingdatafr.md"
    ms.author = "saltug"
/>

# SQL Query Execution and Performance/Serverless SQL pool - Queries reading data from Azure Synapse Link for Cosmos DB
...
* Spark pools - Read, Write (through transactional store), Table, Temporary View

* Serverless SQL pool - Read, View

* Dedicated SQL pool - Not available
