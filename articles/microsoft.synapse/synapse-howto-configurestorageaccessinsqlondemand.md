<properties
	...
	infoBubbleText = ""
	articleId = "synapse-howto-configurestorageaccessinsqlondemand"
	authors = "saltug"
...
* Visit [control storage access for SLQ on-demand](https://review.docs.microsoft.com/azure/synapse-analytics/sql-analytics/development-storage-files-storage-access-control?branch=release-ignite-arcadia) for instructions.
