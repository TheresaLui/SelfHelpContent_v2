<properties
    ...
    resourceTags = ""
    productPesIds = "15818"
    supportTopicIds = "32783877"
    displayOrder = ""
    diagnosticScenario = ""
    infoBubbleText = ""
    pageTitle = "Administration and Security/Dedicated SQL pool - VNET Service Endpoints"
    description = "Administration and Security/Dedicated SQL pool - VNET Service Endpoints"
    articleId = "synapse-cs-administrationandsecurity-dedicatedsqlpoolvnetserviceendpoints.md"
    ms.author = "saltug"
/>

# Administration and Security/Dedicated SQL pool - VNET Service Endpoints
