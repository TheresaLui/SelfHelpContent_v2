<properties
    ...
    resourceTags = ""
    productPesIds = "15818"
    supportTopicIds = "32783927"
    displayOrder = ""
    diagnosticScenario = ""
    infoBubbleText = ""
    pageTitle = "Administration and Security/Synapse Workspace - Access control or permissions"
    description = "Administration and Security/Synapse Workspace - Access control or permissions"
    articleId = "synapse-cs-administrationandsecurity-synapseworkspaceaccesscontrolorpermissions.md"
    ms.author = "saltug"
/>

# Administration and Security/Synapse Workspace - Access control or permissions
