<properties
  pagetitle="Administration and Security/SQL pool Transparent Data Encryption (TDE)"
  service="microsoft.synapse"
  resource="sqlpools"
  ms.author="saltug,goventur"
  selfhelptype="Generic"
  supporttopicids="32738827"
  resourcetags=""
  productpesids="15818"
  cloudenvironments="public,fairfax,blackforest,mooncake,usnat,ussec"
  articleid="synapse-administrationandsecurity-sqlpooltransparentdataencryptiontde"
  ownershipid="AzureData_SQLDataWarehouse" />
# Administration and Security/SQL pool Transparent Data Encryption (TDE)
