<properties
    ...
    resourceTags = ""
    productPesIds = "15818"
    supportTopicIds = "32783898"
    displayOrder = ""
    diagnosticScenario = ""
    infoBubbleText = ""
    pageTitle = "Create, Scale, Pause, Resume or Delete/Pause or Resume Dedicated SQL pool"
    description = "Create, Scale, Pause, Resume or Delete/Pause or Resume Dedicated SQL pool"
    articleId = "synapse-cs-createscalepauseresumeordelete-pauseorresumededicatedsqlpool.md"
    ms.author = "saltug"
/>

# Create, Scale, Pause, Resume or Delete/Pause or Resume Dedicated SQL pool
