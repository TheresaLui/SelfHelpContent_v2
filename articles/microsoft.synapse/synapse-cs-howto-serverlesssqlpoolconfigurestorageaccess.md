<properties
    ...
    resourceTags = ""
    productPesIds = "15818"
    supportTopicIds = "32783905"
    displayOrder = ""
    diagnosticScenario = ""
    infoBubbleText = ""
    pageTitle = "How-To/Serverless SQL pool - Configure storage access"
    description = "How-To/Serverless SQL pool - Configure storage access"
    articleId = "synapse-cs-howto-serverlesssqlpoolconfigurestorageaccess.md"
    ms.author = "fipopovi, saltug"
/>

# How-To/Serverless SQL pool - Configure storage access

## **Recommended Steps**

* Visit [control storage access for Serverless SQL pool](https://docs.microsoft.com/azure/synapse-analytics/sql/develop-storage-files-storage-access-control) for instructions. 
