<properties
    ...
    resourceTags = ""
    productPesIds = "15818"
    supportTopicIds = "32783874"
    displayOrder = ""
    diagnosticScenario = ""
    infoBubbleText = ""
    pageTitle = "How-To/Dedicated SQL pool - Security"
    description = "How-To/Dedicated SQL pool - Security"
    articleId = "synapse-cs-howto-dedicatedsqlpoolsecurity.md"
    ms.author = "saltug"
/>

# How-To/Dedicated SQL pool - Security
...
* [Configure SQL firewall rules](https://azure.microsoft.com/documentation/articles/sql-data-warehouse-get-started-provision/#create-a-new-azure-sql-server-level-firewall) for the IP addresses that are authorized to access this Dedicated SQL pool

* To set-up and connect to Dedicated SQL pool using [Azure Active Directory](https://azure.microsoft.com/documentation/articles/sql-data-warehouse-authentication/) authentication

* [Secure your Dedicated SQL pool](https://azure.microsoft.com/documentation/articles/sql-data-warehouse-overview-manage-security/)
...
* [Dedicated SQL pool Security Overview](https://azure.microsoft.com/documentation/articles/sql-data-warehouse-overview-manage-security/)
