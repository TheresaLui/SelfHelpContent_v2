<properties
    ...
    resourceTags = ""
    productPesIds = "15818"
    supportTopicIds = "32783934"
    displayOrder = ""
    diagnosticScenario = ""
    infoBubbleText = ""
    pageTitle = "How-To/Synapse Workspace - Security"
    description = "How-To/Synapse Workspace - Security"
    articleId = "synapse-cs-howto-synapseworkspacesecurity.md"
    ms.author = "saltug"
/>

# How-To/Synapse Workspace - Security

## **Recommended Documents**

* [Security baseline](https://docs.microsoft.com/azure/synapse-analytics/security-baseline)

* [Synapse workspace IP firewall rules](https://docs.microsoft.com/azure/synapse-analytics/security/synapse-workspace-ip-firewall)
...
* [Troubleshoot Synapse Studio connectivity](https://docs.microsoft.com/azure/synapse-analytics/troubleshoot/troubleshoot-synapse-studio-powershell)
