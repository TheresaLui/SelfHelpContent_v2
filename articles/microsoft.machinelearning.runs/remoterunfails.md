...
* Avoid installing the Python SDK on the conda base environment; instead, create a conda environment and install SDK on that newly created environment. The latest pip should work on that new conda environment.
