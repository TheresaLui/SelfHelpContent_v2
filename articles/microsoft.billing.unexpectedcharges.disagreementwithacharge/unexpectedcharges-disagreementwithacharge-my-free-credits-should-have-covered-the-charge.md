...
The Visual Studio offer includes monthly credit. Amount depends on the type of [Visual Studio Subscription](https://azure.microsoft.com/pricing/member-offers/credit-for-visual-studio-subscribers/) you have. Your Azure services will stop when the monthly credit gets completely used up till your next month credit gets added. You can choose to remove your monthly cap by upgrading [to Pay-As-You-Go pricing](https://azure.microsoft.com/pricing/purchase-options/pay-as-you-go/).

More details on Visual Studio offers are available [here](https://azure.microsoft.com/pricing/member-offers/credit-for-visual-studio-subscribers/).
...
To ensure that Azure Cost Management is supported for your offer type, please check the supported subscription offer type list [here](https://docs.microsoft.com/azure/cost-management-billing/costs/understand-cost-mgt-data#supported-microsoft-azure-offers).
