<properties
    pageTitle="RBAC and Active Directory"
    description="RBAC and Active Directory"
    ...
    articleId="68626a8f-a843-4a2b-95e7-e8d5be47290d"
...
* [Integrate Azure Active Directory with Azure Kubernetes Service](https://docs.microsoft.com/azure/aks/azure-ad-integration)<br>
* [Role-based Access Controls (RBAC) with AKS](https://docs.microsoft.com/azure/aks/concepts-identity#role-based-access-controls-rbac)<br>
* [Secure an Azure Kubernetes cluster with Azure Active Directory and RBAC](https://blog.jcorioland.io/archives/2018/11/20/azure-aks-kubernetes-rbac-azure-active-directory-terraform.html)<br>
