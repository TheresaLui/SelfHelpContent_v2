<properties
    ...
    authors="jakepearson"
    ms.author="jopears"
    articleId="5ed99507-3d01-49cf-8ddd-0984de5a624d_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://rxaks.usseceast.kusto.core.microsoft.scloud').database('AKSprod').ServicePrincipalExpired",
    "dataSource": "Kusto",
