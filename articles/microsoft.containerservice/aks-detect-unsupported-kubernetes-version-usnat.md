<properties
    ...
    articleId="d6d466dd-1989-4c1b-b77e-f2d11c3e453c_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://exaks.usnateast.kusto.core.eaglex.ic.gov').database('AKSprod').UnsupportedKubernetesVersions",
    "dataSource": "Kusto",
  ...
  "owner": {
    ...
    "icm": {
      ...
      "team": "V-1Gov_Orchestration_Triage"
    },
