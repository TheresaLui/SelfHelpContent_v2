...
Alternatively, you can check the table from [Jarvis Logs -> AppGWT -> BackendServerDiagnosticHistory](https://jarvis-west.dc.ad.msft.net/BEA88EA9), and InformationLogEvent tables.
