<properties
    ...
    authors="pratnala"
    ms.author="pratnala"
    articleId="51a4e6bd-5a95-4a41-8309-40f5640fdb8b_Mooncake"
...
---
{
  ...
  "description": "Upgrade your old Azure Cosmos DB {language} SDK to the latest version",
  "longDescription": "Your Azure Cosmos DB account is using an old version of the {language} SDK. We recommend upgrading to the latest version for the latest fixes, performance improvements, and new feature capabilities.",
  "potentialBenefits": "Improved reliability, performance, and new feature capabilities",
  "displayLabel": "Upgrade your old Azure Cosmos DB {language} SDK to the latest version",
  "supportedSDKLanguages": [".NET", ".NET Core", "Sync Java", "Async Java", "Java", "Node.js", "Python"],
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbmooncake3.chinanorth2.kusto.chinacloudapi.cn').database('LiveSite').OldSDK",
