<properties
    ...
    authors="pratnala"
    ms.author="pratnala"
    articleId="60a55165-9ccd-4536-81f6-e8dc6246d3d2_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbusseceast.usseceast.kusto.core.microsoft.scloud').database('Support').OutdatedSDK",
