<properties
    ...
    authors="pratnala"
    ms.author="pratnala"
    articleId="ceb9372d-60f6-4564-8033-a8b1ead4fa76_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbusseceast.usseceast.kusto.core.microsoft.scloud').database('Support').MongoMigrationUpgradeAdvisor",
