<properties
    ...
    authors="pratnala"
    ms.author="pratnala"
    articleId="e27c5181-5005-4dc3-a449-89b726a3bf54_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbusseceast.usseceast.kusto.core.microsoft.scloud').database('Support').QueryPageSize",
