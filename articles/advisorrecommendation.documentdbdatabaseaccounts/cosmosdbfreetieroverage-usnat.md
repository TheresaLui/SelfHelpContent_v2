<properties
    ...
    authors="thweiss"
    ms.author="thweiss"
    articleId="4a993d7c-9d83-4d85-b5a9-7cce0b136378_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbusnateast.usnateast.kusto.core.eaglex.ic.gov').database('Support').FreeTierOverage",
