<properties
    ...
    authors="pratnala"
    ms.author="pratnala"
    articleId="ceb9372d-60f6-4564-8033-a8b1ead4fa76_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbmooncake3.chinanorth2.kusto.chinacloudapi.cn').database('LiveSite').MongoMigrationUpgradeAdvisor",
  ...
  "actions": [
    {
      ...
      "actionType": "Document",
      "documentLink": "https://docs.azure.cn/data-factory/connector-azure-cosmos-db-mongodb-api"
    }
  ],
  "resourceMetadata": {
    "action": {
