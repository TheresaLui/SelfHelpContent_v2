<properties
    ...
    authors="pratnala"
    ms.author="pratnala"
    articleId="60a55165-9ccd-4536-81f6-e8dc6246d3d2_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbmooncake3.chinanorth2.kusto.chinacloudapi.cn').database('LiveSite').OutdatedSDK",
