<properties
    ...
    authors="pratnala"
    ms.author="pratnala"
    articleId="b2fa566d-7da3-4c61-b35c-f2548c665aa0_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbmooncake3.chinanorth2.kusto.chinacloudapi.cn').database('LiveSite').OldPythonSDK",
