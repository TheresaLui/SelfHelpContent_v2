<properties
    ...
    authors="pratnala"
    ms.author="pratnala"
    articleId="ec6fe20c-08d6-43da-ac18-84ac83756a88_Public"
...
---
{
  ...
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbsupport.kusto.windows.net').database('Support').MongoServerSideRetriesAdvisor",
