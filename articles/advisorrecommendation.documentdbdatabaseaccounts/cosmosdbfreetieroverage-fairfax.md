<properties
    ...
    authors="thweiss"
    ms.author="thweiss"
    articleId="4a993d7c-9d83-4d85-b5a9-7cce0b136378_Fairfax"
...
---
{
  ...
  "dataSourceMetadata": {
    "dataSource": "Kusto",
    "streamNamespace": "cluster('https://cdbfairfax.kusto.usgovcloudapi.net').database('LiveSite').FreeTierOverage",
