...
Resolve most issues in Self-Hosted IR using the following steps.

## Recommended Steps

* If you use Self-Hosted IR (SHIR) and experience known issues, follow the steps on the [Self-IR troubleshooting guide](https://docs.microsoft.com/azure/data-factory/self-hosted-integration-runtime-troubleshoot-guide). Note the **Report ID** and provide it with the support request.
