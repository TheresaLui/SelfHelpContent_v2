...
1. __Notes__ on Azure Data Factory - Log Analytics integration: <br>
    ...
    1. To any problems with Log Analytics, we _strongly_ recommend users configure diagnostic settings to _Resource-Specific_ mode, instead of _Azure-Diagnostics_ mode. [Steps](https://docs.microsoft.com/azure/data-factory/monitor-using-azure-monitor#configure-diagnostic-settings-and-workspace)
