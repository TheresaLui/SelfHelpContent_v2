<properties
	pageTitle="Make sure you are credited for withholding tax"
	description="Include tax credit certificate with the withholding tax credit form"
	infoBubbleText=""
...
As of January 21st, 2020 the process for withholding tax submission has changed from creating support requests to a new process. This new process starts at the billing page in partner center. Below are the steps to submit tax withholding requests in partner center and helpful documentation. To get started you will need the tax certificate in electronic form you want to be credited for and the amount you seek credit for.
...
- If there are issues with your request or corrections that need to be made the team will flag the request as "needs partner attention" with details about what needs to be corrected before resubmitting.
