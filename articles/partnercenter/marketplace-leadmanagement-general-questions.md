...
1. Select a lead destination where you want us to send customer leads. The following CRM systems are supported (please read before proceeding):
...
* If your CRM system is not explicitly supported in the list above, the following options allow you to store the customer lead data, and then you can export or import this data into your CRM system.
...
2. Steps for setting up your lead destination
   1. Connect your offer to the lead destination while publishing the offer to the marketplace in Partner Center. See the documentation linked in step 1 for how to do this.
   2. Confirm the connection to the lead destination is set up properly by clicking the "Validate" button available in the window where you are configuring the connection to your lead management destination in Partner Center. 
   3. After validating a successful connection to the lead destination, publish the offer in Partner Center. When you are viewing the offer before you go live (preview version of your offer), test your lead connection by trying to acquire the offer yourself in the preview environment.
3. Make sure the connection to the lead destination stays up-to-date so that you don’t lose any leads. Update these connections in Partner Center whenever something changes on your CRM system.
