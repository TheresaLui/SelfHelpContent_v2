<properties
	pageTitle="Billing and Invoicing Invoices license-based recurring billing"
	description="Billing and Invoicing Invoices license-based recurring billing"
	infoBubbleText=""
	...
	ms.author="v-linx"
	displayOrder=""
    articleId="partnercenter_billing_and_invoicing_invoices_license_based_recurring_billing"
	diagnosticScenario=""
	selfHelpType="generic"
	supportTopicIds="32781871"
...
# Billing and Invoicing Invoices license-based recurring billing

## **Recommended Steps**

You'll be billed for both license-based and usage-based (Azure 145P offer) products in the currency of the country or region in which you're located. You're billed the same regardless of the location of the customer to whom you sold the product.
...
* [Partner Center Billing basics](https://docs.microsoft.com/partner-center/billing-basics)
