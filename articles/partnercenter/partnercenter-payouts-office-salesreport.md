<properties
	pageTitle="Payouts Office Sales Report SelfHelp"
	description="SelfHelp for Payouts Office Sales Report"
	infoBubbleText=""
	...
	ms.author="A-COFLOR"
	displayOrder=""
	articleId="partnercenter_payouts_office_sales_report"
	diagnosticScenario=""
	selfHelpType="generic"
	supportTopicIds="32745419" 
...
/>
# Office Sales Reports

The Office sales reports are no longer available on Partner Center as of October 10, 2020. **Follow the recommended steps below to request for sales data.** 

## **Recommended Steps**

After Oct 10, 2020, to request for sales data, follow the below steps:
...
**Note:** The data may be in a different format than the Office sales report in Partner Center.

## **Recommended Documents**

* [Moving from paid to free add-ins](https://docs.microsoft.com/office/dev/store/moving-from-paid-to-free-addins)
