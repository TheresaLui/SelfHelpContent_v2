 ...
 * [Powershell](https://docs.microsoft.com/en-us/powershell/module/az.blueprint/?view=azps-4.1.0#blueprint).
 * [SDK for .NET](https://docs.microsoft.com/en-us/dotnet/api/overview/azure/blueprints/management?view=azure-dotnet)
 * [REST API](https://docs.microsoft.com/en-us/rest/api/blueprints/)

 Go through the troubleshooting guidance for blueprint errors.
 * [Troubleshooting blueprints](https://docs.microsoft.com/en-us/azure/governance/blueprints/troubleshoot/general)
