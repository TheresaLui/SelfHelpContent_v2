<properties
    pageTitle="Kubernetes API may be unavailable."
    description="Kubernetes API may be unavailable."
    infoBubbleText="Kubernetes API may be unavailable."
    service="Microsoft.ContainerService"
    resource="managedClusters"
    authors="stephbaron"
    ms.author="stbaron"
    articleId="servicehealthinsights-Microsoft.ContainerService-managedClusters-healthannotation_CustomerNodesNotFound"
    diagnosticScenario="health_diagnostic"
    selfHelpType="servicehealthinsights"
    cloudEnvironments="public, fairfax, usnat, ussec"
    articleTags="healthannotation_CustomerNodesNotFound,ServiceHealthAutogenerated"
