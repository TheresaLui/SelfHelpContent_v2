<properties
	...
	supportTopicIds="32743318"
	productPesIds="16460"
	cloudEnvironments="public,MoonCake,FairFax,BlackForest,usnat,ussec"
	schemaVersion="1"
	articleId="86464ec6-4bdf-40bb-a291-26a78d6a4dda"
...
---
{
    ...
    "formElements": [
	{
		...
		"dropdownOptions": [
			{
				"value": "copy_large_files_from_localonpremise_to_files",
				"text": "Upload files (over 100 GB) to Azure Files storage"
			},
			{
				"value": "copy_from_localonpremise_to_files",
				"text": "Upload files (less than 100 GB) to Azure Files storage"
			},
			{
				"value": "copy_large_files_to_localonpremise",
				"text": "Download files (over 100 GB) from Azure Files storage"
			},
			{
				"value": "copy_files_to_localonpremise",
				"text": "Download files (less than 100 GB) from Azure Files storage"
			},
			{
			...
			},
			{
				...
				"text": "Copy files from Azure Files storage to Azure Files storage"
			},
			{
				"value": "copy_files_to_adlsgen2",
				"text": "Copy files from Azure Files storage to Azure Data Lake Gen2 storage"
			},
			{
				"value": "copy_adlsgen2_to_files",
				"text": "Copy files from Azure Data Lake Gen2 storage to Azure Files storage"
			},
			{
	...
	},
	{
		...
		"visibility": "files_migration_scenario == copy_large_files_to_localonpremise || files_migration_scenario == copy_files_to_localonpremise || files_migration_scenario == copy_blobs_to_files || files_migration_scenario == copy_files_to_blobs || files_migration_scenario == copy_files_to_files || files_migration_scenario == copy_files_to_adlsgen2 || files_migration_scenario == copy_adlsgen2_to_files",
		"order": 2,
		"controlType": "dropdown",
	...
	},
	{
		...
		"visibility": "files_migration_scenario == copy_large_files_from_localonpremise_to_files || files_migration_scenario == copy_from_localonpremise_to_files || files_migration_scenario == copy_blobs_to_files || files_migration_scenario == copy_files_to_blobs || files_migration_scenario == copy_files_to_files || files_migration_scenario == copy_files_to_adlsgen2 || files_migration_scenario == copy_adlsgen2_to_files",
		"order": 4,
		"controlType": "dropdown",
	...
	{
		"id": "data_size_tb",
		"visibility": "IssueType == Performance && (files_migration_scenario == copy_large_files_from_localonpremise_to_files || files_migration_scenario == copy_from_localonpremise_to_files || files_migration_scenario == copy_large_files_to_localonpremise || files_migration_scenario == copy_files_to_localonpremise)",
		"order": 7,
		"controlType": "dropdown",
