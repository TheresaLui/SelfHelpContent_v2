<properties
	articleId="Unable-to-move-the-volume-to-a-pool-in-different-netappaccount"
	pageTitle="Unable to move the volume to a pool in different NetApp Account"
	description="Unable to move the volume to a pool in different NetApp Account"
	authors="b-mayada"
	ms.author="b-mayada"
	selfHelpType="problemScopingQuestions"
	supportTopicIds="32777915"
	productPesIds="16469"
...
---
{
  ...
  "title": "Unable to move the volume to a pool in different NetApp Account",
  "fileAttachmentHint": "",
  "formElements": [
    {
