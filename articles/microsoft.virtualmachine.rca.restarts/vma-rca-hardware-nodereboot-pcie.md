...
<!--rcaDescription-->
### *Root Cause*
> The Host Node where the VM was running encountered a **hardware issue** due to **PCIe card errors** on the physical node where the virtual machine was hosted. This caused your VM to get rebooted.
> 
