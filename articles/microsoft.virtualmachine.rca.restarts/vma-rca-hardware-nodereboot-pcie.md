<properties
	pageTitle="VMA RCA"
	description="Root Cause Analysis (RCA) - Hardware NodeReboot - PCIe Error"
...
<!--rcaDescription-->
### *Root Cause*
> The host node reboot was triggered by our Azure monitoring systems that detected a **hardware issue** due to **PCIe card errors** on the physical node where the virtual machine was hosted. This caused your VM to get rebooted.
> 
