...
During this update, the VM unexpectedly rebooted. RDP and SSH connections to the VM, or requests to any other services running inside the VM, could have failed during the reboot. This update is part of routine maintenance on the underlying hosts for this VM.<br> 
...
The update that failed to be installed we be included in the next sceduled update process for this VM.<br>

We apologize for any inconvenience this may have caused you. We are continuously working to improve the platform to reduce incidences of virtual machine unavailability. No action is needed from you.<br>
