...
Details about the cause of the termination are written to system event logs and possibly memory dumps. To investigate further, see these articles from Ubuntu:<br>
