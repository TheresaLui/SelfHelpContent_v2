...
The host node reboot was triggered by our Azure monitoring systems detecting a **potential failure condition with the node** where the virtual machine was hosted. This caused your VM to get rebooted. RDP and SSH connections to the VM, or requests to any other services running inside the VM, could have failed during this time.<br>
