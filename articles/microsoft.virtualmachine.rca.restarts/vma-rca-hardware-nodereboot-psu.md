<properties
	pageTitle="VMA RCA"
	description="RCA - Hardware NodeReboot - PSU Error"
	...
	ms.author="naterns"
	displayOrder=""
	articleId="VMA_RCA_Hardware_NodeReboot_PSU"
...
<!--rcaDescription-->
### *Root Cause*
> The host node reboot was triggered by our Azure monitoring systems that detected a **hardware issue** due to **power supply unit errors** on the physical node where the virtual machine was hosted. This caused your VM to get rebooted.
> 
...
> - Improvements to failure prediction telemetry and quality improvements to the vendor approved PSUs
> 
