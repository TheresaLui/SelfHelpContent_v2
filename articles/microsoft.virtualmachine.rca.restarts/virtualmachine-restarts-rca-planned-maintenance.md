...
This planned maintenance update required a reboot of your virtual machines to apply the required updates to the infrastructure. The VM was shut down while we patched the infrastructure, and then restarted.<br>
