...
<!--issueDescription-->
The physical host node where your VM was running was undergoing an update to the networking stack. These updates might have paused your VMs up to 9 seconds.  
