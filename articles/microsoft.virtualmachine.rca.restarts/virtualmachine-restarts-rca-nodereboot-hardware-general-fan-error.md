<properties
	pageTitle="VMA RCA"
	description="RCA - Node Service Heal - Hardware Fan Error"
	...
	ms.author="scotro"
	displayOrder=""
	articleId="UnexpectedVMReboot_Node_Reboot_Hardware_Fan_Failure"
...
The host node reboot was triggered by our Azure monitoring systems that detected a **hardware issue** due to **fan errors** on the physical node where the virtual machine was hosted. This caused your VM to get rebooted. RDP and SSH connections to the VM, or requests to any other services running inside the VM, could have failed during this time.<br>
