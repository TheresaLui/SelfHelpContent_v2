<properties
	pageTitle="VMA RCA"
	description="RCA - Hardware NodeReboot - Disk Failure"
	...
	ms.author="naterns"
	displayOrder=""	
	articleId="VMA_RCA_Hardware_NodeReboot_Disk_Failure_noend"
...
The host node reboot was triggered by our Azure monitoring systems that detected a **hardware issue** due to a **failed local disk** on the physical node where the virtual machine was hosted. This caused your VM to get rebooted. RDP and SSH connections to the VM, or requests to any other services running inside the VM, could have failed during this time.
