<properties
	pageTitle="VMA RCA"
	description="RCA - Hardware Node Maintenance - Decommission"
	...
	ms.author="naterns"
	displayOrder=""	
	articleId="VMA_RCA_Hardware_NodeMaintenance_Decomm"
...
<!--rcaDescription-->
### *Root Cause*
> This expected occurrence was caused by an **Azure initiated maintenance operation**.  Azure had previously notified impacted customers about this maintenance. As part of this operation, your VM experienced a reboot as it was migrated to newer hardware.
> 
