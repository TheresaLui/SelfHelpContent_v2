<properties
	pageTitle="VMA RCA"
	description="Root Cause Analysis (RCA) - IO Timeout"
...
<!--rcaDescription-->
### **Root Cause**
> This unexpected occurrence was caused by an Azure initiated temporary VM shutdown triggered by the detection of temporary IO transaction timeouts between the physical host node where your VM was running, and the Azure Storage services where your Virtual Hard Disks (VHDs) reside.
> 
