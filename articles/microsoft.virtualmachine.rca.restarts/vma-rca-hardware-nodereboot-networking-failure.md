<properties
	pageTitle="VMA RCA"
	description="Root Cause Analysis (RCA) - Hardware NodeReboot - Networking Failure"
	...
	ms.author="naterns"
	displayOrder=""
	articleId="VMA_RCA_Hardware_NodeReboot_Networking_Failure"
...
<!--rcaDescription-->
### *Root Cause*
> The host node reboot was triggered by our Azure monitoring systems that detected a **networking hardware issue** on the physical node where the virtual machine was hosted. This caused your VM to get rebooted.
> 
