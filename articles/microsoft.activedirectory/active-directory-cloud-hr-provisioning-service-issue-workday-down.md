<properties
	pageTitle="Workday to AD User Provisioning goes into quarantine state over weekends"
	description="Workday to AD User Provisioning goes into quarantine state over weekends"
	infoBubbleText="Workday to AD User Provisioning goes into quarantine state over weekends"
	...
	supportTopicIds="32629760,32629796"
	productPesIds="16666"
