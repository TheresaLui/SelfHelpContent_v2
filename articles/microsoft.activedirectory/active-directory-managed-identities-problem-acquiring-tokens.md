...
2. For user-assigned, ensure you're requesting the token for the correct identity. Provide clident_id, object_id or mi_res_id as part of your token request to the local endpoint.
