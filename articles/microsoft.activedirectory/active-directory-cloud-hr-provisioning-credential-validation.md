<properties
	...
	supportTopicIds="32629760,32629800"
	productPesIds="16666"
...
1. Next, ensure that you are entering the value for *Workday Username* field using the format **username@workday-tenant-name**. If the *workday-tenant-name* is missing then Workday authentication fails.
