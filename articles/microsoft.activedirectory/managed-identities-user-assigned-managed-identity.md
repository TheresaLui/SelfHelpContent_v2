<properties
	pageTitle="User Assigned Managed Identity for Azure Resources"
	description="User Assigned Managed Identity for Azure Resources"
	infoBubbleText="An issue was found with a user assigned managed identity on an Azure Resource"
	service="microsoft.azureactivedirectory"
	resource="userassignedidentities"
	authors="janelmsft"
	ms.author="janelmsft"
	displayOrder="1"
	articleId="01d05ee1-ccfe-4d0c-a0ec-b7c055236b83"
	diagnosticScenario=""
	selfHelpType="resource"
	supportTopicIds="32632152"
	resourceTags=""
	productPesIds="16575"
...
1. Verify you have the Managed Identity Contributor role assignment. That role assignment is required for creating/deleting user-assigned managed identities.
