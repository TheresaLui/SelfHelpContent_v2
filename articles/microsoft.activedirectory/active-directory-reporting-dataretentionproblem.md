...
* You can only see the last 30 days of data if you are Premium tenant (Azure AD P1 or P2)
...
* If you are a P1 tenant and can't see the Sign-ins, check out our [latency information] (https://docs.microsoft.com/azure/active-directory/reports-monitoring/reference-reports-latencie) and file a support ticket if the delay exceeds the documented latency
