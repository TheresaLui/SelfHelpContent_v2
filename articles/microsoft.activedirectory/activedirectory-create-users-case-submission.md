...
1. Ensure that you are authorized to perform this operation. Only a global administrator or user administrator in Azure AD can create, update or delete an existing user. If you are not in one of these roles, you will need to have an administrator create the new user for you, or add you to one of these roles.
