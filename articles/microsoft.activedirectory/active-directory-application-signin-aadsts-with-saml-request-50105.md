...
**Step 1**: Get the SAML request given at the end, and copy the value of the \"Issuer\" property value.

**Step 2**: Signin to the Azure Portal as a global administrator or another role that is able to manage this application.

**Step 3**: Navigate to Azure Active Directory, and go to the list of Enterprise applications blade, search for the application for which you want to enable federated single sign-on.
