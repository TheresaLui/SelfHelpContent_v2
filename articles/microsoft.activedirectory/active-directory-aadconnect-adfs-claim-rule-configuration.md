...
3. For additional troubleshooting for the claims issuance process use [Fiddler](https://docs.microsoft.com/windows-server/identity/ad-fs/troubleshooting/ad-fs-tshoot-fiddler).
