<properties
	...
	description="Synchronizing AD to Azure AD/OOther questions regarding synchronizing AD to Azure AD"
...
# Synchronizing AD to Azure AD/Other questions regarding synchronizing AD to Azure AD
...
Upgrade from DirSync, Azure AD Sync or older builds of Azure AD Connect
<br>
...
Troubleshooting Synchronization Service issues
<br>
...
Understand and troubleshoot synchronization issues with specific AD objects
<br>
...
Enabling and Troubleshooting Password Synchronization
<br>
* [Implement password synchronization with Azure AD Connect sync](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-password-hash-synchronization) 
* [Troubleshoot password synchronization with Azure AD Connect sync](https://docs.microsoft.com/azure/active-directory/hybrid/tshoot-connect-password-hash-synchronization)