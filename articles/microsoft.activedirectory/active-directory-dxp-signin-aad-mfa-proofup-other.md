<properties
    ...
    ms.author="vrjai"
    displayOrder="1"
    articleId="active-directory-dxp-signin-aad-mfa-proofup-other"
...
<!--issueDescription-->
Based on the information you provided the user <!--$userName-->[userName]<!--/$userName--> was trying to sign into <!--$appName-->[appName]<!--/$appName--> but the user sign-in was interrupted for required setup of Multi-Factor Authentication (MFA).
<!--/issueDescription-->
