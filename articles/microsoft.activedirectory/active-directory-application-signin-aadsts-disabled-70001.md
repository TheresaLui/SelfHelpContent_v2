...
**Step2**: Select Azure Active Directory and go to the 'Enterprise applications' blade. Search for the application for which you want to enable federated single sign-on.
