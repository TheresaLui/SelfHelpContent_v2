...
3. Click on the application name to open it, then click **Properties** on the application's left-hand navigation menu. If you do not see the application you want show up here, use the Filter control at the top of the All Applications List and set the Show option to *All applications*
