...
## **Recommended steps**
Click the error message you encounter, for appropriate troubleshooting steps. It is recommended to use Azure AD Connect to configure federation with Azure Active Directory.<br>   
Azure AD Connect provides easy steps to configure and maintain federation. If user sign-in is failing, see if the below common resolution can help.
