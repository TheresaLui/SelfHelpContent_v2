...
You can refer to the following link for the steps to resolve the issue:
...
**Action:**
You can click on the link below to directly navigate to Enterprise Applications to review and fix the configuration issue for the application:
[Enterprise Applications](https://portal.azure.com/#blade/Microsoft_AAD_IAM/StartboardApplicationsMenuBlade/AllApps/menuId/)
