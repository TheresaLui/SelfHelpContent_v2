...
Want an answer now? [Check StackOverflow for issues with Microsoft Graph 401 or 403 authorization failures](https://stackoverflow.com/questions/tagged/microsoft-graph) or post a [question on StackOverflow with tag `microsoft-graph`](https://stackoverflow.com/questions/ask).
...
4. `401 unauthorized error`: **Resetting password or adding a user to a directory role**? <br>
   ...
   [Microsoft Graph permissions](https://developer.microsoft.com/graph/docs/authorization/permission_scopes)< br>
5. `403 Forbidden`: **Does the user have access?** <br>
...
6. `400 Bad Request` or `403 Forbidden`: **Does the user comply with their organization's conditional access (CA) policies?**<br>
...
[Azure Active Directory permissions and consent](https://docs.microsoft.com/azure/active-directory/develop/v2-permissions-and-consent) <br>
[Understanding the Azure AD application consent experiences](https://docs.microsoft.com/azure/active-directory/application-consent-experience) <br>
[Get access on behalf of users](https://developer.microsoft.com/graph/docs/concepts/auth_v2_user) <br>
...
[Get access without a user](https://developer.microsoft.com/graph/docs/concepts/auth_v2_service) <br>
