<properties
	pageTitle="Problem with web service performance"
	description="Problem with web service performance"
	infoBubbleText="Problem with web service performance"
	service="microsoft.machinelearningstudioclassic"
	resource="studioclassic"
	authors="likebupt"
	ms.author="keli19"
	articleId="machinelearning-studioclassic-problemwithwebserviceperformance"
	selfHelpType="generic"
	supportTopicIds="32321867"
	productPesIds="15570"
	cloudEnvironments="public, usnat, ussec, fairfax"
	ownershipId="AzureML_AzureMachineLearning"
/>

# Problem with web service performance

## **Recommended Steps**

Studio (classic) has compute memory sku limitation. For more powerful compute resource, please consider using [Azure Machine Learning designer](https://docs.microsoft.com/azure/machine-learning/concept-designer).
