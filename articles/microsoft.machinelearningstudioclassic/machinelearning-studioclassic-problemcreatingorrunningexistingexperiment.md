...
1. Studio (classic) has compute memory sku limitation. The compute is a shared host pool where one customer can use 8 cores, 56GB at most for training. Memory cost could also be affected by different machine learning algorithms and parameter settings. For more powerful compute resource, please consider using [Azure Machine Learning designer](https://docs.microsoft.com/azure/machine-learning/concept-designer).
