<properties
	pageTitle="Stuck or failed web service call"
	description="Stuck or failed web service call"
	infoBubbleText="Stuck or failed web service call"
	service="microsoft.machinelearningstudioclassic"
	resource="studioclassic"
	authors="likebupt"
	ms.author="keli19"
	articleId="machinelearning-studioclassic-stuckorfailedwebservicecall"
...
User can check common REST API error codes in [this article](https://docs.microsoft.com/azure/machine-learning/studio/web-service-error-codes).
