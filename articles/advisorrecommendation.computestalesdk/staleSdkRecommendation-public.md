...
"owner": 
  ...
  "description": "Update to the recommended SDK version to ensure you avoid performance issues.",
  ...
  "tip": "Update to the recommended SDK version to ensure you avoid performance issues.",
  "supportedSDKLanguages": [".Net", "Java", "JavaScript", "Python"], 
  "actions": [{
                    "actionId": "",
                    "description": "Update to the recommended SDK version.",
                    "actionType": "Document",
                    "condition": "",
