<properties
	  pageTitle="SQL queries recommended actions"
	  description="SQL queries recommended actions"
	  ...
	  articleId="99b73c28-0002-494f-bbbc-a9ce554169db"
	  ownershipId="AzureData_AzureCosmosDB"
/>

# SQL queries recommended actions

We suggest to send the following recommendations to customer.
