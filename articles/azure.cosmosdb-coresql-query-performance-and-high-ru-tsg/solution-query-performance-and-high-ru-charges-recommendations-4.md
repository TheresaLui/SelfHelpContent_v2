<properties
	  pageTitle="Query performance and high RU charges recommendations"
	  description="Query performance and high RU charges recommendations"
	  ...
	  articleId="42beaa03-ebe0-4900-bf37-2d61bd5eba89"
	  ownershipId="AzureData_AzureCosmosDB"
/>

# Query performance and high RU charges recommendations

<!--issueDescription-->

Dear customer,

For optimal query performance, please follow the steps from the [Troubleshoot Query Performance](https://docs.microsoft.com/azure/cosmos-db/troubleshoot-query-performance) article.
Also, the most common issues and workarounds are detailed below. 
