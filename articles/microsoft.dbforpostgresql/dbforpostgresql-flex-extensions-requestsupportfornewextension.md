<properties
    ...
    articleId="dbforpostgresql-flex-extensions-requestsupportfornewextension"
...
The available extensions in Azure Database for PostgreSQL can be found in [this list](https://docs.microsoft.com/azure/postgresql/flexible-server/concepts-extensions).
