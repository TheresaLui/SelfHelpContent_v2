<properties
    pageTitle="High availability on Azure Database for PostgreSQL - Hyperscale (Citus)"
    description="High availability on Azure Database for PostgreSQL - Hyperscale (Citus)"
    service="microsoft.dbforpostgresql"
    resource=""
    ms.author="raagyema"
    displayOrder="70"
    articleId="dbforpostgresql-hyperscale-crud-highavailability.md"
    selfHelpType="generic"
    supportTopicIds="32731221"
    resourceTags=""
    productPesIds="17068"
