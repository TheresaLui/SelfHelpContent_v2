<properties
    ...
    articleId="dbforpostgresql-flex-create-flexserver"
...
* Consult the [REST API reference documentation](https://docs.microsoft.com/rest/api/postgresql/) if you encounter issues using our REST API