...
<!--issueDescription-->
The server <!--$ServerName-->ServerName<!--/$ServerName--> was restarted at <!--$StartTime-->StartTime<!--/$StartTime--> (UTC). The server restarted because planned failover due to <!--$RCA-->RCA<!--/$RCA-->.
<!--/issueDescription-->
