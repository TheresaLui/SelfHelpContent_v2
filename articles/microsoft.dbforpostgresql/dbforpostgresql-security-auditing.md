...
* Do you have a question about URL for `.log` files? 
  The URL generated for accessing your `.log` file is authenticated using your logged-in user credentials. The URL includes a token that was generated from your authentication. Unauthenticated users cannot view the log unless you choose to share the URL.
