<properties
	...
	ms.author="v-basanj"
	displayOrder=""
	articleId="dbforpostgresql-asc-citus-performance-hundredpercentcpu"
...
<!--issueDescription-->
CPU usage was 100% <!--$Count-->Count<!--/$Count--> times on Hyperscale (Citus) server <!--$ServerName-->ServerName<!--/$ServerName--> between <!--$StartTime-->StartTime<!--/$StartTime-->(UTC) and <!--$EndTime-->EndTime<!--/$EndTime-->(UTC).
<!--/issueDescription-->
