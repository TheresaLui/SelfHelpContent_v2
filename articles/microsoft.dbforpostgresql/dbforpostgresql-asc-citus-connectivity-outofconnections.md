<properties
	...
	ms.author="raagyema"
	displayOrder=""
	articleId="dbforpostgresql-asc-citus-connectivity-outofconnections"
	diagnosticScenario="OrcasCitusOutofConnectionsInsight"
...
<!--issueDescription-->
There are <!--$Count-->Count<!--/$Count--> failed connections to Hyperscale (Citus) server <!--$ServerName-->ServerName<!--/$ServerName--> between <!--$StartTime-->StartTime<!--/$StartTime-->(UTC) and <!--$EndTime-->EndTime<!--/$EndTime-->(UTC) because the server was already at its maximum number of connections.
<!--/issueDescription-->
