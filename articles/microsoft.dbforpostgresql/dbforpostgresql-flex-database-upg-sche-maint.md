...
* How long planned maintenance run within a region?
    ...
    Planned maintenance for a given Azure region is typically expected to run 8 hrs (11pm to 7am). During this time, Azure Database for PostgreSQL single servers are restarted and restarts are typically expected to complete in 60-120 seconds. 
* Can I choose a custom maintenance window?

    Yes, you can choose to have maintenance done on day/time of your choosing and the maintenance duration is 1 hour
