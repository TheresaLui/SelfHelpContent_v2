<properties
    ...
    supportTopicIds="32780937, 32780945"
...
* pgaudit does not provide connection logging. Connection logging is provided by Postgres's log_connections and log_disconnections parameters.
