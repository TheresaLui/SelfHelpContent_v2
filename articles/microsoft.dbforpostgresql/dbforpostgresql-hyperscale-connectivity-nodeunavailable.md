...
* Check the [resource metrics](https://docs.microsoft.com/en-us/azure/postgresql/concepts-hyperscale-monitoring) for the node. If the node is at capacity for a resource like CPU, memory, IO, or storage, consider reducing activity on the cluster or [scaling up](https://docs.microsoft.com/azure/postgresql/howto-hyperscale-scaling).
