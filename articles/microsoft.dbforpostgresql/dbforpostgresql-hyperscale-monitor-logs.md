...
You can configure your Azure Database for PostgreSQL - Hyperscale (Citus) logs to be output through [Azure Monitor Logs, storage account, or Event Hubs](https://docs.microsoft.com/azure/azure-monitor/platform/diagnostic-settings). The log format is JSON; each log event is represented by a JSON object. 
