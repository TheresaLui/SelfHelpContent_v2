...
Routing **<!--$action-->[action]<!--/$action-->**  this **<!--$TrafficDirection-->[TrafficDirection]<!--/$TrafficDirection-->** traffic because there are not any routes defined for internet routable IPs.
<!--/issueDescription-->
