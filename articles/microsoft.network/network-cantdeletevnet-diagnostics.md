...
<!--issueDescription-->
We have identified that the following resource(s) are allocated to <!--$Vnet-->[Vnet]<!--/$Vnet-->:
...
1. Check your <!--$Vnet-->[connected devices blade]<!--/$Vnet--> for virtual network. Make sure to delete all the connected devices. If there are any connected devices, deletion of the virtual network will fail.
