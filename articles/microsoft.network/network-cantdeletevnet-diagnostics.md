...
<!--issueDescription-->
Microsoft Azure has identified that the following resource(s) are allocated to [Vnet](data-blade:Microsoft_Azure_Network.VirtualNetworkBlade;data-blade-uri:Microsoft_Azure_Network.VirtualNetworkBlade): <!--$VnetAllocations-->[VnetAllocations]<!--/$VnetAllocations-->
...
1. Check your [connected devices blade](data-blade:Microsoft_Azure_Network.VirtualNetworkBlade;data-blade-uri:Microsoft_Azure_Network.VirtualNetworkBlade) for virtual network. Make sure to delete all the connected devices. If there are any connected devices, deletion of the virtual network will fail.
