...
1. Check your connected devices blade for Virtual Network <!--$Vnet-->[Vnet]<!--/$Vnet-->. Make sure to delete all the connected devices. If there are any connected devices, deletion of the virtual network will fail.
