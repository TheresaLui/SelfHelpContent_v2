...
<!--issueDescription-->
## **Problems Identified**
Microsoft Azure has identified this [Virtual Network](data-blade:Microsoft_Azure_Network.VirtualNetworkBlade) as having the following resource/s allocated: <!--$VnetAllocations-->[VnetAllocations]<!--/$VnetAllocations-->. These resources must be deleted or disassociated with this [Virtual Network](data-blade:Microsoft_Azure_Network.VirtualNetworkBlade) prior to deleting. 
<!--/issueDescription-->
