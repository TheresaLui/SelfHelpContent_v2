...
5. Check Firewall. <br>Check on-premises Firewall Configuration.
6. Check routing. <br>Check routing within your on-premises network to ensure that the routes are propagated appropriately.
