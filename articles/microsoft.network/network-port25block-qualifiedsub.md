...
<!--issueDescription-->
Your subscription **'<!--$SubscriptionName-->[SubscriptionName]<!--/$SubscriptionName-->'**, of type **'<!--$SubOfferType-->[SubscriptionOfferType]<!--/$SubOfferType-->'**, is currently unauthorized to send mail from Azure VMs on TCP port 25. You may request to have this feature enabled for your subscription by continuing with support case creation in the Azure portal for this subscription.
<!--/issueDescription-->
## More Information
We recommend using an SMTP relay as detailed [here](https://blogs.msdn.microsoft.com/mast/2017/11/15/enhanced-azure-security-for-sending-emails-november-2017-update/). 
