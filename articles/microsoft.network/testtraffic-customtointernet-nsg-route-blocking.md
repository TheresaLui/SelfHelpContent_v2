...
. Network security group **"<!--$SourceNsgName-->SourceNsgName<!--/$SourceNsgName-->"** has rule **"<!--$SecurityRuleName-->SecurityRuleName<!--/$SecurityRuleName-->"** that is causing this issue.<br>
