...
Access Control **<!--$action-->[action]<!--/$action-->**  this **<!--$TrafficDirection-->[TrafficDirection]<!--/$TrafficDirection-->** traffic by customer-defined security rule: **<!--$RuleNameWithDefaultRule_RemovedFromBeginning-->[RuleNameWithDefaultRule_RemovedFromBeginning]<!--/$RuleNameWithDefaultRule_RemovedFromBeginning-->**
<!--/issueDescription-->
