...
<!--issueDescription-->
We have identified a problem that prevents network traffic flowing from virtual machine <!--$VmName-->VmName<!--/$VmName--> to <!--$DestinationIp-->DestinationIp<!--/$DestinationIp--> on port <!--$DestinationPort-->DestinationPort<!--/$DestinationPort-->. Our diagnostics detected that the following condition exists:<br>
