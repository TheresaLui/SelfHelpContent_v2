...
<!--issueDescription-->
We have found your subscription **'<!--$SubscriptionName-->[SubscriptionName]<!--/$SubscriptionName-->'**, without exception, **cannot be authorized** to send mail from Azure resources on TCP port 25. 
