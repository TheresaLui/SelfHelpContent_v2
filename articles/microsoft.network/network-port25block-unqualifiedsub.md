...
For more information and recommendations on this restriction please review the details [here](https://blogs.msdn.microsoft.com/mast/2017/11/15/enhanced-azure-security-for-sending-emails-november-2017-update/). If you have a requirement to send mail over TCP port 25, please create a new 'Pay-as-You-Go' subscription as described [here](https://azure.microsoft.com/pricing/purchase-options/) and submit a support request through that subscription for authorization to send mail on port 25.