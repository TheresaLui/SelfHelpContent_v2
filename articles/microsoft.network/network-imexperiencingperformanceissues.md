...
[Enable performance logs](https://azure.microsoft.com/documentation/articles/application-gateway-diagnostics/)
2. Check throughput limits to ensure that throughput is within acceptable limits.<br>
[Check throughput guidance for application gateway](https://azure.microsoft.com/documentation/articles/application-gateway-introduction/)
...
[For additional details, see Application Gateway documentation.](https://azure.microsoft.com/documentation/services/application-gateway/)
