...
Once a configuration change has been made, for an existing Application Gateway of v1 SKU, it is expected to take between 5 to 20 minutes for the update process to be completed. For v2 SKU, it is expected to take between 1 to 2 minutes. If your update or PUT operation on the Application Gateway is taking significantly longer than expected, there are possibilities of update failures.
