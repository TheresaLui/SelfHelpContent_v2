...
9.	External Load-Balancer (ELB/SLB): If you have a VPN/ ExpressRoute and [Forced Tunneling](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-forced-tunneling-rm) or a [Default Route](https://github.com/Azure/azure-content/blob/master/articles/expressroute/expressroute-routing.md) is applied on the Vnet or LB subnet, this can disrupt proper communication routing.
