...
- Check whether cookie-based session affinity has been enabled or not.  You can enable cookie-based session affinity by enabling the **Cookie based affinity** switch in the [HTTP Settings](https://docs.microsoft.com/azure/application-gateway/configuration-overview#http-settings) associated with the required backend pool. 
