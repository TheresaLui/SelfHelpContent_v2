...
---
{
    ...
    "formElements": [
        ...
        },
        {
            ...
            "watermarkText": "Please provide any additional details regarding the issue such as type of data being copied, number of files and typical file sizes, data ports being used and and any other relevant information",
            "required": true,
