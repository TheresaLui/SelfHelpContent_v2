<properties
	  pageTitle="Extract the raw data from the activity and check it with the source app support"
	  description="Extract the raw data from the activity and check it with the source app support"
	  ...
	  articleId="c169e95c-95aa-4b80-8dd3-f864b729408f"
	  ownershipId="CloudAppSecurity_API"
/>

# Extract the raw data from the activity and check it with the source app support
