<properties
	  pageTitle="There is an error in the connected app"
	  description="There is an error in the connected app"
	  ...
	  articleId="3f3d9ede-115f-430c-90fd-eb0c00384dcf"
	  ownershipId="CloudAppSecurity_API"
/>

# There is an error in the connected app
