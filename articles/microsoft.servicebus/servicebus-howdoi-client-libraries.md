<properties
	pageTitle="how do i/Questions with SB client libraries or API"
...
* [Service Bus libraries for .Net](https://docs.microsoft.com/dotnet/api/overview/azure/service-bus?view=azure-dotnet)<br>
* [Service Bus libraries for Python](https://docs.microsoft.com/python/api/overview/azure/servicebus?view=azure-python)<br>
