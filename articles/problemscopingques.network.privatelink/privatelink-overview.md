<properties
    pageTitle="Private Link overview"
    description="Private Link overview"
    ...
    schemaVersion="1"
    articleId="700961cc-d014-4545-be70-2069dc2e0109"
/>
...
---
{
    ...
    "formElements": [
        ...
        },
        {
            ...
            "hints": [
                {
                    "text": "Did you receive any error messages that you need assistance with? (If yes, please share the error message as well)"
                },
                {
                    "text": "Can you share more details about your specific scenario with Private Link Service?"
                }
            ]
        }
    ],
