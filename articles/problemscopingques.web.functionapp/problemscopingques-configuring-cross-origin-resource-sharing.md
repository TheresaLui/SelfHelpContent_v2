<properties
	articleId="problemscopingques-configuring-cross-origin-resource-sharing"
	pageTitle="Configuring Cross-Origin Resource Sharing (CORS)"
	description="Configuring Cross-Origin Resource Sharing (CORS)"
