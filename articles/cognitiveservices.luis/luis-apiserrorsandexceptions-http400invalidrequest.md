...
* [Understand the differences between authoring and prediction keys](https://docs.microsoft.com/azure/cognitive-services/luis/luis-concept-keys) - Note that response codes may differ if you are using V2 or V3 APIs
