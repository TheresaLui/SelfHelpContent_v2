...
* **Two possible states of your account:** [Migrated](https://docs.microsoft.com/en-us/azure/cognitive-services/luis/luis-migration-authoring) or not migrated.
...
* **Will my applications migrate with me?** Yes, only if you are the owner of the application. All your applications will migrate and will be automatically associated with the authoring resource you migrated on.
...
* They will continue to use their applications normally.
    ...
    **PLEASE NOTE:** If any collaborator owns a **runtime/prediction Resource** and associates it with the owner's application, migration will fail for both the owner and collaborator. Collaborator will need to either remove the runtime resource from the application or give access to owner from Azure portal for the migration to be successful.
