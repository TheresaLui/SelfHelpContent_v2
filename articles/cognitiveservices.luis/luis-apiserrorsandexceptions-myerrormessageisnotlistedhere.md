<properties
pageTitle="My error message is not listed here"
description="My error message is not listed here"
...
supportTopicIds="32683919"
productPesIds="16869"
cloudEnvironments="public, MoonCake, fairfax, usnat, ussec"
articleId="LUIS_Conversation_APIsErrorsAndExceptions_myErrorMessageIsNotListedHere"
...
* If you are using LUIS runtime endpoint and getting a **414 response error**, please make sure that the query did not exceed the limit which is set for 500 characters

* Please check [limits for LUIS model and keys](https://docs.microsoft.com/azure/cognitive-services/luis/luis-limits#model-limits)
