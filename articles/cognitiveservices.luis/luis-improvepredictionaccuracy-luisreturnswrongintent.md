...
* You can try adding [model as features](https://docs.microsoft.com/azure/cognitive-services/luis/luis-concept-feature#a-model-as-a-feature-helps-another-model) to your intent or [phrase list features](https://docs.microsoft.com/azure/cognitive-services/luis/luis-concept-feature#a-phrase-list-for-a-particular-concept) to improve its prediction accuracy  
