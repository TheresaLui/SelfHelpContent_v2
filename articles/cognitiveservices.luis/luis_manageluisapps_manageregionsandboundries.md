...
* If you are authoring in **Europe portal (eu.luis.ai)**, here are the[Europe publishing regions](https://docs.microsoft.com/azure/cognitive-services/luis/luis-reference-regions#publishing-to-europe) associated with it.

* If you are authoring in **Australia portal (au.luis.ai)**, here are the[Australia publishing regions](https://docs.microsoft.com/azure/cognitive-services/luis/luis-reference-regions#publishing-to-australia) associated with it.
