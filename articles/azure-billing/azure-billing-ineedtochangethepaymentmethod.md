<properties
	...
	articleId="ddfec062-54cd-4d7a-a2f1-e7c446516e26"
...
4. On the right side of the page, select **Manage payment methods**. If you want to update payment method to 'invoice' (direct debit), please open a [support request](https://ms.portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade/overview) so we can run a credit check before approving your request.
