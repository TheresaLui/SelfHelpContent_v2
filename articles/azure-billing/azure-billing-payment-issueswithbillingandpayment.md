<properties
	pageTitle="payment-my issue is not listed above"
	description="payment-my issue is not listed above"
...
* [Azure portal or Account Center sign-up issues](https://docs.microsoft.com/azure/billing/billing-troubleshoot-azure-sign-up)
* [Troubleshoot Sign-in Issues for Azure Subscription](https://docs.microsoft.com/azure/billing/billing-troubleshoot-sign-in-issue)
