<properties
	pageTitle="General issues or requests for Azure Subscription Exchanges and Refunds"
	description="General issues or requests for Azure Subscription Exchanges and Refunds"
...
For help with exchanges and refunds for:

* [Virtual Machines](https://docs.microsoft.com/azure/virtual-machines/windows/prepay-reserved-vm-instances#cancellations-and-exchanges)
[SUSE Software](https://docs.microsoft.com/azure/virtual-machines/linux/prepay-suse-software-charges#cancellation-and-exchanges-not-allowed)
[SQL Database](https://docs.microsoft.com/azure/sql-database/sql-database-reserved-capacity#cancellations-and-exchanges) <br>

Learn more:

* [Azure Pricing](https://azure.microsoft.com/pricing) <br>
* [Supported list of countries and regions](https://azure.microsoft.com/pricing/faq/) <br>
