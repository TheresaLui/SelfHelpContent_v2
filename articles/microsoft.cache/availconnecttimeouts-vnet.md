...
* [VNET FAQ and configuration options](https://docs.microsoft.com/azure/azure-cache-for-redis/cache-how-to-premium-vnet#azure-cache-for-redis-vnet-faq)<br>
* [Best Practices for Azure Cache for Redis](https://docs.microsoft.com/azure/azure-cache-for-redis/cache-best-practices)<br>
* [Azure Cache for Redis complete documentation](https://docs.microsoft.com/azure/azure-cache-for-redis/)<br>
