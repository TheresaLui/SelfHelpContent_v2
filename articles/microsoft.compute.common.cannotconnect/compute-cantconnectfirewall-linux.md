...
Most customers resolve issues with their Virtual Machine (VM) firewall using the following steps.<br>

## **Recommended Steps**

* Use the [Serial Console blade](button-data-blade:Microsoft_Azure_Compute.VmSerialConsoleValidationBlade.resourceId.$resourceId) to gain access to your VM and edit the firewall rules

## **Recommended Documents**

* [Troubleshoot connectivity problems between Azure VMs](https://docs.microsoft.com/azure/virtual-network/virtual-network-troubleshoot-connectivity-problem-between-vms)<br>
