...
Use [Serial Console](button-data-blade:Microsoft_Azure_Compute.VmSerialConsoleValidationBlade.resourceId.$resourceId) and open a CMD instance to query the current status.<br>
