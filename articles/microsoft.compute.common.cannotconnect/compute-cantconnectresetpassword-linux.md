...
2. Alternatively, [perform the reset actions using CLI and VMAccess extension for Linux](https://docs.microsoft.com/azure/virtual-machines/extensions/vmaccess#ways-to-use-the-vmaccess-extension)
