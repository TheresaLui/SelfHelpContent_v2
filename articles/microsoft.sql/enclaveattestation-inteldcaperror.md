<properties
	pageTitle="Enclave attestation - Intel DCAP error"
	description="Enclave attestation - Intel DCAP error"
	infoBubbleText="Enclave attestation failed due to an error in Intel Data Center Attestation Primitives (DCAP) client."
	service="microsoft.sql"
	resource="servers"
	authors="vidit-msft"
	ms.author="viditgupta"
	displayOrder=""
	articleId="enclaveAttestationIntelDcapError_7C8F26F5-4CB3-43F9-9438-D1EBA4CF753D"
	diagnosticScenario=""
	selfHelpType="rca"
...
# Enclave attestation failed in Intel Data Center Attestation Primitives (DCAP) client
...
Contact **Customer Support** to validate that the Intel DCAP binary is installed on the node and configured properly.
