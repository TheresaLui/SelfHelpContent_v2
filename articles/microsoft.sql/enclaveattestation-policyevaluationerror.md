<properties
	pageTitle="Enclave attestation - Policy Evaluation error"
	description="Enclave attestation - Policy Evaluation error"
	infoBubbleText="There seems to be an error while evaluating the attestation policy."
	service="microsoft.sql"
	resource="servers"
	authors="vidit-msft"
	ms.author="viditgupta"
	displayOrder=""
	articleId="enclaveAttestationPolicyEvaluationError_DADA39EB-EF47-475E-A8B1-6E491E47D987"
	diagnosticScenario=""
	selfHelpType="rca"
...
# Attestation policy evaluation error

## We ran diagnostics on your resource and found an issue
<!--issueDescription-->
We ran diagnostics between <!--$StartTime-->StartTime<!--/$StartTime--> UTC and <!--$EndTime-->EndTime<!--/$EndTime--> UTC and 
it seems like there is an issue with the attestation policy used for connecting to your database **<!--$DatabaseName-->DatabaseName<!--/$DatabaseName-->**. To resolve this issue, please follow the recommended steps.
<!--/issueDescription-->
