...
it seems there is an issue with the attestation policy used for connecting to your database **<!--$DatabaseName-->DatabaseName<!--/$DatabaseName-->**. To resolve this issue, follow the recommended steps.
<!--/issueDescription-->
