...
a) reducing how often a copy is required, and <br>
b) introducing pause/resume capability which can be used instead of scaling, and is expected to take less than 5 minutes in all cases. For more information, please refer to the links below.
