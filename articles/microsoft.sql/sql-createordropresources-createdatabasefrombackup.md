...
### Using AzureSQLDatabase backups.
...
* [SQL Server Customer Advisory Team blog about migrating using BACPAC files](https://techcommunity.microsoft.com/t5/datacat/migrating-from-sql-server-to-azure-sql-database-using-bacpac/ba-p/305407)<br>
