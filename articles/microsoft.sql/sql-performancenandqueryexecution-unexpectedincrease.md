...
<ul>
<li>[Failover Rest API](https://docs.microsoft.com/en-us/rest/api/sql/databases(failover)) can be used to easily failover your Azure SQL database to a new node.</li>
</ul>
