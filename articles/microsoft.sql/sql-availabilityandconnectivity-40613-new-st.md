...
Error 40613 is a nonspecific, [transient error](https://docs.microsoft.com/azure/azure-sql/database/troubleshoot-common-connectivity-issues?WT.mc_id=pid:13491:sid:32745425) that is returned when your database is unavailable.  It is nonspecific because it is returned for all unavailability reasons, including:
