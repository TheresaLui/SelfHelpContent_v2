...
During the period the service is reconfiguring your database on different hardware, all attempts to connect to the database will receive error 40613.  The [Resource Health](https://docs.microsoft.com/azure/azure-sql/database/resource-health-to-troubleshoot-connectivity?WT.mc_id=pid:13491:sid:32745425) blade will reflect the fact that the database was unavailable within 15 minutes.  If a more detailed unavailability reason is available, the resource health event is updated with this information (usually within 30 minutes).  
