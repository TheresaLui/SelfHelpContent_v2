...
<!--issueDescription-->  
We were able to detect a login failure in the following Azure Member Database(s):
<br>
**<!--$LoginFailedAzureMemberList--> LoginFailedAzureMemberList <!--/$LoginFailedAzureMemberList-->**
<!--/issueDescription-->

Please update the credentials for the member(s).

## **Recommended Steps**

1. In [Azure Portal](https://portal.azure.cn), navigate to the hub database
...
In case the failing task is Sync, please review the credentials for the hub:
