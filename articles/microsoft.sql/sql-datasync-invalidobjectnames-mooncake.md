...
<!--issueDescription-->  
In Data Sync, the names of objects (databases, tables, and columns) cannot contain the printable characters period (.), left square bracket ([), or right square bracket (]).

We were able to detect unsupported object names in the Database(s):
