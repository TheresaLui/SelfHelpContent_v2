...
* [Overview of Elastic Jobs](https://docs.microsoft.com/en-us/azure/sql-database/elastic-jobs-overview)
* [Elastic Jobs PowerShell documentation](https://docs.microsoft.com/en-us/azure/sql-database/elastic-jobs-powershell)
* [Elastic Jobs T-SQL documentation](https://docs.microsoft.com/en-us/azure/sql-database/elastic-jobs-tsql)
...
* [Job Agents](https://docs.microsoft.com/en-us/rest/api/sql/jobagents)
* [Credentials](https://docs.microsoft.com/en-us/rest/api/sql/jobcredentials)
* [Target Groups](https://docs.microsoft.com/en-us/rest/api/sql/jobtargetgroups)
* [Jobs](https://docs.microsoft.com/en-us/rest/api/sql/jobs)
* [Job Steps](https://docs.microsoft.com/en-us/rest/api/sql/jobsteps)
* [Job Executions](https://docs.microsoft.com/en-us/rest/api/sql/jobexecutions)
* [Job Step Executions](https://docs.microsoft.com/en-us/rest/api/sql/jobstepexecutions)
* [Job Target Executions](https://docs.microsoft.com/en-us/rest/api/sql/jobtargetexecutions)