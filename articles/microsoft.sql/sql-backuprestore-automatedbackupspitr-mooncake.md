...
* [Backup scheduling](https://docs.azure.cn/sql-database/sql-database-automated-backups?WT.mc_id=pid:13491:sid:32630409/#how-often-do-backups-happen) is handled transparently and is dependent on compute size and database activity:
...
* [You can change the backup retention period](https://docs.azure.cn/sql-database/sql-database-automated-backups?WT.mc_id=pid:13491:sid:32630409/#how-to-change-the-pitr-backup-retention-period) for a database to 7, 14, 21, 28, or 35 days via the Azure Portal, PowerShell, or the REST API:
...
* You cannot view a list of automated backups:
	...
	* [Long-term retention backups can be listed](https://docs.azure.cn/sql-database/sql-database-long-term-backup-retention-configure?WT.mc_id=pid:13491:sid:32630409/#view-backups-and-restore-from-a-backup-using-azure-portal) and should not be confused with automated backups for point in time restore
...
* [**Geo-restore**](https://docs.azure.cn/sql-database/sql-database-recovery-using-backups?WT.mc_id=pid:13491:sid:32630409/#geo-restore): SQL Databases can be restored on any server in any Azure region from the most recent geo-replicated backup
