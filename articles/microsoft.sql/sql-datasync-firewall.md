...
<!--issueDescription-->  
Data Sync feature relies on Azure hosted sync agents to perform tasks like Refresh Schema, Provisioning, etc. Those agents need to connect to your databases using Azure IPs.
When using Data Sync feature you need to keep **Allow access to Azure services** turned on so the sync agents can access your SQL Database server.<br>
Alternatively, you can just whitelist the SQL DB IP Ranges for hub's region.<br>
