...
3. [Load data with Azure Data Factory](https://azure.microsoft.com/documentation/articles/sql-data-warehouse-load-from-azure-blob-storage-with-data-factory/)
4. [Load data with bcp](https://docs.azure.cn/sql-data-warehouse/sql-data-warehouse-load-from-sql-server-with-bcp/)
5. [Load data with SSIS](https://docs.azure.cn/sql-data-warehouse/sql-data-warehouse-load-from-sql-server-with-integration-services/)
...
* [How to load with BCP](https://docs.azure.cn/sql-data-warehouse/sql-data-warehouse-load-with-bcp/)<br>
* [How to load with SSIS](https://docs.azure.cn/sql-data-warehouse/sql-data-warehouse-load-from-sql-server-with-integration-services/)
