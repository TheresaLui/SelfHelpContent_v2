...
Often, when dropping a database using Azure Portal fails, dropping the database using SQL Server Management Studio will work more reliably.  Simply run "DROP [database name]" from SSMS. https://docs.microsoft.com/azure/sql-database/sql-database-connect-query-ssms
