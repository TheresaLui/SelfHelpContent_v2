...
Data Sync was not able to reach the following database(s):
...
* [Azure SQL Database IP firewall rules](https://docs.azure.cn/sql-database/sql-database-firewall-configure)
