...
* You cannot view a list of automated backups due to their frequency and nature
...
* The following options are available for [restoring databases from automated backups](https://docs.microsoft.com/azure/sql-database/sql-database-recovery-using-backups?WT.mc_id=pid:13491:sid:32630409/):
