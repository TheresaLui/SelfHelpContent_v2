...
## **Recommended steps**
If you get connection failures using Service Fabric Explorer (SFX) or PowerShell to the Management Endpoint, please try the foollowing steps.  
