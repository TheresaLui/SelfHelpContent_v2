...
2. Network Security Group blocking traffic from Service Fabric Resource Provider. Service Fabric Resource Provider (SFRP) is at {region}.servicefabric.azure.com (for example, westus.servicefabric.azure.com).  View your NSG rules at Resource Group -> Virtual Network -> Subnet -> Security
