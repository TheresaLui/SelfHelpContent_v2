...
1. Most of the System errors are described in this article: [Use system health reports to troubleshoot](https://docs.azure.cn/service-fabric/service-fabric-understand-and-troubleshoot-with-system-health-reports/)
