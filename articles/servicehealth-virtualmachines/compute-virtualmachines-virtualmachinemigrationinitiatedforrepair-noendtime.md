<properties
	...
	articleId="servicehealthinsights-microsoft.compute-virtualmachines-healthannotation_virtualmachinemigrationinitiatedforrepair"
...
<!--issueDescription-->
At <!--$startTime--> startTime <!--/$startTime--> UTC, your virtual machine <!--$resourceName--> resourceName <!--/$resourceName--> became unavailable because of an unexpected failure on the server where it was hosted. Your virtual machine was automatically moved to another host server.
<!--/issueDescription-->
