<properties
	...
	articleId="servicehealthinsights-microsoft.classiccompute-virtualmachines-healthannotation_virtualmachinestorageoffline-withendtime"
	diagnosticScenario="health_diagnostic"
	selfHelpType="servicehealthinsights"
	cloudEnvironments="public"
	articleTags="healthannotation_virtualmachinestorageoffline-withendtime"
/>

# Your virtual machine wasn't available because it lost connectivity to its remote disk

<!--issueDescription-->
At <!--$startTime--> startTime <!--/$startTime--> UTC, your virtual machine <!--$resourceName--> resourceName <!--/$resourceName--> became unavailable because it lost connectivity to its remote disk. The availability of your virtual machine was restored at <!--$endTime--> endTime <!--/$endTime--> UTC.
<!--/issueDescription-->
