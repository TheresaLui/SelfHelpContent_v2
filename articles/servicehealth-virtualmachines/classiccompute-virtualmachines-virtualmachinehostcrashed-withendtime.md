<properties
	pageTitle="Your virtual machine wasn't available due to an unexpected reboot of the host server"
	description="Your virtual machine wasn't available due to an unexpected reboot of the host server"
	infoBubbleText="Your virtual machine wasn't available due to an unexpected reboot of the host server"
	service="microsoft.classiccompute"
	resource="virtualmachines"
	authors="dushyantgill"
	articleId="servicehealthinsights-microsoft.classiccompute-virtualmachines-healthannotation_virtualmachinehostcrashed-withendtime"
	diagnosticScenario="health_diagnostic"
	selfHelpType="servicehealthinsights"
	cloudEnvironments="public"
	articleTags="healthannotation_virtualmachinehostcrashed-withendtime"
/>

# Your virtual machine wasn't available due to an unexpected reboot of the host server

<!--issueDescription-->
At <!--$startTime--> startTime <!--/$startTime--> UTC, your virtual machine <!--$resourceName--> resourceName <!--/$resourceName--> became unavailable because the server where it was hosted rebooted unexpectedly. The availability of your virtual machine was restored at <!--$endTime--> endTime <!--/$endTime--> UTC.
<!--/issueDescription-->
