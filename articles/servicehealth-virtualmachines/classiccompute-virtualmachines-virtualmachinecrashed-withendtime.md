...
* **Learn about Windows bug check codes**: please refer to the following article: [bug check code reference](https://docs.microsoft.com/windows-hardware/drivers/debugger/bug-check-code-reference2).