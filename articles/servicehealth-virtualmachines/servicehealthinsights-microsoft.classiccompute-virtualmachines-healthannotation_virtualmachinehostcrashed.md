<properties
	...
	authors="dugill"
	articleId="servicehealthinsights-microsoft.classiccompute-virtualmachines-healthannotation_virtualmachinehostcrashed"
	diagnosticScenario="health_diagnostic"
	selfHelpType="servicehealthinsights"
	cloudEnvironments="public"
	articleTags="healthannotation_virtualmachinehostcrashed"
/>

# Your virtual machine wasn't available due to an unexpected reboot of the host server

<!--issueDescription-->
At <!--$startTime--> startTime <!--/$startTime--> UTC, your virtual machine <!--$resourceName--> resourceName <!--/$resourceName--> became unavailable because the server it was hosted on rebooted unexpectedly. The availability of your virtual machine was restored at <!--$endTime--> endTime <!--/$endTime--> UTC.
<!--/issueDescription-->
