<properties
	...
	articleId="servicehealthinsights-microsoft.classiccompute-virtualmachines-healthannotation_virtualmachinemigrationinitiatedforunplannedmaintenance-withendtime"
	diagnosticScenario="health_diagnostic"
	selfHelpType="servicehealthinsights"
	cloudEnvironments="public"
	articleTags="healthannotation_virtualmachinemigrationinitiatedforunplannedmaintenance-withendtime"
/>

# Your virtual machine was unavailable while it was being migrated to another host server

<!--issueDescription-->
At <!--$startTime--> startTime <!--/$startTime--> UTC, your virtual machine <!--$resourceName--> resourceName <!--/$resourceName--> became unavailable because of an unexpected event on the server where it was hosted. Your virtual machine was automatically moved to another host server and availability was restored at <!--$endTime--> endTime <!--/$endTime--> UTC.
<!--/issueDescription-->

An unplanned hardware maintenance action was required to ensure the long term reliability of the host server where your virtual machine was hosted. As a result, your virtual machine was automatically moved to a different and healthy host server to avoid further impact. This caused your virtual machine to reboot. RDP and SSH connections to your virtual machine, or requests to any services running inside your virtual machine may have failed during this time.
