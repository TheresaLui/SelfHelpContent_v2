...
2.	You have provided a unique name for your search service and followed the naming guidelines found [here](https://docs.microsoft.com/en-us/azure/search/search-create-service-portal).
3.	You have selected a [supported region](https://azure.microsoft.com/en-us/pricing/details/search/) for Azure Cognitive Search.
