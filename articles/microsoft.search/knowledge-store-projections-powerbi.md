...
1. Power BI is configured to access the [knowledge stroe storage account](https://docs.microsoft.com/en-us/azure/search/knowledge-store-connect-powerbi)
1. Power BI uses the relationships generated by the knowledge store
	
## **Recommended Documents**

* [Create an Azure Search knowledge store and connect using Power BI](https://docs.microsoft.com/en-us/azure/search/knowledge-store-connect-powerbi) 
