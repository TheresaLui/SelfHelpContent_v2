<properties
	pageTitle="Resolve index and statistics related issues in Azure SQL Database Managed Instance"
	description="Resolve index and statistics related issues in Azure SQL Database Managed Instance"
	...
	articleId="sqlmi-performanceandqueryexecution-indexmaintaineneceandstatstics"
	ownershipId="AzureData_AzureSQLDB_Performance"
/>

# Resolve index and statistics related issues in Azure SQL Database Managed Instance
