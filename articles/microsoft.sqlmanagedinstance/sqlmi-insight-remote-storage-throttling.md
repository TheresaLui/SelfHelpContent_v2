...
* To increase the size of file, use the __MODIFY FILE__ clause of the __ALTER DATABASE__ statement, specifying the __SIZE__ and the __MAXSIZE__ syntax, as described in the following example:
