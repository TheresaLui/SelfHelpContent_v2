...
* If you have free, unneeded space on your instance, you can [enlarge your log files](<https://docs.microsoft.com/sql/relational-databases/logs/manage-the-size-of-the-transaction-log-file?view=sql-server-2017#AddOrEnlarge>). To enlarge the log file, use the __MODIFY FILE__ clause of the __ALTER DATABASE__ statement, specifying the __SIZE__ and/or __MAXSIZE__ syntax, as described in the following example:
