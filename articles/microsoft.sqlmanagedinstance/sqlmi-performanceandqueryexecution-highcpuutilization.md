<properties
	pageTitle="Resolve poor performance issues due to high CPU in Azure SQL Database Managed Instance"
	description="Resolve poor performance issues due to high CPU in Azure SQL Database Managed Instance"
