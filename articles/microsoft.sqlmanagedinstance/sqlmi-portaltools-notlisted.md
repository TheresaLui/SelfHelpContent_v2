...
* [SQL Server Data Tools for Visual Studio (SSDT)](https://docs.microsoft.com/en-us/sql/ssdt/sql-server-data-tools). Note that Visual Studio 2019 or higher is required.
