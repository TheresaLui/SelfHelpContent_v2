...
- Check whether your [feature is available in Managed Instance](https://docs.microsoft.com/azure/sql-database/sql-database-features)
- Check if there are [known issues or feature limitations in Managed Instance](https://docs.microsoft.com/azure/sql-database/sql-database-features) that you can relate with your issue
