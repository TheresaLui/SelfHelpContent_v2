...
- Check are you reaching the storage limit by querying `master.sys.server_resource_stats` view. If you are not reaching the current instance storage limit, check have you reached the limit in the past because maybe some files are shrunk in the meantime.
