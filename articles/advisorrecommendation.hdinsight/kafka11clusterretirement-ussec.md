<properties
    ...
    authors="xunwei"
    ms.author="xunwei"
    articleId="36dff9ef-afde-40f5-b742-79a0bafcf6c2_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://USSecEast.hdinsight.kusto.core.microsoft.scloud').database('hdinsight').KafkaVersionRetirementInHDI",
    "dataSource": "Kusto",
