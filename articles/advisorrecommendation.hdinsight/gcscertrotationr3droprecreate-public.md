<properties
    ...
    authors="xunwei"
    ms.author="xunwei"
    articleId="d3a6303c-ac8f-4a9c-aad9-939b440d17ba_Public"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://hdinsight.kusto.windows.net').database('HDInsight').GCSCertRotationR3DropRecreate",
    "dataSource": "Kusto",
