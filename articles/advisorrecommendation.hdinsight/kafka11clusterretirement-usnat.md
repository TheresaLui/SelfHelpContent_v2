<properties
    ...
    authors="xunwei"
    ms.author="xunwei"
    articleId="36dff9ef-afde-40f5-b742-79a0bafcf6c2_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://hdinsightwest.usnatwest.kusto.core.eaglex.ic.gov').database('hdinsightkustodb').KafkaVersionRetirementInHDI",
    "dataSource": "Kusto",
