<properties
    ...
    authors="xunwei"
    ms.author="xunwei"
    articleId="dddd213b-87b9-439e-a607-a9ecd94e0ae1_Fairfax"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://hdinsightff.kusto.usgovcloudapi.net').database('HDInsightFF').GCSCertRotationR3PlanPatch",
    "dataSource": "Kusto",
