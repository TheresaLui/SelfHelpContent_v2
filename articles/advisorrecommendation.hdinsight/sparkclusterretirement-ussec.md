<properties
    ...
    authors="xunwei"
    ms.author="xunwei"
    articleId="20dfc768-7850-4176-9707-b9bb52afb95a_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://hdinsight.usseceast.kusto.core.microsoft.scloud').database('hdinsightkustodb').SparkVersionRetirementInHDI",
    "dataSource": "Kusto",
