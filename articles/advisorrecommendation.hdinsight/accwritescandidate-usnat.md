<properties
    ...
    authors="xunwei"
    ms.author="xunwei"
    articleId="8109a740-abe9-453e-91fc-c25598de73d0_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://hdinsightwest.usnatwest.kusto.core.eaglex.ic.gov').database('hdinsightkustodb').AccWriteCandidateHBaseClusters",
    "dataSource": "Kusto",
