<properties
    ...
    authors="xunwei"
    ms.author="xunwei"
    articleId="353bcb88-3747-4a7a-8b1c-374117db5668_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://hdinsightmooncake2.chinanorth2.kusto.chinacloudapi.cn').database('HDInsightMC').AllClustersInLastHr",
    "dataSource": "Kusto",
