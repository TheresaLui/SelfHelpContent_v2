<properties
    ...
    authors="xunwei"
    ms.author="xunwei"
    articleId="8109a740-abe9-453e-91fc-c25598de73d0_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://hdinsight.usseceast.kusto.core.microsoft.scloud').database('hdinsightkustodb').AccWriteCandidateHBaseClusters",
    "dataSource": "Kusto",
