<properties
          ...
          articleId="51bf111d-3a32-4981-b22b-076a6c44d902"
           ownershipId="Centennial_CloudNet_LoadBalancer"
    />

# Linux

**Data Migration Tools available on Linux OS**
...
2. **Azure CLI**: Azure CLI is an open source, cross platform set of tools for different azure services. 

3. **Other tools**: 
   
   ***AzCopy v7*** - Copy blobs in Blob storage (*Obsolete/Not Recommended*).
...
2: Azure CLI (Blob/File)

3: Other Tools (Blob/File)
