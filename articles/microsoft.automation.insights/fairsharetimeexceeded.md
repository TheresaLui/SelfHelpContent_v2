...
infoBubbleText="Found a failed runbook that exceeded the fair share time limit. See details on the right."
...
We have investigated and identified that your runbook, <!--$RunbookName-->[RunbookName]<!--/$RunbookName-->, failed <!--$FailedJobs-->[FailedJobs]<!--/$FailedJobs--> times in the 5 days preceding when this case was created. It exceeded the 180-minute [fair share](https://docs.microsoft.com/azure/automation/automation-runbook-execution#fair-share).
### Recommended Steps
