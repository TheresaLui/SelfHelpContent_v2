...
#### 1) Look at the [memory limit troubleshooting guide](https://docs.microsoft.com/en-us/azure/automation/troubleshoot/runbooks#job-attempted-3-times)
...
If the methods described in the [memory limit troubleshooting guide](https://docs.microsoft.com/en-us/azure/automation/troubleshoot/runbooks#job-attempted-3-times) are not acceptable you will need to optimize the runbook.
...
- [Memory limit troubleshooting guide](https://docs.microsoft.com/en-us/azure/automation/troubleshoot/runbooks#job-attempted-3-times)
