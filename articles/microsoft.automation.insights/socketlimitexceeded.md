...
#### 1) Review the [Socket Limit troubleshooting guide](https://docs.microsoft.com/azure/automation/troubleshoot/runbooks#job-attempted-3-times) which contains methods to solve this problem.
Implement the recommendations in the Socket Limit troubleshooting guide including:
