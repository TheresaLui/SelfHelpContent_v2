...
[Using Logging with Key Vault](https://docs.microsoft.com/en-us/azure/key-vault/key-vault-logging)
...
[Set up Key Vault with end-to-end key rotation and auditing](https://docs.microsoft.com/en-us/azure/key-vault/key-vault-key-rotation-log-monitoring)
...
[Logging with Azure Key Vault](https://docs.microsoft.com/en-us/azure/key-vault/key-vault-logging)<br>
[Set up Key Vault with end-to-end key rotation and auditing](https://docs.microsoft.com/en-us/azure/key-vault/key-vault-key-rotation-log-monitoring)
