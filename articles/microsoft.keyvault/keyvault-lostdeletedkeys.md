...
[Using Soft-Delete and Backup and Restore Behavior with Key Vault](https://docs.microsoft.com/en-us/azure/key-vault/key-vault-ovw-soft-delete)
...
[Using Soft-Delete with Key Vault](https://docs.microsoft.com/en-us/azure/key-vault/key-vault-ovw-soft-delete)<br>
[Understanding Backup and Restore Behavior in Key Vault](https://docs.microsoft.com/en-us/azure/key-vault/key-vault-ovw-security-worlds)<br>
