...
* If you are moving your key vault to a new subscription, please see the following document. [Azure Key Vault Subscription Move](https://docs.microsoft.com/en-us/azure/key-vault/general/keyvault-move-subscription)
