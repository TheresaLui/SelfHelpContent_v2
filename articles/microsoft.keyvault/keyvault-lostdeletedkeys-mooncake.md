...
* Using Soft-Delete with Key Vault: [Using Soft-Delete and Backup and Restore Behavior with Key Vault](https://docs.azure.cn/key-vault/key-vault-ovw-soft-delete)
