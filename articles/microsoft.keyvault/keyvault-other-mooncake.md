...
* How to Create and Manage a Key Vault
    ...
    [Key Vault Getting Started Guide in PowerShell](https://docs.azure.cn/key-vault/key-vault-get-started)
...
* See how to use SAS tokens with [Managed Storage Account Keys](https://docs.azure.cn/key-vault/key-vault-ovw-storage-keys)
...
* [Code Samples for Key Vault](https://azure.microsoft.com/resources/samples/?service=key-vault&sort=0)