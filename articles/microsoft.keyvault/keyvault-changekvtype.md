...
* When Key Vault is created through CLI command use --sku parameter to create standard or premium type. For more information how to create key vault check [Create Key Vault using CLI](https://docs.microsoft.com/en-us/cli/azure/keyvault?view=azure-cli-latest#az-keyvault-create) <br>
...
[Creating and Managing Key Vault with Portal](https://docs.microsoft.com/en-us/azure/key-vault/quick-create-portal)<br>
...
[Azure CLI Developer Guide](https://docs.microsoft.com/en-us/cli/azure/keyvault?view=azure-cli-latest)