...
---
{
    ...
    "actions": [
        {
            ...
            "description": "Contact Cisco support to upgrade Cloud Services Router 1000V image version",
            "actionType": "Document",
    ...
    "tip": "Upgrade Cisco Cloud Services Router 1000V image version to improve network throughput while reducing latency and jitter.",
