...
---
{
    ...
    "version": 1.0,
    "learnMoreLink": "https://docs.microsoft.com/azure/virtual-network/create-vm-accelerated-networking-cli#enable-accelerated-networking-on-existing-vms", // Delete this property because this is a generic notification??? [scottnap] – Recommend leave this in as it is generic guidance.
