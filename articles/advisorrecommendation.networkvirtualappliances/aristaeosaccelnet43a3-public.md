...
---
{
    ...
    "actions": [
        {
            ...
            "description": "Contact Arista Networks support to upgrade vEOS Router image version",
            "actionType": "Document",
    ...
    "tip": "Upgrade Arista Networks vEOS Router image version to improve network throughput while reducing latency and jitter.",
