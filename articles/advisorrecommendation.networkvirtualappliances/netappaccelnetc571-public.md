...
ms.author="nvaeng"
articleId="c571b9b2-fe79-4785-8083-30b7b57a4f3d_public"
...
---
{
    ...
    "actions": [
        {
            ...
            "description": "Contact NetApp support to upgrade Cloud Volumes ONTAP image to 9.7.20200124 or later version.",
            "actionType": "Document",
    ...
    "tip": "Upgrade NetApp Cloud Volumes ONTAP image version to eliminate any unexpected degradation in network performance.",
