...
---
{
    ...
    "actions": [
        {
            ...
            "description": "Contact Palo Alto Networks support to upgrade VM-Series Firewall image version",
            "actionType": "Document",
    ...
    "tip": "Upgrade Palo Alto Networks VM-Series Firewall image version to improve network throughput while reducing latency and jitter.",
