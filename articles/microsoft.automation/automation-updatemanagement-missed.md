...
## **Recommended Steps**
Update Management logs attempts to install updates. [Check the job output](https://docs.microsoft.com/azure/automation/manage-update-multi#view-results-of-an-update-deployment) for errors. 
