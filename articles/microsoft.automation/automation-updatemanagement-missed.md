...
* This error is commonly caused by machines that are turned off at the time of the deployment. It can also be caused by network connectivity or a machine that has changed names. The ["Failed to Start" troubleshooting guide](https://docs.microsoft.com/azure/automation/troubleshoot/update-management#failed-to-start) gives specific steps on how to resolve this issue.
...
* Updates can also be skipped after the maintenance window is exceeded. See ["The scheduled update failed with a MaintenanceWindowExceeded error"](https://docs.microsoft.com/azure/automation/troubleshoot/update-management#mw-exceeded). 
