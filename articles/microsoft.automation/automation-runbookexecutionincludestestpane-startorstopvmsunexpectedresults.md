...
<properties
    ...
    description="Problems related to runbook execution (includes test pane)/start or stop vms: unexpected results"
...
#runbook execution (includes test pane)/start or stop vms: unexpected results
