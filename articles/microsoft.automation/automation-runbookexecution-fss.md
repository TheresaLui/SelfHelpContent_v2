...
Specific problems and their solutions are listed below, but we highly recommend you try these three troubleshooting steps first:

1. Try running the [runbook locally](https://docs.microsoft.com/azure/automation/troubleshoot/runbooks#runbook-fails) before running it in Azure Automation. This can clarify if the issue is a bug in the runbook versus an issue with Azure Automation.
