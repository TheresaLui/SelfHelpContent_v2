...
* Check the [job logs](https://docs.microsoft.com/en-us/azure/automation/manage-update-multi#view-results-of-an-update-deployment) of a deployment to see if updates were filtered out due to classification.
