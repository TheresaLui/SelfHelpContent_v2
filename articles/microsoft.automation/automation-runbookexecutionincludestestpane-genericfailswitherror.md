...
<properties
    pageTitle="runbook execution (includes test pane)/generic: fails with error"
    description="32501545RunbookExecutioninclud"
    service="microsoft.automation"
    resource="automationaccounts"
    authors="adoyle"
    displayorder=""
    selfHelpType="generic"
    supportTopicIds="32501545"
    resourceTags=""
    productPesIds="15607"
    cloudEnvironments="public"
/>

# runbook execution (includes test pane)/generic: fails with error
