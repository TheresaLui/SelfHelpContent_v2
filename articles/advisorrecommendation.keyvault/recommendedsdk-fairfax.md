<properties
    ...
    ms.author="osmuller"
    articleId="89df03c6-017c-4061-bc7e-f33e772339d0_fairfax"
...
---
{
	...
	"dataSourceMetadata": {
		"streamNamespace": "cluster('https://keyvaultff.kusto.usgovcloudapi.net').database('warm').GetAzureAdvisorRecommendedSdkReport",
		"dataSource": "Kusto",
	...
	"owner": {
		...
		"icm": {
			"routingId": "adrocs://Recovery/AzKV_FF",
