...
- If you are unable to block access to your native application, in your access policy, set the **Client app filter** to **Mobile** and **Desktop**. If this is not set, the resulting policy will only apply to browser sessions.

- Validate your sign-n flow by downloading the Azure AD sign-in logs in the JSON file format. If you proceed to open the support case, make sure you include the file with the ticket.
