<properties
    pageTitle="Config setup routing"
    description="Config setup routing"
...
Learn how to forward traffic to Azure Firewall using User Defined Routes:
