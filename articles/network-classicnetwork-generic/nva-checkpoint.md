<properties
	pageTitle="networkvirtualappliance/checkpoint"
	description="networkvirtualappliance/checkpoint"
	...
	supportTopicIds="32632158"
	resourceTags=""
	productPesIds="16679"
	cloudEnvironments="public,mooncake,fairfax,blackforest, usnat, ussec"
	articleId="nva-checkpoint.md"
	ownershipId="CloudNet_NVA"
/>

# networkvirtualappliance/checkpoint
...
* To get help from Check Point, open a support request [here](https://supportcenter.checkpoint.com/supportcenter/portal?eventSubmit_doGoviewsolutiondetails=&solutionid=sk31559)
...
* To understand your NVA’s network bandwidth do the following: 
   ...
   * [Contact the NVA vendor directly](https://supportcenter.checkpoint.com/supportcenter/portal?eventSubmit_doGoviewsolutiondetails=&solutionid=sk31559) for guidance on SKU sizing and bandwidth capabilities
