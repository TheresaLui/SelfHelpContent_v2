<properties
    pageTitle="Secure Hybrid Network connecting Azure VNETs and on-premises"
    description="Secure Hybrid Network connecting Azure VNETs and on-premises"
    service="microsoft.network"
    resource="azurefirewalls"
    authors="v-miegge"
    ms.author="Mario.Liu"
    selfHelpType="generic"
    supportTopicIds="32745451, 32745468"
    resourceTags=""
    productPesIds="16556"
    ownershipId="CloudNet_AzureFirewall"
    cloudEnvironments="public,fairfax,blackforest,mooncake,usnat,ussec"
    articleId="ee8ccbd6-d389-44b0-a55f-73238520fe14"
/>

# Secure Hybrid Network connecting Azure VNETs and on-premises

You can use Azure Firewall to control network access in a hybrid network using rules that define allowed and denied network traffic. Use the below help for securing hybrid network traffic using Azure Firewall.
