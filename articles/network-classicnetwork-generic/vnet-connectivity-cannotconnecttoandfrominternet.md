...
## **Recommended steps**
1. Click [here](data-blade:microsoft_azure_network.NetworkWatcherConnectivityBlade.source.$subscriptionId) to troubleshoot connectivity issues to the internet<br>
