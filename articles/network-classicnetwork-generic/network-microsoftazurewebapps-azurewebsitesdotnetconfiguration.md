...
For more information please review:[Traffic Manager endpoints](https://azure.microsoft.com/en-us/documentation/articles/traffic-manager-endpoint-types/)

## **Recommended documents**
[Controlling Azure Web App with Traffic Manager](https://azure.microsoft.com/documentation/articles/web-sites-traffic-manager/)
