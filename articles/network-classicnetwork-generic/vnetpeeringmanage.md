...
In order to peer across subscriptions, you need certain permissions over subscriptions. The [Peering across subscriptions](https://docs.microsoft.com/azure/virtual-network/virtual-networks-create-vnetpeering-arm-portal#a-namex-subapeering-across-subscriptions) article shows you how this can be done.
