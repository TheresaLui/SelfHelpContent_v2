...
2. Ensure to remove all devices from the virtual network before deleting. The reccomended deletion order is gateway connections, gateways, IPs, VNet Peerings, App Service Environment. Detailed steps can be found on the [Troubleshoor cannot delete VNet article](https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-troubleshoot-cannot-delete-vnet#check-whether-a-virtual-network-gateway-is-running-in-the-virtual-network)<br>
