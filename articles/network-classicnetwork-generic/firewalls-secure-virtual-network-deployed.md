<properties
    pageTitle="Secure Virtual Network deployed in Azure"
    description="Secure Virtual Network deployed in Azure"
    service="microsoft.network"
    resource="azurefirewalls"
    authors="v-miegge"
    ms.author="Mario.Liu"
    selfHelpType="generic"
    supportTopicIds="32745451, 32745472"
    resourceTags=""
    productPesIds="16556"
    ownershipId="CloudNet_AzureFirewall"
    cloudEnvironments="public,fairfax,blackforest,mooncake,usnat,ussec"
    articleId="8167fdb5-ce7c-4b45-a4bf-a9f9351b1488"
/>

# Secure Virtual Network deployed in Azure

Virtual Network traffic is secured by deploying Azure Firewall and configuring routes on subnets to forward traffic to Azure Firewall for inspection. Use the below help to learn more about securing Virtual Network subnets using Azure Firewall.
