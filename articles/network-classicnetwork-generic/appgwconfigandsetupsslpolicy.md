...
[Configure SSL policy and end to end SSL](https://docs.microsoft.com/azure/application-gateway/application-gateway-end-to-end-ssl-powershell) with application gateway using PowerShell<br>
