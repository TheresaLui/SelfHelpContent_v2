...
2. Make sure that your application gateway is running and is healthy according to [Azure Resource Health criteria](https://docs.microsoft.com/azure/application-gateway/resource-health-overview).
