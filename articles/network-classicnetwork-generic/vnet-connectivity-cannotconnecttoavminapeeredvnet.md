...
* Cannot connect to a gateway via VNets that are globally peered? Globally peered VNets do not currenly support gateway transit. Read about [VNet peering and Global VNet Peering constraints](https://docs.microsoft.com/azure/virtual-network/virtual-network-manage-peering#requirements-and-constraints) <br>
* Cannot connect to a load balancer in a globally peered virtual network? This is not currently supported across virtual networks that are globally peered. Read about [VNet peering and Global VNet Peering constraints](https://docs.microsoft.com/azure/virtual-network/virtual-network-manage-peering#requirements-and-constraints) <br>
