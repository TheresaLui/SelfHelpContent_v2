...
* [Configure Azure VPN client](https://docs.microsoft.com/azure/vpn-gateway/openvpn-azure-ad-client) to connect to a Virtual Network using  Point-to-Site VPN and Azure Active Directory authentication<br>
