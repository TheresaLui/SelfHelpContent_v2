<properties
	pageTitle="networkvirtualappliance/fortinet"
	description="networkvirtualappliance/fortinet"
...
* To get help from Fortinet, open a support request [here](https://support.fortinet.com)
...
* To understand your NVA’s network bandwidth do the following: 
   ...
   * [Contact the NVA vendor directly](https://support.fortinet.com) for guidance on SKU sizing and bandwidth capabilities
