...
3. Learn how to create rules with specific source and destination IPs and ports [here](https://docs.microsoft.com/azure/virtual-network/network-security-groups-overview#security-rules).
...
5. Check the [updated list of Service Tag IP ranges](https://docs.microsoft.com/azure/virtual-network/service-tags-overview#discover-service-tags-by-using-downloadable-json-files) to make sure you understand which IP’s you are allowing by using rules with certain Service Tags.

6. Visit this [resource]( https://docs.microsoft.com/azure/virtual-network/diagnose-network-traffic-filter-problem) to diagnose why traffic is being incorrectly blocked or allowed.

7. Visit this [resource]( https://docs.microsoft.com/azure/virtual-network/network-security-group-how-it-works#intra-subnet-traffic) to understand how NSG rules work within subnets.
