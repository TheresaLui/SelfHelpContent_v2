...
Insights from the diagnostics below can help troubleshoot most of the Site-to-Site VPN connectivity issues. If diagnostics don’t detect any issue, the recommended steps and documents are useful assets to help you troubleshoot further.
...
<noResultText>Diagnostic did not detect any issue with your VPN Gateway. Please review additional solutions below.</noResultText> 
...
<executionText>We are running diagnostic on your GatewaySubnet to detect anomalies.</executionText>
<timeoutText>We stopped the check, as it was taking too long.</timeoutText> 
<noResultText>Diagnostic did not detect any issue on your GatewaySubnet. Please review additional solutions below.</noResultText>
<additionalInputsReq>false</additionalInputsReq>
</Insight>
