<properties
    pageTitle="Config diagnostics and logging"
...
* Use [Log Analytics Samples](https://docs.microsoft.com/azure/firewall/log-analytics-samples) to analyze Azure Firewall logs
