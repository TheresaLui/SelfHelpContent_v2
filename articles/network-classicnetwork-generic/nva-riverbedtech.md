<properties
	pageTitle="networkvirtualappliance/riverbedtechnology"
	description="networkvirtualappliance/riverbedtechnology"
...
* To get help from Riverbed Technology, open a support request [here](https://support.riverbed.com)
...
* To understand your NVA’s network bandwidth do the following: 
   ...
   * [Contact the NVA vendor directly](https://support.riverbed.com) for guidance on SKU sizing and bandwidth capabilities
