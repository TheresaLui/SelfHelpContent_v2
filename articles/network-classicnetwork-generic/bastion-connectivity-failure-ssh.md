<properties
    pageTitle="Failure to connect using SSH"
    description="Failure to connect using SSH"
...
1)	You can read product [documentation](https://aka.ms/bastionhost/nsg) on how to manage NSGs in the Bastion deployment.
