<properties
	pageTitle="configuration and setup/how to change bandwidth of an expressroutecircuit"
	description="configuration and setup/how to change bandwidth of an expressroutecircuit "
...
Connect a virtual network to an ExpressRoute circuit using [portal](https://docs.microsoft.com/azure/expressroute/expressroute-howto-linkvnet-portal-resource-manager), [PowerShell](https://docs.microsoft.com/azure/expressroute/expressroute-howto-linkvnet-arm), [Azure CLI](https://docs.microsoft.com/azure/expressroute/howto-linkvnet-cli)
