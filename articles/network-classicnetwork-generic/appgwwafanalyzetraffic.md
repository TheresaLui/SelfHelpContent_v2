<properties
	pageTitle="Analyze Allowed/Blocked Traffic in WAF"
...
You can analyze and identify malicious requests which were detected or blocked by analyzing the WAF logs. Check the document mentioned below for guidance on WAF logging and analysis.
