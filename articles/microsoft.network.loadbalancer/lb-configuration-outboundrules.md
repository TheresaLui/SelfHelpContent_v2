...
* If none of the options suits your scenario, you can consider assigning Public IP to individual virtual machines. But note this will expose the endpoints to the Internet.  
