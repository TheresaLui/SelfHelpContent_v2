...
* To learn more about design guidance for health probes, read more [here](https://docs.microsoft.com/azure/load-balancer/load-balancer-custom-probe-overview#design). 
