<properties
	...
	description="Virtual Machine Size Not Found - Avaiability Zone"
...
<!--issueDescription-->
We detected that the virtual machine **<!--$vmname-->myVM<!--/$vmname-->** is deployed in region **<!--$region-->region<!--/$region-->** using Availability Zone **<!--$zone-->zone<!--/$zone-->**, and the power state of the VM is **<!--$powerstate-->powerstate<!--/$powerstate-->**.<br>
<!--/issueDescription-->
