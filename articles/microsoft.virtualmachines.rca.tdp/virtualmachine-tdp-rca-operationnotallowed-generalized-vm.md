...
There is no way to return the VM that generated this error back to its original state as a functioning virtual machine. If you have the image, or VM, that you used to create the VM that generated this error, you can use it to create an image for creating a new VM. See [How to create an unmanaged VM image from an Azure VM](https://azure.microsoft.com/documentation/articles/virtual-machines-windows-capture-image).
