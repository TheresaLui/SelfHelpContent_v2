<properties
	...
	description="Root cause analysis for 'maximum total regional vCPUs quota limit exceeded' when deploying an existing virtual machine."
	...
	ms.author="v-mibufo"
	displayOrder=""
	articleId="virtualmachine-tdp-gt-rca-max-quota-limit-exceeded-vcpu-existingvm"
