...
<!--issueDescription-->
Based on the analysis of the  deployment of virtual machine **<!--$VMName-->VMName<!--/$VMName-->**, it is recommended that you try deploying a different size or to a different region. Your desired deployment allocation failed with the requested parameters:
<!--/issueDescription-->
