<properties
	...
	ms.author="v-mibufo"
	displayOrder=""
	articleId="virtualmachine-tdp-gt-rca-vm-allocation-failure-asr-existingvm"
...
<!--issueDescription-->
Based on the analysis of the  deployment of virtual machine **<!--$VMName-->VMName<!--/$VMName-->**, we recommend that you try deploying a different size or to a different region. The deployment allocation that you wanted failed with the requested parameters:
<!--/issueDescription-->
