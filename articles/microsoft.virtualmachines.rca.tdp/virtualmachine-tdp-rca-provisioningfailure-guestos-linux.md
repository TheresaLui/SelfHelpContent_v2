...
For more information, see [Create a Windows VM from a specialized disk by using PowerShell](https://azure.microsoft.com/documentation/articles/virtual-machines-windows-create-vm-specialized/).<br>

## Generalize the VM for use as an image

You can use the failed VM as a specialized data VHD to create a new VM. For more information, see [How to create an image of a virtual machine or VHD](https://docs.microsoft.com/azure/virtual-machines/linux/capture-image).<br>
