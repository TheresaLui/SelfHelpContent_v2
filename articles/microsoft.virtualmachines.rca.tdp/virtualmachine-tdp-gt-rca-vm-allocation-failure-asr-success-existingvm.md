...
<!--issueDescription-->
The current specification for virtual machine **<!--$VMName-->VMName<!--/$VMName-->** has a **high** chance of allocation success. You should expect see successful deployment allocation for your specified deployment.
