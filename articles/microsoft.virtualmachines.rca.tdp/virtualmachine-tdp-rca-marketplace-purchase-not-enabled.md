...
1. Sign in to the [Microsoft Azure Enterprise Portal](https://ea.azure.com/).<br>
1. Select **Manage** on the left navigation.<br>
1. Select the **EnrollmentTab**.<br>
1. View the **Enrollment Detail** section.<br>
