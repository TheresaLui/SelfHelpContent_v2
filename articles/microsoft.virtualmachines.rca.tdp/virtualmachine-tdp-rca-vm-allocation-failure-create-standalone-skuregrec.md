...
Please try creating the VM again as the issue might have been temporary and there now could be sufficient resources for the allocation. If that doesn't work, consider choosing another VM size that has been provided in the table above for your region or another region.<br>

* Review and use one of the suggested sizes and region pairs provided in the table above.<br>
* Browse virtual machine sizes  by region, choose `virtual machines` in an interactive query that Azure provides [here](https://azure.microsoft.com/global-infrastructure/services/?products=virtual-machines).
