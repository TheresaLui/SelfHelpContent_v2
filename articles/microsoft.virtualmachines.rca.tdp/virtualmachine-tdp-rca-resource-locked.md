...
<!--issueDescription-->
We detected that the attempt to delete **<!--$vmname-->Virtual machine<!--/$vmname-->** initiated at **<!--$StartTime-->StartTime<!--/$StartTime--> (UTC)** failed because the resource is locked.<br>
<!--/issueDescription-->
