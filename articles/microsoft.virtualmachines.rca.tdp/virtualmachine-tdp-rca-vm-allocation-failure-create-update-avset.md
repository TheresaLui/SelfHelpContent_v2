<properties
	...
	ms.author="scotro"
	displayOrder=""
	articleId="OperationFailure_RCA-create-update-avset"
...
- Resize the VM to a size that is currently available in your availability set. If you are using an older VM product, consider newer versions. See [Resize a Windows VM in an avilability set](https://docs.microsoft.com/azure/virtual-machines/windows/resize-vm#resize-a-windows-vm-in-an-availability-set)<br>
