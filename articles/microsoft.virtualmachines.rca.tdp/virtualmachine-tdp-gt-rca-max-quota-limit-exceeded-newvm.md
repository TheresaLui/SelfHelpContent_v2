...
<properties
	...
	description="Root cause analysis for 'maximum quota limit exceeded' when deploying a new virtual machine."
	...
	ms.author="v-mibufo"
	displayOrder=""
	articleId="virtualmachine-tdp-gt-rca-max-quota-limit-exceeded-newvm"
...
<!--issueDescription-->
We have detected that the deployment of virtual machine size **<!--$VMSize-->VM Size<!--/$VMSize-->** in region **<!--$Region-->Region<!--/$Region-->** failed due to the virtual CPU quota being exceeded for the requested resource.
<!--/issueDescription-->
