...
To search and browse the virtual machines by region, choose `virtual machines` in the interactive [Products by region](https://azure.microsoft.com/global-infrastructure/services/?products=virtual-machines) query. You can also determine specific SKUs by region with the [Azure CLI](https://docs.microsoft.com/azure/azure-resource-manager/resource-manager-sku-not-available-errors#solution-2---azure-cli).
