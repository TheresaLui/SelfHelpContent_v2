<properties
	...
	description="Root cause analysis for 'SKU not available' when deploying a new virtual machine in an availability zone."
	...
	ms.author="v-mibufo"
	displayOrder=""
	articleId="virtualmachine-tdp-gt-rca-over-skunotavailable-newvm-avzone"
...
The SKU restriction prevented deployment in availability zone **<!--$AvZone-->Availability Zone<!--/$AvZone-->**.
<!--/issueDescription-->
