...
<!--issueDescription-->
We have detected that the deployment of VM size **<!--$VMSize-->VM Size<!--/$VMSize-->** in region **<!--$Region-->Region<!--/$Region-->** failed because of a **<!--$RestrictionType-->Restriction Type<!--/$RestrictionType-->** restriction on the SKU that you are trying to deploy.<br>
