<properties
	...
	description="Root cause analysis for 'SKU not available' when deploying an existing virtual machine."
	...
	ms.author="v-mibufo"
	displayOrder=""
	articleId="virtualmachine-tdp-gt-rca-skunotavailable-existingvm"
...
<!--issueDescription-->
We have detected that the deployment of VM size **<!--$VMSize-->VM Size<!--/$VMSize-->** in region **<!--$Region-->Region<!--/$Region-->** failed because of a **<!--$RestrictionType-->Restriction Type<!--/$RestrictionType-->** restriction on the SKU you are trying to deploy.<br>

The SKU restriction prevented virtual machine **<!--$vmname-->Virtual machine<!--/$vmname-->** from deploying in availability zone **<!--$AvZone-->Availability Zone<!--/$AvZone-->**.
<!--/issueDescription-->
...
Determine sizes available for your subscription using these methods:
