...
* [Deploy multiple number of Firewall rules, Virtual Network rules, server parameters or databases in server](https://github.com/Azure/azure-mariadb/tree/master/arm-templates/ExampleWithMultipleServerProperties)<br>
