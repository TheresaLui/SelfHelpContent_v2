...
* To familiarize yourself with using ARM templates to create databases in Azure Database for MariaDB server, refer to [this sample template](https://github.com/Azure/azure-mariadb/tree/master/arm-templates)
