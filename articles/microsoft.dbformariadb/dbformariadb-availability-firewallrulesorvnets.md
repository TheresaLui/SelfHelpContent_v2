...
* [Configure a Private link using Azure CLI](https://docs.microsoft.com/azure/mariadb/howto-configure-privatelink-cli/)<br>
* [Configure a Private link using Portal](https://docs.microsoft.com/azure/mariadb/howto-configure-privatelink-portal/)<br>
