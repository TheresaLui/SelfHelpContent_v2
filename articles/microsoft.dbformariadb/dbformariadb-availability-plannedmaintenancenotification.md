...
* You can receive alert for upcoming planned maintenance using:
  ...
  * Using alerts: You can configure alerts for an upcoming planned maintenance event. Refer to [how can I get notified of planned maintenance](https://docs.microsoft.com/azure/mariadb/concepts-planned-maintenance-notification#how-can-i-get-notified-of-planned-maintenance) to configure alerts.
...
* A planned maintenance for a given Azure region is typically expected to run 15 hrs. Azure Database for MariaDB are running in containers so database server restarts are typically quick, expected to complete typically in 60-120 seconds.
