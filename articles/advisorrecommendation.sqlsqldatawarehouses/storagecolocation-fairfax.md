...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazureusg.kusto.usgovcloudapi.net').database('FairFax').dw_trains | take 0 | project SubscriptionId = '', ResourceId = '', Version = 1.0, ExtendedProperties = '{}' //No XStore telemetry access",
    "dataSource": "Kusto",
