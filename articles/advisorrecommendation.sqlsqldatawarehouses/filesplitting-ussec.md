<properties
    ...
    authors="kevin"
    ms.author="kevin"
    articleId="dd93fbbf-e5ef-4c7c-886e-2bfef0958f45_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazureussece.kusto.core.microsoft.scloud').database('sqlazure1').dw_advisor_Load_FileSplits",
    "dataSource": "Kusto",
