<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="9d7196d1-2d7c-4316-820f-7374a4ddf250_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazureussece.kusto.core.microsoft.scloud').database('sqlazure1').dw_advisor_DataSkew",
    "schemaVersion": 2.0,
    "dataSource": "Kusto",
