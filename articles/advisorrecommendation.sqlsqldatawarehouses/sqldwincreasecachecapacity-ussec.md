<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="14b28bdb-b83d-4f55-a516-44d4152f1f2b_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazureussece.kusto.core.microsoft.scloud').database('sqlazure1').dw_advisor_IncreaseCacheCapacity",
    "schemaVersion": 2.0,
    "dataSource": "Kusto",
