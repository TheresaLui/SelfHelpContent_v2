<properties
    ...
    authors="kevin"
    ms.author="kevin"
    articleId="e0ba1234-61da-46e3-a66d-fa0752b9df7d_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazureussece.kusto.core.microsoft.scloud').database('sqlazure1').dw_advisor_Load_BatchSize",
    "dataSource": "Kusto",
