<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="33e515fe-354c-4016-a0f7-c4d6585aea61_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazurechi2.chinanorth2.kusto.chinacloudapi.cn').database('MoonCake').dw_advisor_TempdbContention",
    "schemaVersion": 2.0,
    "dataSource": "Kusto",
