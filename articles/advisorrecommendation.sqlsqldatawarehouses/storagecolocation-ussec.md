...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazureussece.kusto.core.microsoft.scloud').database('sqlazure1').dw_trains | take 0 | project SubscriptionId = '', ResourceId = '', Version = 1.0, ExtendedProperties = '{}' //No XStore telemetry access",
    "dataSource": "Kusto",
