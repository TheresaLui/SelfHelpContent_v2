<properties
    ...
    authors="kevin"
    ms.author="kevin"
    articleId="e0ba1234-61da-46e3-a66d-fa0752b9df7d_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazureusnate.usnateast.kusto.core.eaglex.ic.gov').database('sqlazure1').dw_advisor_Load_BatchSize",
    "dataSource": "Kusto",
