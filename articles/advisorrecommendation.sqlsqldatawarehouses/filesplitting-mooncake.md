<properties
    ...
    authors="kevin"
    ms.author="kevin"
    articleId="dd93fbbf-e5ef-4c7c-886e-2bfef0958f45_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazurechi2.chinanorth2.kusto.chinacloudapi.cn').database('MoonCake').dw_advisor_Load_FileSplits",
    "dataSource": "Kusto",
