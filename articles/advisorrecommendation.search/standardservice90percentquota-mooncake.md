<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="b5a98691-da25-4fc3-a4f4-f9f0d35a42c6_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 2.0,
    "streamNamespace": "cluster('https://azsearchmooncake.chinaeast2.kusto.chinacloudapi.cn').database('AzureSearch').GetStandardServicesOver90PercentSizeQuota",
    "dataSource": "Kusto",
