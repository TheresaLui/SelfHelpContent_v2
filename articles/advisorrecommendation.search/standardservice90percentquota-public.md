<properties
    pageTitle="You are close to exceeding your available storage quota. Increase your number of partitions if you need more storage."
...
---
{
  ...
  "description": "You are close to exceeding your available storage quota. Increase your number of partitions if you need more storage.",
  "longDescription": "You are close to exceeding your available storage quota. Increase your number of partitions if you need more storage. After exceeding storage quota, indexing operations will stop working.",
  "potentialBenefits": "Able to index to handle more data",
  "actions": [
    {
  ...
  "displayLabel": "You are close to exceeding your available storage quota. Increase your number of partitions if you need more storage.",
  "additionalColumns": []
}
---