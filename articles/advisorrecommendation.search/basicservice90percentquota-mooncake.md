<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="97b38421-f88c-4db0-b397-b2d81eff6630_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 2.0,
    "streamNamespace": "cluster('https://azsearchmooncake.chinaeast2.kusto.chinacloudapi.cn').database('AzureSearch').GetBasicServicesOver90PercentSizeQuota",
    "dataSource": "Kusto",
