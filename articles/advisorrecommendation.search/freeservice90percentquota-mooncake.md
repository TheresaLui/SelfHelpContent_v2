<properties
    ...
    authors="aadevteam"
    ms.author="aadevteam"
    articleId="8d31f25f-31a9-4267-b817-20ee44f88069_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 2.0,
    "streamNamespace": "cluster('https://azsearchmooncake.chinaeast2.kusto.chinacloudapi.cn').database('AzureSearch').GetFreeServicesOver90PercentSizeQuota",
    "dataSource": "Kusto",
