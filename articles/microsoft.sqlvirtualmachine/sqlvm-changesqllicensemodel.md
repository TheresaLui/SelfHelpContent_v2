...
**Switch your SQL license**: The ability to switch between licensing models is a feature provided by the [new SQL VM resource provider](https://docs.microsoft.com/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-ahb).<br>
