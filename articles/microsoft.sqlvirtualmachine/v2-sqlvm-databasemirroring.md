<properties
	...
	description="AlwaysOn, High Availability, Disaster Recovery -Database Mirroring"
...
Most users are able to resolve their Database Mirroring issues using the recommended documents below.
