<properties
	...
	description="AlwaysOn, High Availability, Disaster Recovery/Log shipping"
...
Most users are able to resolve their issues with SQL Server Log shipping using the recommended documents below.
