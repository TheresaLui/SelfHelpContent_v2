...
To deploy SQL Server inside an Azure Virtual Machine (VM), follow the instructions in [Provision SQL Server using Azure Portal](https://docs.microsoft.com/azure/virtual-machines/windows/sql/virtual-machines-windows-portal-sql-server-provision) guide.
...
* **Changing the default drive for SQL installation**
  
  If you're deploying any SQL Server Marketplace image, you cannot change the installation directory during provisioning. By default, the binaries are installed in the C drive. To install SQL binaries/installation on a different drive: <br>
