...
* Registering with SQL IaaS Extension will enable enhanced monitoring and management, flexible license and edition conversions, and asset discovery benefits with no impact on existing resources  
...
* If you do not see a SQL Virtual machine resource, you can register the [SQL IaaS Extension](https://docs.microsoft.com/azure/azure-sql/virtual-machines/windows/sql-agent-extension-manually-register-single-vm?WT.mc_id=Portal-Microsoft_Azure_Support&tabs=bash%2Cazure-cli) 
...
* Storage Configuration or Extending drives from SQL Virtual Machine resource may be grayed out if you've customized your storage pool 
