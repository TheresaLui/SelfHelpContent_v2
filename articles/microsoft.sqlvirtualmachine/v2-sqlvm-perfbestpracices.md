<properties
	pageTitle="Performance/SQL Server Performance Best Practices"
	description="Performance/SQL Server Performance Best Practices"
...
/>
# Performance/SQL Server Performance Best Practices
...
* You may also [download PerfInsights](https://www.microsoft.com/download/details.aspx?id=54915&fa43d42b-25b5-4a42-fe9b-1634f450f5ee=True) and run it on your virtual machine
* To ensure a speedy resolution, please **provide us the PerfInsights logs** if you create a support case. See [How to use PerfInsights](https://docs.microsoft.com/azure/virtual-machines/troubleshooting/how-to-use-perfinsights).
