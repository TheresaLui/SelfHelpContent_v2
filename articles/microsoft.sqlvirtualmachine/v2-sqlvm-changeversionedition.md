...
To change **licensing model** of SQL Server on Azure VM from Pay As you Go to Bring your own license or Azure Hybrid benefit please follow article
...
To get SQL Server **installation media**, please follow these steps - <br>
