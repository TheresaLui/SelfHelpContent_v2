...
If you're having problems configuring single sign-on to your application, the following articles can help resolve most of your issues.
...
* [I can sign in to my application, but I get an error on the application sign-in page](https://docs.microsoft.com/azure/active-directory/manage-apps/application-sign-in-problem-application-error?WT.mc_id=UI_AAD_Apps_Sign_In_Support_L2_Gallery)
...
The following video talks about the Delegated and Application permissions required to access application data through Microsoft Graph and how to add them via consent process.
