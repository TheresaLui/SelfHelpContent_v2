...
## **Recommended Steps**
To resolve Network Security Group (NSG) issues, work through the following steps. Note that, NSGs, by default, deny connections from the Internet unless they are explicitly allowed. 
