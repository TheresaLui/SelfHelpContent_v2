...
* Select your subscription from the [Subscriptions page](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade) in Azure portal as [a user with access to invoices](https://docs.microsoft.com/azure/billing/billing-manage-access). Select **Invoices**
...
Could be since the subscription is disabled due to outstanding charges. Please make sure to login as an admin to settle the payments before [re-activating the subscription](https://docs.microsoft.com/azure/billing/billing-subscription-become-disable)<br>
