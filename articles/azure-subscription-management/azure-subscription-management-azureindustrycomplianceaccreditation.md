...
* **FedRamp Certification**: For any FedRamp certification, please refer: [FedRamp Marketplace](https://marketplace.fedramp.gov/#/products?sort=productName)<br>
...
* **GDPR Compliance**: If you have questions about Data Processing Agreement, please review the Data Protection Terms starting on Page 7 in the [Online Services Terms](https://aka.ms/online-services-terms)(OST). The OST includes the primary data processing terms but is incorporated into the standard commercial contract. Among other things, it provides with a contractual commitment regarding our GDPR obligations.<br>
Additionally, please review the GDPR specific terms at the end of the contract in Attachment 4 starting on Page 42. These sections cover Microsoft’s GDPR obligations as a data processor as well as sub-processor to another data processor.<br>
...
**Note**: Online Services customer data and personal data list notification is fully automated. For more information, see Microsoft’s [Data Protection Resources](https://servicetrust.microsoft.com/Documents/TrustDocuments)<br>
