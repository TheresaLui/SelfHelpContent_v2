<properties
	pageTitle="purchase,signup or upgrade - unable to convert subscription"
	description="purchase,signup or upgrade - unable to convert subscription"
...
You may experience an issue when you try to sign up for a new account in the Microsoft Azure portal or Azure account center. Before you troubleshoot the issue, first consider the following suggestions:
   ...
   * Could be since the subscription is disabled due to outstanding charges. Please make sure to login as an admin to settle the payments <br>
   
[Microsoft Azure Offer details](https://azure.microsoft.com/support/legal/offer-details/)<br>

**Activate Pay-as-you-go**: Click [Purchase-Pay-As-You-Go](https://azure.microsoft.com/offers/ms-azr-0003p/) and select **Purchase now** to activate the Pay-As-You-Go subscription. For free support, select the option with **No technical support** and click **Next**.<br>
	
**Activate Azure Sponsorship**: Click [Purchase-Azure Sponsorship Offer](https://azure.microsoft.com/offers/ms-azr-0036p/) and select **Purchase now** to activate the subscription.<br>
...
If your internet browser page hangs, try each of the following steps until you can get to the Azure portal
   ...
   * Refresh the page. Use a different internet browser
...
This issue can occur if you use more than one user account in an internet browser<br>
