...
* All resources like Virtual Machines, disks, and websites transfer to the new account successfully. The resources below under **Azure AD Domain Services** could be affected in a cross-tenant subscription transfer.

Learn more about [transferring billing ownership for an Azure subscription](https://docs.microsoft.com/azure/cost-management-billing/understand/subscription-transfer)
