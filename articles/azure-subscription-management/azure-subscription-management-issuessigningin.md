<properties
	pageTitle="Resolve issues signing in or accessing your Azure subscriptions"
	description="Resolve issues signing in or accessing your Azure subscriptions"
...
To manage access to Azure resources, you must have the appropriate [administrator role](https://docs.microsoft.com/azure/billing/billing-add-change-azure-subscription-administrator).
