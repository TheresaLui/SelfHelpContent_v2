...
As a [Pay-As-You-Go](https://azure.microsoft.com/offers/ms-azr-0003p/) customer, you can switch your Azure subscription to another offer in the [Account Center](https://account.windowsazure.com/Subscriptions)<br>

**Switch a Subscription Offer**<br>
  ...
  2. Select your Pay-As-You-Go subscription.<br>
  3. Click **Switch to another offer**.<br>
  ...
  5. By default, the new subscription is set it to the new offer name. You could rename it. Click **Switch Offer** to complete the process.<br>
...
You might not see the **Switch to another offer** button due to:<br>
  ...
  * If you're on [Free Trial](https://azure.microsoft.com/free/), learn how to [upgrade to Pay-As-You-Go](https://docs.microsoft.com/azure/billing/billing-upgrade-azure-subscription).<br>
  * You're still on your first billing period; you must wait for your first billing period to end before you can switch offers.<br>
...
Learn more on how to move resources within an existing Azure offering : [Move resources to a new resource group or subscription](Move resources to a new resource group or subscription)<br>
