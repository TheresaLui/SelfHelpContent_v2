<properties
	articleId="5e4c7f48-7e03-4045-99ae-540c112b1cef"
	...
	supportTopicIds="32636467, 32636465, 32636464"
	productPesIds="15078"
	cloudEnvironments="public, Fairfax, usnat, ussec"
	schemaVersion="1"
	ownershipId="AzureData_HDInsight"
/>
# Interactive Query Issue
---
{
    "resourceRequired": true,
    "subscriptionRequired": true,
    "title": "HDInsight Interactive Query Issue",
    "fileAttachmentHint": "Please attach YARN Application log, HiveServer2Interactive log, and client application output (if applicable) to help us triage your problem faster",
    "formElements": [
        {
        ...
        },
        {
            ...
            "order": 150,
            "controlType": "textbox",
            "displayLabel": "YARN Application ID for the Interactive Query job if known",
            "required": false
        },
        {
            ...
            "watermarkText": "Interactive query",
            "required": true
        },
        {
            ...
            "order": 300,
            "controlType": "multilinetextbox",
            "displayLabel": "Interactive query explain plan if available",
