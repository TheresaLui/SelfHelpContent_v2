<properties
	articleId="9a731dbe-b546-4c6f-8abd-f80dfbb4609d"
	pageTitle="Scoping Questions for HDInsight ODBC JDBC Issue"
	description="Scoping Questions for HDInsight ODBC JDBC Issue"
...
---
{
    ...
    "title": "HDInsight ODBC JDBC Issue",
    "fileAttachmentHint": "Please attach client application output (if applicable) to help us triage your problem faster",
    "formElements": [
        {
