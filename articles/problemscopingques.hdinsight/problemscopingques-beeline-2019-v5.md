<properties
	articleId="61915a9c-51dd-4001-b8f0-5e93bf22f33e"
	pageTitle="Scoping Questions for HDInsight Beeline Issue"
	description="Scoping Questions for HDInsight Beeline Issue"
...
---
{
    ...
    "title": "HDInsight Beeline Issue",
    "fileAttachmentHint": "Please attach output of the beeline command with DEBUG log turned on, to help us triage your problem faster",
    "formElements": [
        {
        ...
        },
        {
            ...
            "order": 5,
            "controlType": "textbox",
            "displayLabel": "Connection string used",
            "watermarkText": "Connection string",
            "required": true
        },
        {
            "id": "is_new_problem",
