...
---
{
    ...
    "fileAttachmentHint": "Please attach YARN Application log, HiveServer2 log, Hive client log, Client ODBC log (if applicable), some sample data (if applicable) to help us triage your problem faster",
    "formElements": [
        {
