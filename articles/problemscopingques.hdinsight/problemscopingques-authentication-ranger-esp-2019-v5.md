<properties
	articleId="ad9e7bf6-4a76-4a50-a6fe-bb4b46cb8fce"
	pageTitle="Scoping Questions for HDInsight Authentication with Ranger in ESP Issue"
	description="Scoping Questions for HDInsight Authentication with Ranger in ESP Issue"
	authors="shravanmn, csunilkumar, lisaliu"
	ms.author="shravan, sunilkc, lisaliu"
	selfHelpType="problemScopingQuestions"
	supportTopicIds="32636489"
	productPesIds="15078"
	cloudEnvironments="public, Fairfax"
	schemaVersion="1"
	ownershipId="AzureData_HDInsight"
/>
# HDInsight Authentication with Ranger in ESP Issue
---
{
    "resourceRequired": true,
    "subscriptionRequired": true,
    "title": "HDInsight HDFS Authentication with Ranger in ESP Issue",
    "fileAttachmentHint": "",
    "formElements": [
        {
        ...
        },
        {
            ...
            "order": 350,
            "controlType": "dropdown",
            "displayLabel": "Can you log in to Ranger using the cluster local admin credential?",
            "watermarkText": "Choose an option",
            "dropdownOptions": [
                {
                    "value": "Yes",
