...
<!--issueDescription-->
Our diagnostics show there were several instances where the VM disk <!--$throttlingCounter-->Counter<!--/$throttlingCounter--> on this VM exceeded the VM's limit (<!--$vmLimit-->limit<!--/$vmLimit-->) in the last hour.
<!--/issueDescription-->
