...
* [Create a new Analysis Services firewall config](https://docs.microsoft.com/powershell/module/az.analysisservices/new-azanalysisservicesfirewallconfig?view=azps-5.4.0)