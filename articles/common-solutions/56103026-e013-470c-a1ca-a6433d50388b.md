<properties
  pagetitle="SQL Managed Instance Azure Arc security."
  service="microsoft.azuredata"
  resource="sqlmanagedinstances"
  ms.author="jopilov"
  selfhelptype="Generic"
  supporttopicids="32743950,32743951,32743952,32743971,32743998,32744016"
  productpesids="17125"
  cloudenvironments="public, fairfax, mooncake, blackforest, ussec, usnat"
  articleid="56103026-e013-470c-a1ca-a6433d50388b"
  ownershipid="AzureData_Managed_Instance_Azure_Arc" />
# SQL Managed Instance Azure Arc security.
...
> [!NOTE]  
> [TLS-encrypted connections](https://docs.microsoft.com/sql/database-engine/configure-windows/enable-encrypted-connections-to-the-database-engine) of data over the wire is not currently supported in Managed Instance Azure Arc