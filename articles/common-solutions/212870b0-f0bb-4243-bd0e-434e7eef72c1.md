...
1.	Make sure you configured your rule according to our [Create incidents from alerts documentation](https://docs.microsoft.com/azure/sentinel/create-incidents-from-alerts)
