...
3. To monitor [Data collection Health](https://docs.microsoft.com/azure/sentinel/monitor-data-connector-health):<br>
   a. Go to the **Agent Info** tab<br>
   ...
   c. Search your required machine in the **Machine name** filter
