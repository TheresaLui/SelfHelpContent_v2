...
3. To monitor [Data collection Health](https://docs.microsoft.com/azure/sentinel/monitor-data-connector-health), go to the **Agent Info** tab, select one of the following:
   1.  To view only the Azure Arc-managed machines, select the **Azure-managed machines** tab; 
   2.  To view both managed and non-Azure machines with the Log Analytics agent installed, select the **All machines** tab.<br>
...
5. CEF based connector:
   ...
   2. You must have python 2.7 or 3 installed on the Linux machine.
