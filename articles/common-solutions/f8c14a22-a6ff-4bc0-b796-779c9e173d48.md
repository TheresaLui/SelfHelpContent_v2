...
3. To monitor [Data collection Health](https://docs.microsoft.com/azure/sentinel/monitor-data-connector-health), go to the **Agent Info** tab, select one of the following, and then search your required machine in the **Machine name** filter:
