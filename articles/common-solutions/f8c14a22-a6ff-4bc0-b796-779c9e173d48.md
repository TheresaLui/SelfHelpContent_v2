...
5. **CEF based connector**:
   - [Supported OS list](https://docs.microsoft.com/azure/sentinel/connect-common-event-format#prerequisites)
   -  You must have elevated permissions (sudo) on your designated Linux machine
   -  You must have python 2.7 or 3 installed on the Linux machine. Use the python `-version` command to check.
   -  You must have elevated permissions (sudo) on your designated Linux machine
   ...
   -  To validate connectivity, use the [troubleshooting script](https://docs.microsoft.com/azure/sentinel/connect-cef-verify?tabs=rsyslog)
