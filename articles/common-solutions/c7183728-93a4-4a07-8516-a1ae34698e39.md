...
Azure Front Door (AFD) Rules Engine allows you to dynamically modify your AFD routing rules based on match conditions of the incoming request Learn how to configure route rule overrides by reviewing the following documents. 
