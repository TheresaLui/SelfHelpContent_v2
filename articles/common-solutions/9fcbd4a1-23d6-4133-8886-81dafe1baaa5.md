...
- **Storage Accounts**
    1. Storage account is in a private network
        ...
        - Create Azure IR in a specific region different from the Storage account and Whitelist Azure IR IPs for that region in the storage account. It is better to use a service Tag for the specific region, because the IP Ranges may change. Refer to the article [here](https://docs.microsoft.com/azure/data-factory/azure-integration-runtime-ip-addresses) for IP address and setup information.
