...
3. Performance issues while writing data in the sink
    ...
    **_Recommendations_**:
    ...
    2. If you choose custom partitioning, refer to the performance tuning guide [here](https://docs.microsoft.com/azure/data-factory/concepts-data-flow-performance)
