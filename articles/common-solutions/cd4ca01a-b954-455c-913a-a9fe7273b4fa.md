...
*  I received an invitation, but I’m having issues accessing the organization and/or project<br>
    ...
    *   Sign out of your browser: Select the [Visual Studio sign out link](https://app.vssps.visualstudio.com/_signout) and then wait until the sign-out process completes
    ...
    *   Review [the guide for troubleshooting connectivity issues](https://docs.microsoft.com/azure/devops/user-guide/troubleshoot-connection?view=azure-devops)
