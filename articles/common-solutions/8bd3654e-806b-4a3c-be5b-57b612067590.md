...
2.	Validate the entity mapping configuration is according to [analytics rules documentation](https://docs.microsoft.com/azure/sentinel/tutorial-detect-threats-custom).
