...
2. If you are receiving an ENDPOINT_NOT_FOUND or are experiencing any other connectivity issue, verify that agent service is running:
    *[Troubleshooting unavailable VMs](https://docs.microsoft.com/azure/virtual-desktop/troubleshoot-agent#error-endpoint_not_found)