...
To enable alerts for a particular virtual machine, or for a particular monitor on a virtual machine, use **Alert status** in the configuration setting for the virtual machine in the Azure portal. For details, see [Configure monitoring in Azure Monitor for VMs guest health (preview)](https://docs.microsoft.com/azure/azure-monitor/insights/vminsights-health-configure). Review [Configure monitoring in Azure Monitor for VMs guest health using data collection rules (preview)](https://docs.microsoft.com/azure/azure-monitor/insights/vminsights-health-configure-dcr) for details on configuring monitors across a set of virtual machines.
