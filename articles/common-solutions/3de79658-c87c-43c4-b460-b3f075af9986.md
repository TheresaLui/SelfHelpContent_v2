...
Yes, it is possible. Please find the below details: 
* If the destination subscription exists within the same Azure active directory tenant. Open AAD  tenant -> All resources -> Select Azure B2C tenant -> Click on Move -> Move to another subscription. 
