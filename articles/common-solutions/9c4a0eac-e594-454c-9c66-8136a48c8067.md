...
- **Most Listener connectivity or Load Balancer issues can be resolved with the following steps**
  ...
  * Figure out the **Variables** by using the following chart and ensure that you have [run PowerShell](https://docs.microsoft.com/azure/virtual-machines/windows/sql/virtual-machines-windows-portal-sql-availability-group-tutorial#configure-listener).
...
* **To avoid issues with Listener Connectivity**
   ...
   * Make sure the SQL instance is running on **[Static Port](https://docs.microsoft.com/sql/database-engine/configure-windows/configure-a-server-to-listen-on-a-specific-tcp-port?view=sql-server-ver15)**.
