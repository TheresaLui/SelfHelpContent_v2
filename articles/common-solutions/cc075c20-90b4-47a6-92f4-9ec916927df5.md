...
3.	Enable the compute role on the device. This creates a virtual switch on the enabled port. When IOT Edge is enabled, A Kubernetes cluster is created on the device. Your IOT module is deployed on top of the k8s cluster.   
