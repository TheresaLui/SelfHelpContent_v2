...
Azure AD B2C supports granular password complexity policies, in addition to the defaults that are supported in Azure AD. [See these steps to configure complexity requirements for passwords in Azure Active Directory B2C](https://docs.microsoft.com/azure/active-directory-b2c/password-complexity?pivots=b2c-custom-policy).
