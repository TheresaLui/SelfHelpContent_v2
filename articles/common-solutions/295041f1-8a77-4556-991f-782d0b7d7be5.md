...
To troubleshoot the sign-in issues, we recommend referring to [Troubleshooting guide for problems signing in to SAML based single sign on configured apps](https://docs.microsoft.com/azure/active-directory/manage-apps/application-sign-in-problem-federated-sso-gallery?WT.mc_id=UI_AAD_Apps_Sign_In_Support_L2_Gallery). For more information on AADSTS error codes returned from Azure AD security token service (STS), please read [Azure AD Authentication and Authorization Error codes](https://docs.microsoft.com/azure/active-directory/develop/reference-aadsts-error-codes?WT.mc_id=Portal-Microsoft_Azure_Support). 
To solve problems while configuring an application for SAML based SSO, check out [Troubleshoot SAML based single sign-on in Azure AD](https://docs.microsoft.com/azure/active-directory/manage-apps/troubleshoot-saml-based-sso?WT.mc_id=UI_AAD_Enterprise_Apps_Support_L2_Overview). For information on implementing HTTP Redirect binding (for application to send SAML request encoded in the location header), please refer [SAML protocol specification document](https://docs.oasis-open.org/security/saml/v2.0/saml-bindings-2.0-os.pdf).
...
* Solve common SAML SSO problems by referring [Redirect URI (Reply URL) restrictions](https://docs.microsoft.com/azure/active-directory/develop/reply-url)
