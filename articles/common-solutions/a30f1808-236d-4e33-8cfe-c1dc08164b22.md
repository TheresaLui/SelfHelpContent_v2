...
On the Windows Server client connected to your Data Box Gateway, connect to an SMB share by entering the commands:
...
4. In the **Run** window, specify the `\\<device IP address>` and select **OK**.  The shares you created appear in File Explorer as folders. Double-click a share (folder) to view the content.
