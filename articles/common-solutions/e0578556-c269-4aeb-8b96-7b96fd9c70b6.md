...
3. Perform the registration by running the following command (where *ComputerName Server* is the name of any server in the cluster). To get your Azure subscription ID, go to **portal.azure.com** > **Subscriptions**, and copy your ID from the list.<br>
