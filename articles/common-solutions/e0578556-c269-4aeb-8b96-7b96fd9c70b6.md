...
3. Perform the registration using the name of any server in the cluster. To get your Azure subscription ID, go to **portal.azure.com** > **Subscriptions**, and copy your ID from the list.
