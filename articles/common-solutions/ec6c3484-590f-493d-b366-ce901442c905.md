...
2. See if running connection diagnostics on the device reveal anything: [IoT Hub connection diagnostics tool](https://github.com/Azure/iothub-diagnostics)
...
4. Please make sure to collect logs so we can better help you diagnose the issue.
