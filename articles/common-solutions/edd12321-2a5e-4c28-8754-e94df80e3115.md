...
* Microsoft Cloud App Security (MCAS) supports malware detection for the following apps: Box, Dropbox, G-Suite, Office 365. (Office 365 requires a valid license for Microsoft Defender for Office 365 P1.)

* Malware detection is a built-in policy and is disabled, by default. To enable malware detection, go to the policy page in the Azure portal.
