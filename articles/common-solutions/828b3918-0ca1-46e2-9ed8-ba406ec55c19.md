...
Azure Front Door Rules Engine allows you to configure header actions and route overrides on specific URL paths. Learn how to configure these overrides by reviewing the following documents. 
