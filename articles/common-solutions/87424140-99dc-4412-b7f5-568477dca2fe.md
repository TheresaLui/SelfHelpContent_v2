...
Data residency refers to where user data is stored. See a [List of available regions](https://docs.microsoft.com//azure/active-directory-b2c/data-residency#data-residency). 
