...
*  For details about the visually authoring experience, please review  [Visual authoring](https://docs.microsoft.com/azure/data-factory/author-visually).
* To learn about iterative development debugging in ADF, please review [Iterative Development and Debugging](https://docs.microsoft.com/azure/data-factory/iterative-development-debugging)

* To learn how to manage pipeline artifacts in ADF, please review  [ADF Management](https://docs.microsoft.com/azure/data-factory/author-management-hub)
* For details about source control in ADF, please review [Source Control](https://docs.microsoft.com/azure/data-factory/source-control)
* For publishing pipelines, please review [ADF Publishing](https://docs.microsoft.com/azure/data-factory/continuous-integration-deployment-improvements)

* For creating ADF pipelines using ARM(Azure Resource Manager) templates, please review [ADF using ARM](https://docs.microsoft.com/azure/data-factory/quickstart-create-data-factory-dot-net)
...
If you are new to ADF, please review following documents.
