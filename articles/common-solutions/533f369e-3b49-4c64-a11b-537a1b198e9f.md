...
You can choose whether you want to be notified by email, SMS, or a webhook action in the action group associated with the alert rule. For more details see recommended steps below
