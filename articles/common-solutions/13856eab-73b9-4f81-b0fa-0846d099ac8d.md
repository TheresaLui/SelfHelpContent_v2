...
By using Azure Private Link Service, you can connect to various platforms as a service (PaaS) deployments in Azure via a private endpoint.
 ...
 please refer to [ Private Link Deployments](https://docs.microsoft.com/azure/private-link/)
...
* Currently, it's not possible to block **public access** through Azure portal, SDK, or API to Azure Data Factory, even if you create the data factory with Private Endpoint in your virtual network. It  will be enabled in mid 2021. Please contact support. 
