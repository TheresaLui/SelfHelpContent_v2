...
Registering Automatic VM guest patching for Linux is a two-step process.  First you must enable the InGuestAutoPatchVM preview for your subscription.  After the subscription is registered you need to opt-in the Compute resource (Virtual Machine) provider.

Below are the Azure Portal PowerShell Cloud Shell commands:  
