...
```
**Validate Automatic Guest Patching extension (Microsoft.CPlat.Core.WindowsPatchExtension) is installed on the VM.  Performed after local late night + 3 hours**
```
