...
When an Azure AD B2C directory is created, an app called b2c-extensions-app. This app, referred to as the b2c-extensions-app, is visible in App registrations. It is used by the Azure AD B2C service to store information about users and custom attributes. If the app is deleted, Azure AD B2C will not function correctly and your production environment will be affected. [Verify that the extensions app is present](https://docs.microsoft.com/azure/active-directory-b2c/extensions-app). 
