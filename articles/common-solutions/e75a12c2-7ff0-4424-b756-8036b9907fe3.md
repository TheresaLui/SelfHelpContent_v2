...
3. For assigning resource level roles and permissions, please follow [ADF Roles and Permissions](https://docs.microsoft.comazure/role-based-access-control/custom-roles)
