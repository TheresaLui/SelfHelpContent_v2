...
Use [Azure Monitor to monitor Azure Active Directory B2C](https://docs.microsoft.com/azure/active-directory-b2c/azure-monitor) sign-in and auditing logs. Retain the logs for long-term use or integrate them with third-party security information and event management (SIEM) tools to gain insights into your environment.
