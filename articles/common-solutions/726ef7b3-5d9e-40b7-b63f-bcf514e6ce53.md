...
2. Make sure that your Microsoft Azure Sentinel Logstash output plugin version is between 7.0 and 7.9. Find the version by running the following command:<br>       
