...
4. If you have successfully verified all three but are still encountering a client issue, please create a new support request.

## **Recommended Documents**

* [Device Update for IoT Hub Documentation](https://)
* [Device Update Troubleshooting Guide](http://)