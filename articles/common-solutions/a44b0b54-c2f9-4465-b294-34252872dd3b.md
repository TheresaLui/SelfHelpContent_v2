...
It looks like you're encountering an issue with the Device Update client. Most users are able to resolve their client-side issues using the following steps.
