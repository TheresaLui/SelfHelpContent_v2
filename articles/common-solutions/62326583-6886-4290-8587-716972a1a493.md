...
* Why can't I see my Azure subscription to be linked with my Azure DevOps organization?
    * A user interface limitation prevents the subscription picker from displaying more than 50 subscriptions. If your user account has access to more than 50 subscriptions and the target subscription is not visible, you can create a new user account; grant the account Owner/Contributor rights to the target subscription and administrative privileges to the Azure DevOps organization. Then use the new account to link the organization to the target subscription. If that is not an option, continue to create a support ticket.
