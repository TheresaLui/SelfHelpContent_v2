...
Resolve common issues creating playbooks in Azure Sentinel using the following steps. Need help creating your first playbook? See the [Azure Sentinel Playbooks tutorial](https://docs.microsoft.com/azure/sentinel/tutorial-respond-threats-playbook).
...
1. Make sure that you have the Azure Logic Apps contributor role (or a stronger role, such as Contributor or Owner) on the playbooks that you want to attach.
