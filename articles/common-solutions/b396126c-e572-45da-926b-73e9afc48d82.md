...
Get an [Overview of user accounts in Azure Active Directory B2C](https://docs.microsoft.com/azure/active-directory-b2c/user-overview).
...
* Having the user sign-up via a [sign-up or sign-up/sign-in policy](https://docs.microsoft.com/azure/active-directory-b2c/user-flow-overview?WT.mc_id=Portal-Microsoft_Azure_Support#create-a-sign-up-policy)  

* Using the [Graph API](https://docs.microsoft.com/azure/active-directory-b2c/manage-user-accounts-graph-api?WT.mc_id=Portal-Microsoft_Azure_Support) 
