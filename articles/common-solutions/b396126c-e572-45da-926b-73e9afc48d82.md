...
* **Creating users in Azure AD B2C** 

   To create an AD B2C user who can sign in through your B2C integrated app:  

    * Have the user sign-up through a [sign-up or sign-up/sign-in policy](https://docs.microsoft.com/azure/active-directory-b2c/user-flow-overview?WT.mc_id=Portal-Microsoft_Azure_Support#create-a-sign-up-policy)  
...
* Learn about AD B2C from our [Frequently asked questions](https://docs.microsoft.com/azure/active-directory-b2c/active-directory-b2c-faqs) about the Azure Active Directory B2C
