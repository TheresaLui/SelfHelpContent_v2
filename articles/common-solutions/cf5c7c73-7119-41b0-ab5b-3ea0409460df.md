...
* [Add a native client application to your Azure Active Directory B2C tenant](https://docs.microsoft.coms/azure/active-directory-b2c/add-native-application?tabs=app-reg-ga). 
