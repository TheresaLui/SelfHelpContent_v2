<properties
  pagetitle="Creating alert rules"
  description=""
  service=""
  resource=""
...
- When creating alert rules for SQL insights (preview), you need the [Log Analytics contributor role](https://docs.microsoft.com/azure/azure-monitor/logs/manage-access#manage-access-using-azure-permissions) on the workspace you will use
