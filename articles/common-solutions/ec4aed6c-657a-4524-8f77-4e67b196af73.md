...
4. For problems with starting a event-based triggers trigger from REST API and SDK, we recommend to call Subscribe To Events API first, and call Get Event Subscription Status API to make sure the trigger’s event subscription status is enabled before starting the trigger. Sample script to subscribe to events before starting the event trigger in CICD scenarios:[Tutorial](https://docs.microsoft.com/en-us/azure/data-factory/continuous-integration-deployment#script) 
