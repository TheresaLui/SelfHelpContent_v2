...
Use the following procedure to configure network ports. 

There are six ports provided with the ASE. Make sure that you connect the computer to PORT 1 on your device for the initial setup.

## **Recommended Steps**

1. When you plug the network cable into the ethernet port, ensure that the ethernet port LEDs are flickering
