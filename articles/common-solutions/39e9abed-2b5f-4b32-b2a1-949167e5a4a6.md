...
2. Deploy the playbook in your Azure Subscription and resource group by clicking on Deploy to Azure button. 

3. Fill in the required parameters. You will define the Subscription and Resource Group of this playbooks, it’s name, the display name for the connections and some other parameters to be used in the playbook steps. 

4. Authorize all the API connections: 

    1. In the Logic Apps resource page, select API connections in the menu. 
...
If any error occurs in the playbook: 

1. Make sure the connections are authorized. You can go over the actions and look for an action with an unauthorized error. 
