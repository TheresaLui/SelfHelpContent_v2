...
* Check whether `Confluent organization name` has any of the following forbidden characters: `<>#%'*^`{|}~\"` and whitespace (space, tab)
* Check if the Plan and Price information has loaded correctly. If you notice any issues here, please know that our engineers are working to fix this 
