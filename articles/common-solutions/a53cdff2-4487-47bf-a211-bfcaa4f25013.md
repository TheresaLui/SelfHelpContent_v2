...
**Azure SQL Source**, we recommend to: 
...
- [Azure SQL Soruce Recommendations](https://docs.microsoft.com/en-us/azure/data-factory/concepts-data-flow-performance?WT.mc_id=Portal-Microsoft_Azure_Support#azure-sql-database-sources)

**Azure Synapse Analytics sources**, we recommend to:

-  Use Enable Staging instead of partitioning that improves read performance.
- [Azure Synapse Analytics Source Recommendations](https://docs.microsoft.com/en-us/azure/data-factory/concepts-data-flow-performance#azure-synapse-analytics-sources)

**File-based sources**, we recommend to:

- Use the Spark-native Parquet format for optimal read and write times.
- [File-based Source Recommendations](https://docs.microsoft.com/en-us/azure/data-factory/concepts-data-flow-performance#file-based-sources)
...
- [Optimizing Transformations doc](https://docs.microsoft.com/azure/data-factory/concepts-data-flow-performance#optimizing-transformations)
- [Total Sink Processing Time vs. Transformation Processing Time](https://docs.microsoft.com/en-us/azure/data-factory/concepts-data-flow-monitoring#total-sink-processing-time-vs-transformation-processing-time)
