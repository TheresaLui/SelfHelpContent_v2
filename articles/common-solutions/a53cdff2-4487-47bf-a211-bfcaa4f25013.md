...
- Output to a single file and "As Data in column" takes more time. Using partitioning in downstream application, Dataflow, Copy, and Spark can work on the partitioned files very easily.
