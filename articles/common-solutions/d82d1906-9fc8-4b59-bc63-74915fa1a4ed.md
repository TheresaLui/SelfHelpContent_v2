...
In case of a possible false positive incident:<br>
1. Consider modifying the analytic rule to exclude similar false positive incidents in the future. Find a link to the analytic rule that generated the incident on the incident page. Learn about [working with Analytic rules](https://docs.microsoft.com/azure/sentinel/tutorial-detect-threats-custom). 
