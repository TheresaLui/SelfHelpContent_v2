...
Iotedge command connects to the IoT Edge module runtime daemon (aziot-egdge) and will also make queries into the container runtime. The user running the tool needs to have permission to connect to the daemon's management socket.
