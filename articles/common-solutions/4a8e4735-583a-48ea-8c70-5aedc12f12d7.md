...
* Details of setting up replication inlcuding selecting target subscription are [availble here](https://docs.microsoft.com/azure/migrate/tutorial-migrate-vmware#replicate-vms)