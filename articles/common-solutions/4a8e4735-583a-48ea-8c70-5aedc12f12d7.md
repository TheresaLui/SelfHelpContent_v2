...
Learn more about Azure Migrate by reviewing these issues and resources.

### **How to check whether user has appropriate access to create a project**
To create a project, a user needs Owner or Contributor permissions. [Learn how to determine if you have the required access.](https://docs.microsoft.com/azure/role-based-access-control/check-access)..don't see a particular geography when creating the Azure Migrate project**
...
* [Support matrix for physical server migration (including other clouds)](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-physical-migration)
