...
To create a project, a user needs Owner or Contributor permissions. [Learn how to determine if you have the required access.](https://docs.microsoft.com/azure/role-based-access-control/check-access)
...
* Details regarding migrating servers (Winodws or Linux) are [available here](https://docs.microsoft.com/azure/migrate/)