...
4. From the list of virtual machines, select and click to view the details of the VM that you want to delete. In the details blade, select **Delete** to remove the VM.
