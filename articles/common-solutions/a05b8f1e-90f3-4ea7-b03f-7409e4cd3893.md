...
In order to use SQL insights (preview) to monitor your Azure SQL VM or SQL Server running on an Azure VM, you need to create a monitoring user that will collect the data.
