...
1. Refer to [our documentation](https://docs.microsoft.com/azure/azure-monitor/insights/sql-insights-enable#azure-sql-database) for creating the monitoring user
