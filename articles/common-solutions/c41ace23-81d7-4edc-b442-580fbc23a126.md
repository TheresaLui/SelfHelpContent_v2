...
1. To find this, browse to the **Resource Set** asset to see the `partitionCount`. This represents the number of files/partitions in the Resource Set. 
2. Note the `aggregatedProperties` and `sampleUri`, which pinpoint the fully qualified file name.
