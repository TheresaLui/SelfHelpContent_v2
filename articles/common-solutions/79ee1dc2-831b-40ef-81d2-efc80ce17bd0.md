...
3. For a private IoT Hub, the root CA for the private hub needs to be added to the trust bundle provided in `trust_bundle_cert` of the config file. For more information, please read [Manage certificates on an IoT Edge device](https://docs.microsoft.com/azure/iot-edge/how-to-manage-device-certificates?view=iotedge-2020-11).
