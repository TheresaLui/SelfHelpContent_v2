<properties
  pagetitle="Issue retrieving log data using the REST API"
  service="microsoft.insights"
  resource="components"
  ms.author="rashmia"
  selfhelptype="Resource"
  supporttopicids="32729610"
  productpesids="15693"
  cloudenvironments="public, fairfax, mooncake, blackforest, ussec, usnat"
  articleid="67f32f8d-eae3-4dd0-a3c2-d57d55f82de9"
  ownershipid="AzureMonitoring_ApplicationInsights" />
# Issue retrieving log data using the REST API
