...
Check if you have recently changed your account password in Azure AD. If you have changed your password, existing personal access tokens will not work till you sign into Azure DevOps organization using the changed password at least once.
