...
3. If you are still encountering an issue, check the [error code documentation](https://docs.microsoft.com/iot-hub-device-update/device-update-error-codes) for the Device Update content service.
