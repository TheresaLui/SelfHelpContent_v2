...
**Note:** When enabling Azure Defender at the Log Analytics workspace level, **several capabilities will be unavailable**, including just-in-time access, network detection, regulatory compliance, adaptive network hardening, and adaptive application control.  
