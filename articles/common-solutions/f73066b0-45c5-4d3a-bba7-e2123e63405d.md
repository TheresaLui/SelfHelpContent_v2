...
* **SSAS Database consistency Check (DBCC) , Databases Recovery, SSAS Databases Corruption"**
     ...
     - **Errors in the metadata manager: "An error occurred when loading the CubeName cube, from the file '…'" or backup and restore errors: "An error occurred while synchronizing the '*DBName*' database. Server: The operation has been cancelled."**
