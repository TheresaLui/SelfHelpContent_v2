...
5. Check the [Device Update troubleshooting guide](https://) to see if your issue is addressed. If you are still encountering issues, please create a new support request.
