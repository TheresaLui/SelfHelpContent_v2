<properties
  ...
  resource="factories"
  ms.author="susabat,rakatuko,dfandel"
...
If you have received an error code, please reference the [ADF Troubleshooting Guide](https://docs.microsoft.com/azure/data-factory/data-factory-troubleshoot-guide#web-activity) and search for the code nmber.
