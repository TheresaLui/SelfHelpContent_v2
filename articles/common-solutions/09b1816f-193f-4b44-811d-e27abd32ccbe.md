...
* Review [concepts of an Windows Virtual Desktop environment[This is the display text for the last article in the list](https://docs.microsoft.com/azure/virtual-desktop/environment-setup/)