...
- In the specific Log Analytics workspace blade, go to the **General** section and select **Solutions**  
...
To add the security solution, go the same workspace blade, go to the **General** section, and select **Workspace summary**.
* Select **Add** 
* In the Marketplace, select **Azure Security Center**
* In the next window, select **Create**
