...
For companies that want to change that order, they can change it only on an App Service Environment (ASE) or by outsourcing the handshake to an Azure Gateway. 
