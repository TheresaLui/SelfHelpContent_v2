<properties
    pageTitle="Avere vFXT My Problem is not Listed"
    description="Resolve general issues with Avere vFXT cluster."
    infoBubbleText="Avere vFXT My Problem is not Listed"
    authors="jbut"
    ms.author="jebutl"
    displayOrder="1"
    articleId="averevfxt-problemnotlisted"
    diagnosticScenario=""
...
# Avere vFXT Cluster My Problem is not Listed
...
Similarily, you may also check the Dashboard graphs by navigating to the main page of the Avere Control Panel.
