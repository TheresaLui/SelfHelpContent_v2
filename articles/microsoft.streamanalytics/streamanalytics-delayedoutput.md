...
It is important to ensure data is getting ingested into all partitions of your Event Hubs or IoT Hub. When one input parition is not receiving input, this can lead to a 5 second delay of your output.
