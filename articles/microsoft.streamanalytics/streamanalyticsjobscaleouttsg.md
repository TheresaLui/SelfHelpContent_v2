...
It was found that your Stream Analytics job has high resource utilization. Every job has some amount of memory and compute power that is used to process incoming events. High resource utilization might impact job's performance and therefore it is recommended to increase the number of Streaming Units assigned to a job.
...
3. You can also learn which parts of your query can cause high resource utilization and try to optimize your query. You can also increase the number of Streaming Units assigned to your job by going to Scale under Configure section on portal. 
