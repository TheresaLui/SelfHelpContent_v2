...
3. Use the "Sample Data" button for each of the inputs and download the input sample data. <br>
...
8. If no output is obtained after the expected duration (based on the query), try the following: <br>
