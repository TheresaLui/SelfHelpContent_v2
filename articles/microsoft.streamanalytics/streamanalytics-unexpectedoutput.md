...
# Unexpected Output
There are times when your Stream Analytics query may not be producing the output you are expecting. This could happen due to a variety of reasons. To learn how to debug and understand why your job is producing unexpected output, see the recommended documents.
