...
Azure Stream Analytics is priced by the number of streaming units required to process the data into the service. Each streaming unit providing is billed on an hourly basis. 
