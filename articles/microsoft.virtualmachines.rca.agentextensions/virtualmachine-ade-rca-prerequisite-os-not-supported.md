<properties
	...
	ms.author="tiag"
	displayOrder=""
	articleId="ADE_RCA-ade-on-linux-failing-prerequisites-os-not-supported"
...
<!--issueDescription-->
The operation on the Azure Disk Encryption for Linux extension on your virtual machine **<!--$vmname-->Virtual machine<!--/$vmname-->** initiated at **<!--$StartTime-->StartTime<!--/$StartTime--> (UTC)** failed because your operating system distro is not supported for encrypting the VM.
<!--/issueDescription-->
