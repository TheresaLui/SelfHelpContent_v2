<properties
	pageTitle="worker role (paas)/Planned Maintenance(Azure Platform)"
	description="worker role (paas)/Planned Maintenance(Azure Platform)"
...
* [MSRC Releases for Guest OS updates](https://docs.microsoft.com/azure/cloud-services/cloud-services-guestos-msrc-releases)
