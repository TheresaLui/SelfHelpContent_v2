<properties
	...
	description="worker role (paas)/configuration and management/managing"
...
[How to move the Cloud Services between Resource Groups and what are the limitations?]
(https://azure.microsoft.com/documentation/articles/resource-group-move-resources/#classic-deployment-limitations)<br>
...
[How to change the VM size of an exiting Cloud Services Role](https://docs.microsoft.com/azure/cloud-services/cloud-services-sizes-specs#changing-the-size-of-an-existing-role)<br>
[How to convert Cloud Servies to Service Fabric](https://docs.microsoft.com/azure/service-fabric/service-fabric-cloud-services-migration-worker-role-stateless-service)<br>
