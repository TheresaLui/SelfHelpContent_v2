...
* [How-to: Configure backup for Azure VM, pricing and support matrix questions](https://docs.microsoft.com/azure/backup/backup-azure-vms-first-look-arm)<br>
* [How-to: Setup backup alerts for Azure VM](https://docs.microsoft.com/azure/backup/backup-azure-monitor-vms )<br>
* [How-to: Manage backup Azure VM](https://docs.microsoft.com/azure/backup/backup-azure-manage-vms)<br>
* [Frequently asked questions about Azure Backup service](https://docs.microsoft.com/azure/backup/backup-azure-vm-backup-faq)<br>
