...
## **Recommended steps**
1. [Check the detailed error message here] (data-blade:Microsoft_Azure_CloudServices.cloudServiceStatusMessageBlade) for instances which are not in ready state. <br>
