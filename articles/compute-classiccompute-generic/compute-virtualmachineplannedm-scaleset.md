...
To maintain the VMs within the scale sets, planned maintenance is scheduled in waves. Only running instances are maintained. A wave starts with a notification to a subscription owner and co-owners. This notification defines a schedule with two time windows:
