...
* [Configure availability sets for Linux virtual machines in classic deployments](https://docs.microsoft.com/azure/virtual-machines/linux/classic/configure-availability)
* [Configure availability sets for Linux virtual machines using Resource Manager deployments](https://docs.microsoft.com/azure/virtual-machines/azure-cli-arm-commands#azure-availset-commands-to-manage-your-availability-sets)
* [Understand and use Resource Health Center to troubleshoot this scenario in the future](https://docs.microsoft.com/azure/resource-health/resource-health-overview)
* [Understand planned maintenance and how it is communicated for virtual machines in Azure](https://docs.microsoft.com/azure/virtual-machines/windows/planned-maintenance)
