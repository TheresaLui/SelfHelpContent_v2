...
* Look at [Event Hubs Exceptions](https://docs.azure.cn/event-hubs/event-hubs-messaging-exceptions#timeoutexception) article for more information about timeout exceptions
...
* [More information on the TimeOutException Class](https://msdn.microsoft.com/library/system.timeoutexception.aspx)
