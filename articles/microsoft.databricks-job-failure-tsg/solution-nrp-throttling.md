...
1. [Pools](https://docs.microsoft.com/en-us/azure/databricks/clusters/instance-pools/)
2. [Azure Requests Limits and Throttling](https://docs.microsoft.com/en-us/azure/azure-resource-manager/management/request-limits-and-throttling)
