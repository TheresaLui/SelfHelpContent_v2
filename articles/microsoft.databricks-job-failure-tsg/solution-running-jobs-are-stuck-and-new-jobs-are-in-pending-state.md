...
<br>
Moreover, we can go through Spark UI to troubleshoot slowest Stage/Task to RCA the problem.<br>
<br>
It is important to mention that by design:<br>
<br>
1. The number of jobs is limited to 1000.<br>
