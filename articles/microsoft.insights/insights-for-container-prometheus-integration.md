<properties
    pageTitle="I need help with Prometheus integration"
    description="I need help with Prometheus integration"
    infoBubbleText="Here is the information to resolve issues related to Prometheus integration"
...
Most customers resolved the issues related to Prometheus integration using the below links. 
