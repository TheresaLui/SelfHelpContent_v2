...
1. Review the log alert rule to verify that the the query run by the alert service is same as what you want
    ...
    - You can check the exact query used by the alerting service by [viewing the condition of your alert rule](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/alert-log-troubleshoot#alert-query-output-misunderstood)
