...
### 3. **Use the snapshot health check** 
...
### 4. **Verify the instrumentation key** 
...
### 5. **Upgrade to the latest version of the NuGet package** 
...
### 7. **Troubleshooting Cloud Services** 
...
### 8. **Overriding the Shadow Copy folder** 
...
### 9. **Use search to find exceptions with snapshots** 
...
### 10. **Edit network proxy or firewall rules** 
