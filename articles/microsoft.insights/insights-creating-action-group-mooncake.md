...
Learn about the [behavior of each action type](https://docs.azure.cn/azure-monitor/platform/action-groups#action-specific-information) that can be used in an Action group.
...
[Creating and managing action groups](https://docs.azure.cn/azure-monitor/platform/action-groups)
