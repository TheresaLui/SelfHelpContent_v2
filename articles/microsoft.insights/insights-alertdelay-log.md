...
1. Data ingestion time in to Log Analytics might be impacting your alert rule
    ...
    - If you need alerts with a lower latency, consider using [Metric alerts for Logs](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/alerts-metric-logs) for alerting on Heartbeat, Perf or Events tables
