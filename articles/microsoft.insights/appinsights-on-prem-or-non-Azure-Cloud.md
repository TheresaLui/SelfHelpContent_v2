...
## **On-Premises Application Insights Agent Recommended Steps**

On-premises agent-based monitoring is available for [ASP.NET](https://docs.microsoft.com/azure/azure-monitor/app/status-monitor-v2-overview) and [Java](https://docs.microsoft.com/azure/azure-monitor/app/java-on-premises) applications.
