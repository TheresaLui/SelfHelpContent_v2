<properties
    pageTitle="I am having issues managing fired alerts with API, CLI or ARM template"
    description="I am having issues managing fired alerts with API, CLI or ARM template"
    infoBubbleText=""
    ...
    ms.author="ofmanor"
    displayOrder="8"
    articleId="alerts-crud-api-alerts"
