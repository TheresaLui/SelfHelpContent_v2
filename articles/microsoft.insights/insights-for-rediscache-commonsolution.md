...
- [Explore Azure Monitor for Azure Cache for Redis](https://docs.microsoft.com/azure/azure-monitor/insights/redis-cache-insights-overview):
	...
	* To help understand the specific Azure Monitor for Azure Cache for Redis Metrics-[Available metrics and reporting intervals](https://docs.microsoft.com/azure/azure-cache-for-redis/cache-how-to-monitor#available-metrics-and-reporting-intervals)
