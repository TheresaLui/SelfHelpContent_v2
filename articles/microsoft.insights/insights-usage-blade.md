...
2.	Please verify you are using recommended mechanisms of loading the SDK, documented here: [Getting Started](https://github.com/Microsoft/ApplicationInsights-JS#get-started)
