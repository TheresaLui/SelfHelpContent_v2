...
3. Execute a comparable query in Analytics and compare it to the other screens, it's possible the data latency is only during display
4. If the latency is persistent it is recommended to open a case for tracking.

**For Errors**<br>

For all supported SDKs you should not see any errors relating to telemetry collection. If you are seeing errors that are specific to **dc.services.visualstudio.com** please use the steps below. If you are seeing other errors that are coming from your application please go back and open a case for the SDK.
...
4. If you are receiving an error message from the service it is likely we are experiencing issues and it is recommended to open
