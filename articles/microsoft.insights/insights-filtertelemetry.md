...
**Filtering telemetry**<br>
In order to **filter** telemetry you will need to create an [ITelemetryProcessor](https://docs.microsoft.com/azure/azure-monitor/app/api-filtering-sampling#filtering-itelemetryprocessor) ad add it to your application code. Below is a list of specific SDK implementations.<br>
...
[See here](https://github.com/Microsoft/ApplicationInsights-JS#telemetry-initializers) for Node.JS<br>
