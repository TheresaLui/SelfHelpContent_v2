...
* To create a new resource use **New-AzureRmApplicationInsights** and **Remove-AzureRmApplicationInsights** for deleting one 
* To manage your Application Insights resource’s daily cap using **Get-AzureRmApplicationInsights -IncludeDailyCap** to retrieve the current value and **Set-AzureRmApplicationInsightsDailyCap** to set a new cap. 
