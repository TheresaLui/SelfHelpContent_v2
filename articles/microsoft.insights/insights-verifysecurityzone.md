...
5. Edge and Internet Explorer users can also get this error when trusted zone settings are not supported. <br> Verify both Analytics portal and Azure Active Directory portal are in the same security zone.
