...
3. Review your activity logs for events that might match the condition in your alert rule.
    ...
    1. Filter to the resource, resource group or subscription for which your alert was triggered (you can get this information from your alert email or under [alerts in Azure Monitor](https://ms.portal.azure.com/#blade/Microsoft_Azure_Monitoring/AzureMonitoringBrowseBlade/alertsV2))
...
[How to view fired alerts in Azure Monitor](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/alerts-managing-alert-instances)