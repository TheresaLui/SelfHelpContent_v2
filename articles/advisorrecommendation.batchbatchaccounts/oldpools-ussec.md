<properties
    ...
    articleId="962f2d6d-b2c7-4c48-9e61-2a857051815d_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://azurebatchrx.usseceast.kusto.core.microsoft.scloud').database('azurebatchprod').AzureAdvisor_OldPools",
    "dataSource": "Kusto",
  ...
  "tip": "Consider recreating old pools to get the latest node agent, which includes the latest updates and bug fixes. Alternatively, scale the pool down to 0 nodes and then resize."
}
---