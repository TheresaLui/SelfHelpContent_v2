<properties
    ...
    authors="pkshultz"
    ms.author="pkshultz"
    articleId="a49b0685-56d6-468d-b879-7e021a2395e3_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://azurebatch.usnatwest.kusto.core.eaglex.ic.gov').database('azurebatchprod').AzureAdvisor_PoolServerPools",
    "dataSource": "Kusto",
