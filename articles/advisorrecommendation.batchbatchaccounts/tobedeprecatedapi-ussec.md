<properties
    ...
    articleId="bbc3f0f1-85b7-4bcb-b474-0e02571eb5fa_USSec"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('cluster('https://azurebatchrx.usseceast.kusto.core.microsoft.scloud').database('azurebatchprod').AzureAdvisor_toBeDeprecatedAPI",
    "dataSource": "Kusto",
