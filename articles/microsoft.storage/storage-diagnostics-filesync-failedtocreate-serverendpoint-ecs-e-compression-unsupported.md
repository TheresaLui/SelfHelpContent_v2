...
<!--issueDescription-->
Server endpoint creation failed under the Storage Sync Service resource <!--$storageSyncServiceName-->[storageSyncServiceName]<!--/$storageSyncServiceName--> due to error <!--/issueDescription--> ECS_E_COMPRESSION_UNSUPPORTED (error code: -2134347507 or 0x80c8710d). This error occurred between <!--$startTime-->[startTime]<!--/$startTime--> and <!--$endTime-->[endTime]<!--/$endTime-->.
