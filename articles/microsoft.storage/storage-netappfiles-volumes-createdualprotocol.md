...
2. Make sure proper root certificate is added in AD connection in NetApp account and reverse look up zones are updated. Refer to [Troubleshoot dual protocol volumes](https://docs.microsoft.com/azure/azure-netapp-files/troubleshoot-dual-protocol-volumes) for more information.
