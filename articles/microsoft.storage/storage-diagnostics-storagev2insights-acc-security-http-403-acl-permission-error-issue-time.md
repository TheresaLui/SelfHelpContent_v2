...
- **For the folder path** - Provide **Execute**(**X**) and **Read**(**R**) permissions on the relevant folder and **Execute**(**X**) permission on all the parent folders up to the root folder.<br>
