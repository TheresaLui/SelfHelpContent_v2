...
<!--issueDescription-->
Sync failed for one or more server endpoints under the Storage Sync Service resource _**<!--$storageSyncServiceName-->[storageSyncServiceName]<!--/$storageSyncServiceName-->**_ due to error **CERT\_E\_UNTRUSTEDROOT** (error code **0x800b0109** or **-2146762487**). This error occurred between _<!--$startTime-->[startTime]<!--/$startTime-->_ and _<!--$endTime-->[endTime]<!--/$endTime-->_.
