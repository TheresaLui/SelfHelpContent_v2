...
3. Enter a name for your storage account. See [Storage account endpoints](https://docs.microsoft.com/azure/storage/storage-create-storage-account#storage-account-endpoints) for details about how the storage account name will be used to address your objects in Azure Storage.
...
5. Select the type of storage account: **General purpose** or **Blob storage**. General purpose is the default.<br>
...
6. Select the replication option for the storage account: **LRS**, **GRS**, **RA-GRS**, or **ZRS**. The default is **RA-GRS**. For more details on Azure Storage replication options, see [Azure Storage replication](https://docs.microsoft.com/azure/storage/storage-redundancy).
7. Select the subscription in which you want to create the new storage account.
8. Specify a new resource group or select an existing resource group. For more information on resource groups, see [Azure Resource Manager overview](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-overview).
