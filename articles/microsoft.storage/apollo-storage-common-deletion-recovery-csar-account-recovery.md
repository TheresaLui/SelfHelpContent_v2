...
<noResultText>No recoverable storage acccount was found.If you intend to recover specific containers, blobs, files etc please go back to "Basics" tab and select "Recover deleted storage data" as the problem subtype instead.</noResultText>
