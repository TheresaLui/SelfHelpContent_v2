...
<!--/issueDescription-->
Please ensure that [prerequisite for enabling customer-managed keys](https://docs.microsoft.com/azure/storage/common/storage-encryption-keys-portal?toc=%2fazure%2fstorage%2fblobs%2ftoc.json) are met before enabling it on storage account.
