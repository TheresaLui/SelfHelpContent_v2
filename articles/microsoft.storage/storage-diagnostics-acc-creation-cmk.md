...
* [Configure customer-managed keys for Azure Storage encryption from Azure CLI](https://docs.microsoft.com/powershell/module/az.keyvault/set-azkeyvaultaccesspolicy?view=azps-2.5.0)
