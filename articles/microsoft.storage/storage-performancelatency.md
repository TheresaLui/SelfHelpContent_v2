...
* [Troubleshoot latency increase](https://docs.microsoft.com/azure/storage/common/storage-monitoring-diagnosing-troubleshooting?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#troubleshooting-guidance) when using Azure Storage
...
* [Troubleshoot latency using Storage Analytics logs](https://docs.microsoft.com/azure/storage/common/troubleshoot-latency-storage-analytics-logs)