...
- [Overview of Azure Active Directory authentication over SMB for Azure Files (preview)](https://docs.microsoft.com/azure/storage/files/storage-files-active-directory-overview)<br>
