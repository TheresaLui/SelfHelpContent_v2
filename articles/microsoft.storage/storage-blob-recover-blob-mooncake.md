...
We apologize, but we are unable to recover a deleted blob without [soft delete](https://docs.azure.cn/storage/blobs/storage-blob-soft-delete) enabled.
