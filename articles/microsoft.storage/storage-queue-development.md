...
* [Get Started with Azure Queue Storage using Node.js](https://docs.microsoft.com/azure/storage/queues/storage-nodejs-how-to-use-queues/)<br>
* [Get Started with Azure Queue Storage using C++](https://docs.microsoft.com/azure/storage/queues/storage-c-plus-plus-how-to-use-queues/)<br>
* [Get Started with Azure Queue Storage using PHP](https://docs.microsoft.com/azure/storage/queues/storage-php-how-to-use-queues/)<br>
