...
4. Refer [troubleshoot-LDAP-volumes](https://docs.microsoft.com/azure/azure-netapp-files/troubleshoot-ldap-volumes) if you are getting while creating LDAP Volume
...
- [Create NFS Volumes with LDAP Extended Group](https://docs.microsoft.com/azure/azure-netapp-files/azure-netapp-files-create-volumes) and [Configuring LDAP with Extended Group for the volume](https://docs.microsoft.com/azure/azure-netapp-files/configure-ldap-extended-groups)
