...
* Also available is this [video on enabling AD DS authentication](https://www.youtube.com/embed/9S5A1IJqfOQ) for Azure files with [Windows Virtual Desktop(https://docs.microsoft.com/azure/virtual-desktop/create-file-share/):
