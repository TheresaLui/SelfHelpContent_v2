<properties
pageTitle="Sync failed to upload - ECS_E_XSMB_REST_INCOMPATIBILITY"
description="Sync failed to upload - ECS_E_XSMB_REST_INCOMPATIBILITY"
...
ms.author="passap"
displayOrder=""
articleId="FileSync_FailedToUpload_ECS_E_XSMB_REST_INCOMPATIBILITY"
diagnosticScenario="Sync failed to upload - ECS_E_XSMB_REST_INCOMPATIBILITY"
...
# Azure File Sync failed to upload file(s) due to error _**ECS_E_XSMB_REST_INCOMPATIBILITY**_
