...
[How does my inventory output look like?](https://review.docs.microsoft.com/azure/storage/blobs/blob-inventory#inventory-output)

### **Frequently Reported Issues**

* **Enabling Firewall rules on your storage account may block inventory requests** - If you enable firewall rules for your storage account, inventory requests may be blocked. You can unblock these requests by providing exceptions for trusted Microsoft services. For more information, see the Exceptions section in [Configure firewalls and virtual networks](https://review.docs.microsoft.com/azure/storage/common/storage-network-security#exceptions).
