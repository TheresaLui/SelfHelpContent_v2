<properties
	pageTitle="Transfer data from external sources to blob"
  description="Transfer data from external sources to blob"
...
- [Copy data from Amazon S3 buckets by using AzCopy](https://docs.microsoft.com/azure/storage/common/storage-use-azcopy-s3)
