<properties
pageTitle="Sync failed to recall - WININET_E_TIMEOUT"
description="Sync failed to recall - WININET_E_TIMEOUT"
...
ms.author="passap"
displayOrder=""
articleId="FileSync_FailedToRecall_WININET_E_TIMEOUT"
diagnosticScenario="Sync failed to recall - WININET_E_TIMEOUT"
...
# Azure File Sync failed to recall file(s) due to error **WININET_E_TIMEOUT**

<!--issueDescription-->
Azure File Sync failed to recall file(s) for one or more server endpoints under the Storage Sync Service resource **<!--$storageSyncServiceName-->[storageSyncServiceName]<!--/$storageSyncServiceName-->** due to **error code: 0x80072ee2 or -2147012894**. This error occurred between **<!--$startTime-->[startTime]<!--/$startTime-->** and **<!--$endTime-->[endTime]<!--/$endTime-->**.<br/><br/>This error can occur whenever the Azure File Sync service is inaccessible from the server.
<!--/issueDescription-->
