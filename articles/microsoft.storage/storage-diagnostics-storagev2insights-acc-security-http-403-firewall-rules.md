...
4. A general recommendation is to enable [storage analytics log](https://docs.microsoft.com/en-us/azure/storage/common/storage-analytics#about-storage-analytics-logging) to trace requests, analyze usage trends, and diagnose issues with your storage account.
