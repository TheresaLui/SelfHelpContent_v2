...
2. [Remove the server from all sync groups](https://docs.microsoft.com/azure/storage/files/storage-sync-files-server-registration#remove-the-server-from-all-sync-groups).
...
3. [Unregister the server](https://docs.microsoft.com/azure/storage/files/storage-sync-files-server-registration#unregister-the-server).
