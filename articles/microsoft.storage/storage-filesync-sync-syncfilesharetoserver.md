<properties
	pageTitle="Troubleshooting Azure File Sync - Files are not syncing from Azure file share to server"
	description="Troubleshooting Azure File Sync - Files are not syncing from Azure file share to server"
