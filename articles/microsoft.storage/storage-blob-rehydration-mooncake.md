...
- [Azure Blob storage access tiers FAQ](https://docs.azure.cn/storage/blobs/storage-blob-storage-tiers#faq)
- [Archive access tier](https://docs.azure.cn/storage/blobs/storage-blob-storage-tiers#archive-access-tier)
- [Blob rehydration](https://docs.azure.cn/storage/blobs/storage-blob-storage-tiers#blob-rehydration)