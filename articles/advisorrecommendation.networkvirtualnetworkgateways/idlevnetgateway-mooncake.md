<properties
    ...
    authors="anzaman"
    ms.author="alzam"
    articleId="129d8c1e-a4d2-4bac-86ce-c7c2b2e37feb_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 1.0,
    "streamNamespace": "cluster('https://aznwchinamc.chinanorth2.kusto.chinacloudapi.cn').database('aznwmds').McIdleGateways",
    "dataSource": "Kusto",
