<properties
    ...
    authors="anzaman"
    ms.author="alzam"
    articleId="f3be5a9b-2583-4a1c-b774-2481c00ccb04_Mooncake"
...
---
{
  ...
  "dataSourceMetadata": {
    "schemaVersion": 1.0,
    "streamNamespace": "cluster('https://aznwchinamc.chinanorth2.kusto.chinacloudapi.cn').database('aznwmds').McAA1tunnelGateways",
    "dataSource": "Kusto",
