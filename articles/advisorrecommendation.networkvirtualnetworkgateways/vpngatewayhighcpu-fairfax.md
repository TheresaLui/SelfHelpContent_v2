<properties
    ...
    authors="raashman"
    ms.author="raashman"
    articleId="2e41fe84-7173-4fe9-b257-61aa4679c3fe_Fairfax"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://aznwff.kusto.usgovcloudapi.net').database('CXPCREGeneral').p2shighcpufairfax",
    "dataSource": "Kusto",
