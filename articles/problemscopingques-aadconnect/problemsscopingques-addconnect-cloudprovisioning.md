...
---
{
    ...
    "fileAttachmentHint": "Upload the trace or advanced verbose logging (if you have it enabled) from your corresponding AD domain machine. Learn [more](https://docs.microsoft.com/azure/active-directory/cloud-provisioning/how-to-troubleshoot#log-files)",
        "diagnosticCard": {
