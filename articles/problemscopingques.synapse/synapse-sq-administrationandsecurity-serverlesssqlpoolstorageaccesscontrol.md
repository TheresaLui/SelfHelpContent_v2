<properties
    ...
    description = "Administration and Security/Serverless SQL pool - Storage access control"
    articleId = "synapse-sq-administrationandsecurity-serverlesssqlpoolstorageaccesscontrol.md"
...
---
{
    ...
    "fileAttachmentHint": "",
    "title": "Serverless SQL pool - Storage access control",
    "formElements": [
        {
