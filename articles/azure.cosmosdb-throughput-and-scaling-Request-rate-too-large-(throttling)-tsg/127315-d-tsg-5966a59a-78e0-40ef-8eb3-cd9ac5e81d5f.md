...
#### Step1. Get provisioned RU limit per partition
<pre>
BackendEndRequest5M 
...
#### Step2. Deep dive into partition to see the list of operations in 1 second interval when throttling happened
 
