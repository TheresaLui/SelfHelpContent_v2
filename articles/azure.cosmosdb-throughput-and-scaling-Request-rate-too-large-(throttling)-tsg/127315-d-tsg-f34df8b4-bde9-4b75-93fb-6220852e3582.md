...
#### Step1. Review the followings to seek a change to reduce RU consumption and estimate total RU consumption.
...
#### Step2. Set new provision RU based on above calculation value.
...
#### Step3. Calculate average normalized utilization across all hours with metric “Normalized RU Utilization” 
