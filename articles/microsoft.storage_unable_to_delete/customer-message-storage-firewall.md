...
<!--issueDescription-->
We've researched this case and believe that your unable to delete issue is due to Azure Firewall being enabled on your storage account and the source IP/Public IP of the connection not being whitelisted. In order to resolve this issue you must [whitelist the Public IP within the Firewall of the Storage Account](https://docs.microsoft.com/en-us/azure/storage/common/storage-network-security#grant-access-from-an-internet-ip-range).
<!--/issueDescription-->
