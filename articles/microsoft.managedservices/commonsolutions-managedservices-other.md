...
Here are some common questions we receive about Azure Lighthouse.

## How do I use Azure Lighthouse?
To see Azure Lighthouse in action, watch this overview [demo](https://www.youtube.com/watch?v=x-Db_AFKCzM&t=248s).
