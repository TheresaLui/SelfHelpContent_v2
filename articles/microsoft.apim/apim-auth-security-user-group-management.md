<properties
    pageTitle="User and group in Azure API Management"
    description="Manage user and group in Azure API Management"
    service="microsoft.apim"
    resource="apimanagement"
    authors="genli,v-miegge"
    ms.author="mquian,toddfous"
    selfHelpType="generic"
    supportTopicIds="32632436"
    resourceTags=""
    productPesIds="15551"
...
* [How to manage user accounts in Azure API Management](https://docs.microsoft.com/azure/api-management/api-management-howto-create-or-invite-developers)<br>
