<properties
    ...
    authors="alau"
    ms.author="alau-ms"
    articleId="2cbca084-4e80-4720-a7fe-dc8c3074e8ca_Fairfax"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazureusg.kusto.usgovcloudapi.net').database('FairFax').GetMySqlRedirectionRecommendations",
    "schemaVersion": 2.0,
    "dataSource": "Kusto",
