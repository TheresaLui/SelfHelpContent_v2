<properties
    ...
    authors="alau"
    ms.author="alau-ms"
    articleId="2cbca084-4e80-4720-a7fe-dc8c3074e8ca_USNat"
...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazureusnate.usnateast.kusto.core.eaglex.ic.gov').database('sqlazure1').GetMySqlRedirectionRecommendations",
    "schemaVersion": 2.0,
    "dataSource": "Kusto",
  ...
  "actions": [
    ...
    {
      "actionId": "73fcca2b-f6ba-4a6c-b776-9b3e5d2226a3",
  ...
  "resourceMetadata": {
    "action": {
      "actionId": "78f26730-0b00-406b-9978-f77895f6c415",
      "actionType": "Blade",
