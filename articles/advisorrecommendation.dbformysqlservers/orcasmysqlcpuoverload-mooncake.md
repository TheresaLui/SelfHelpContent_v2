...
---
{
  ...
  "dataSourceMetadata": {
    "streamNamespace": "cluster('https://sqlazurechi2.chinanorth2.kusto.chinacloudapi.cn').database('MoonCake').GetMySqlCpuRecommendations",
    "schemaVersion": 2.0,
    "dataSource": "Kusto",
  ...
  "actions": [
    {
      "actionId": "daefb660-33fc-475d-a119-c0688c99dd00",
  ...
  "resourceMetadata": {
    "action": {
      "actionId": "269ff9ba-8866-4cc3-941e-41874a7d7adc",
      "actionType": "Blade",
      "extensionName": "HubsExtension",
      "bladeName": "ResourceMenuBlade",
      "metadata": {
