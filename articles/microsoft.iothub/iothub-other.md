...
* IoT Hub data retention default is one day, but it can be increased to seven days. For more information, refer to [https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messages-read-builtin](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-messages-read-builtin)
