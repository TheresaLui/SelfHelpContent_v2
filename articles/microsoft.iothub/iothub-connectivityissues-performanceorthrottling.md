...
1. Also check if you're hitting the throttle limit by comparing your [traffic](data-blade:Microsoft_Azure_Monitoring.MetricsBladeV3.id.$resourceId) against our [documentation](https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-quotas-throttling).
