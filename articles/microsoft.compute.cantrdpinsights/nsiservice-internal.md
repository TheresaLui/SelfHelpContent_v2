...
## **Recommended Steps**
To resolve the issue, please try the steps in the [Network Store Interface service not starting](https://docs.microsoft.com/en-us/troubleshoot/azure/virtual-machines/azure-vm-nsi-not-starting) troubleshooting guide.
