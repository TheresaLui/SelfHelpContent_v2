<properties
	pageTitle="Problem using private Python packages"
	description="Problem using private Python packages"
	infoBubbleText="Problem using private Python packages"
	service="microsoft.machinelearning"
	resource="environments"
	authors="saachigopal"
	ms.author="sagopal"
	supportTopicIds="32755206"
	productPesIds="16644"
	cloudEnvironments="public, fairfax, mooncake, usnat, ussec"
	articleId="microsoft.machinelearning.environments.problemusingprivatepythonpackages"
	selfHelpType="generic"
	ownershipId="AzureML_AzureMachineLearningServices"
/>

# Problem using private Python packages
