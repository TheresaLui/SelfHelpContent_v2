...
<properties
	pageTitle="Return shipping label"
	description="Learn how to resolve return shipping label issues"
...
* [Ship Data Box Disk to Azure](https://docs.microsoft.com/azure/databox/data-box-disk-deploy-picked-up)
...
* [Troubleshoot Data Box blob storage errors](https://docs.microsoft.com/azure/databox/data-box-troubleshoot-rest)
