<properties
	...
	articleId="d456ede7-7bf3-4aa6-afa0-c6e840052283"
   	ownershipId="Centennial_CloudNet_LoadBalancer"
/>

# Configure the new storage account 

1. Some features won't export to a template, so you'll have to add them to the new storage account. 
2. The following table lists these features along with guidance for adding them to your new storage account.  
