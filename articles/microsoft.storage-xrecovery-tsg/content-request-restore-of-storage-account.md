...
**NOTE**: If you are not a member of TM-CSSStgRec, you will not be able to recover the storage account. Please follow these steps:
-  Create an [ICM](https://portal.microsofticm.com/imp/v3/incidents/create?tmpl=74a1g3) [Must use this link and NOT use the ASC method] 
- Send an email with it to cssstgrec@microsoft.com to help the Restore Storage Account operation, provide the ICM number in the email to the recovery team. 
- For ARR customers, please send an email to arrstgrecovery@microsoft.com

<br>
If you are a member of TM-CSSStgRec perform the following steps: <br>
...
6. Successful completion will look like the following:<br>

<br>

>Messages   **Result**  Preview<br>
<br>Restore Storage Account
<br>
1 {}<br>
